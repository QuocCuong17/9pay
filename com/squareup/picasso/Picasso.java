...
public class Picasso {
    ...
    void resumeAction(Action action) {
        ...
        if (quickMemoryCacheCheck != null) {
            ...
            if (this.loggingEnabled) {
                Utils.log("Main", WorkflowModule.Properties.Section.Component.State.STATE_COMPLETED, action.request.logId(), "from " + LoadedFrom.MEMORY);
                return;
            }
            return;
        }
    ...
    private void deliverAction(Bitmap bitmap, LoadedFrom loadedFrom, Action action, Exception exc) {
        ...
        if (this.loggingEnabled) {
            Utils.log("Main", WorkflowModule.Properties.Section.Component.State.STATE_COMPLETED, action.request.logId(), "from " + loadedFrom);
        }
    }

...
public class CameraInstance {
        ...
        if (this.open) {
            this.cameraThread.enqueue(new Runnable() { // from class: com.journeyapps.barcodescanner.camera.CameraInstance$$ExternalSyntheticLambda3
                ...
                public final void run() {
                    CameraInstance.this.m941xdd5ef35b(z);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m941xdd5ef35b(boolean z) {
    ...
    public void changeCameraParameters(final CameraParametersCallback cameraParametersCallback) {
        ...
        if (this.open) {
            this.cameraThread.enqueue(new Runnable() { // from class: com.journeyapps.barcodescanner.camera.CameraInstance$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    CameraInstance.this.m938x78173d15(cameraParametersCallback);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m938x78173d15(CameraParametersCallback cameraParametersCallback) {
    ...
    public void requestPreview(final PreviewCallback previewCallback) {
        this.mainHandler.post(new Runnable() { // from class: com.journeyapps.barcodescanner.camera.CameraInstance$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                CameraInstance.this.m940xf1e80099(previewCallback);
            }
        });
    }

    /* renamed from: lambda$requestPreview$3$com-journeyapps-barcodescanner-camera-CameraInstance, reason: not valid java name */
    public /* synthetic */ void m940xf1e80099(final PreviewCallback previewCallback) {
        if (!this.open) {
            ...
            this.cameraThread.enqueue(new Runnable() { // from class: com.journeyapps.barcodescanner.camera.CameraInstance$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    CameraInstance.this.m939xd7cc81fa(previewCallback);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m939xd7cc81fa(PreviewCallback previewCallback) {

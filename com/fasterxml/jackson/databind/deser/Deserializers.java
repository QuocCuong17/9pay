...
public interface Deserializers {
    ...
    /* renamed from: com.fasterxml.jackson.databind.deser.Deserializers$-CC, reason: invalid class name */
    /* loaded from: classes2.dex */
    public final /* synthetic */ class CC {
        public static boolean $default$hasDeserializerFor(Deserializers _this, DeserializationConfig deserializationConfig, Class cls) {
            return false;
        }
    }
    ...
    public static abstract class Base implements Deserializers {
        ...
        public /* synthetic */ boolean hasDeserializerFor(DeserializationConfig deserializationConfig, Class cls) {
            return CC.$default$hasDeserializerFor(this, deserializationConfig, cls);
        }
    }

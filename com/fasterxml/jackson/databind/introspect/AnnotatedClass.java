    ...
    private final Creators _creators() {
        ...
        if (creators == null) {
            ...
            if (javaType == null) {
                ...
                creators = AnnotatedCreatorCollector.collectCreators(this._annotationIntrospector, this._typeFactory, this, javaType, this._primaryMixIn, this._collectAnnotations);
            }

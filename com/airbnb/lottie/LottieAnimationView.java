...
public class LottieAnimationView extends AppCompatImageView {
        ...
        if (isInEditMode()) {
            return new LottieTask<>(new Callable() { // from class: com.airbnb.lottie.LottieAnimationView$$ExternalSyntheticLambda2
                ...
                public final Object call() {
                    return LottieAnimationView.this.m551lambda$fromRawRes$1$comairbnblottieLottieAnimationView(i);
                }
            }, true);
        }
    ...
    public /* synthetic */ LottieResult m551lambda$fromRawRes$1$comairbnblottieLottieAnimationView(int i) throws Exception {
    ...
    private LottieTask<LottieComposition> fromAssets(final String str) {
        if (isInEditMode()) {
            return new LottieTask<>(new Callable() { // from class: com.airbnb.lottie.LottieAnimationView$$ExternalSyntheticLambda3
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return LottieAnimationView.this.m550lambda$fromAssets$2$comairbnblottieLottieAnimationView(str);
                }
            }, true);
        }
    ...
    public /* synthetic */ LottieResult m550lambda$fromAssets$2$comairbnblottieLottieAnimationView(String str) throws Exception {

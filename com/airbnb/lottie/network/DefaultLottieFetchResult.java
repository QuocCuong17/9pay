...
public class DefaultLottieFetchResult implements LottieFetchResult {
    ...
    public String error() {
        try {
            ...
            return "Unable to fetch " + this.connection.getURL() + ". Failed with " + this.connection.getResponseCode() + IOUtils.LINE_SEPARATOR_UNIX + getErrorFromConnection(this.connection);
        } catch (IOException e) {

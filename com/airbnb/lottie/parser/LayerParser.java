...
public class LayerParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.of("nm", "ind", "refId", "ty", "parent", "sw", "sh", "sc", "ks", TtmlNode.TAG_TT, "masksProperties", "shapes", "t", "ef", "sr", "st", "w", CmcdData.Factory.STREAMING_FORMAT_HLS, "ip", "op", "tm", "cl", "hd");
    ...
    public static Layer parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        ...
        arrayList2.add(new Keyframe(lottieComposition, valueOf, valueOf, null, f3, Float.valueOf(f5)));
        arrayList2.add(new Keyframe(lottieComposition, valueOf2, valueOf2, null, f5, Float.valueOf(Float.MAX_VALUE)));

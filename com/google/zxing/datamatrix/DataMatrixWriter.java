...
public final class DataMatrixWriter implements Writer {
    ...
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int i, int i2, Map<EncodeHintType, ?> map) {
        ...
        if (map != null && map.containsKey(EncodeHintType.DATA_MATRIX_COMPACT) && Boolean.parseBoolean(map.get(EncodeHintType.DATA_MATRIX_COMPACT).toString())) {
            ...
            encodeHighLevel = MinimalEncoder.encodeHighLevel(str, map.containsKey(EncodeHintType.CHARACTER_SET) ? Charset.forName(map.get(EncodeHintType.CHARACTER_SET).toString()) : null, z ? 29 : -1, symbolShapeHint);
        } else {

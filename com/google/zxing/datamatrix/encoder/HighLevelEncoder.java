    ...
    static int lookAheadTestIntern(CharSequence charSequence, int i, int i2) {
        ...
        while (true) {
            ...
            if (i5 >= 4) {
                ...
                if (iArr2[0] < min(iArr2[i3], iArr2[1], iArr2[2], iArr2[3], iArr2[4])) {
                    return 0;
                }
                if (iArr2[i3] < iArr2[0] || iArr2[i3] + 1 < min(iArr2[1], iArr2[2], iArr2[3], iArr2[4])) {
                    break;
                }
                if (iArr2[4] + 1 < min(iArr2[i3], iArr2[1], iArr2[2], iArr2[3], iArr2[0])) {
                    return 4;
                }
                if (iArr2[2] + 1 < min(iArr2[i3], iArr2[1], iArr2[4], iArr2[3], iArr2[0])) {
                    return 2;
                }
                if (iArr2[3] + 1 < min(iArr2[i3], iArr2[1], iArr2[4], iArr2[2], iArr2[0])) {
                    return 3;
                }
                if (iArr2[1] + 1 >= min(iArr2[0], iArr2[i3], iArr2[4], iArr2[2])) {
                    continue;
                } else {
                    if (iArr2[1] < iArr2[3]) {
                        return 1;

...
public final class PDF417ScanningDecoder {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x007e, code lost:
        ...
        if (r4.getDetectionResultColumn(r8) == null) goto L30;
     */
    ...
    */
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i, int i2) throws NotFoundException, FormatException, ChecksumException {
        ...
        while (true) {
            ...
            if (resultPoint != null) {
                detectionResultRowIndicatorColumn = getRowIndicatorColumn(bitMatrix, boundingBox2, resultPoint, true, i, i2);
            }
            if (resultPoint3 != null) {
                detectionResultRowIndicatorColumn2 = getRowIndicatorColumn(bitMatrix, boundingBox2, resultPoint3, false, i, i2);
            }
            ...
            if (!z || boundingBox == null || (boundingBox.getMinY() >= boundingBox2.getMinY() && boundingBox.getMaxY() <= boundingBox2.getMaxY())) {
                break;
            }
            z = false;
        }

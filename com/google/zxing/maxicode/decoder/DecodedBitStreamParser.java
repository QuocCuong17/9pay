...
final class DecodedBitStreamParser {
    ...
    private static final byte[] COUNTRY_BYTES = {53, 54, 43, ISO7816.INS_UNBLOCK_CHV, 45, 46, 47, ISO7816.INS_DECREASE, 37, 38};
    private static final byte[] SERVICE_CLASS_BYTES = {55, 56, 57, 58, 59, 60, 49, ISO7816.INS_INCREASE, 51, ISO7816.INS_DECREASE_STAMPED};
    private static final byte[] POSTCODE_2_LENGTH_BYTES = {39, 40, 41, ISO7816.INS_PSO, Ascii.US, 32};
    private static final byte[] POSTCODE_2_BYTES = {33, ISO7816.INS_MSE, 35, ISO7816.INS_CHANGE_CHV, Ascii.EM, Ascii.SUB, Ascii.ESC, 28, 29, 30, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, 13, 14, 15, 16, 17, Ascii.DC2, 7, 8, 9, 10, 11, 12, 1, 2};
    private static final byte[][] POSTCODE_3_BYTES = {new byte[]{39, 40, 41, ISO7816.INS_PSO, Ascii.US, 32}, new byte[]{33, ISO7816.INS_MSE, 35, ISO7816.INS_CHANGE_CHV, Ascii.EM, Ascii.SUB}, new byte[]{Ascii.ESC, 28, 29, 30, 19, Ascii.DC4}, new byte[]{Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, 13, 14}, new byte[]{15, 16, 17, Ascii.DC2, 7, 8}, new byte[]{9, 10, 11, 12, 1, 2}};

...
public final class WifiResultParser extends ResultParser {
    ...
    public WifiParsedResult parse(Result result) {
        ...
        if (matchSinglePrefixedField5 == null) {
            ...
            if (matchSinglePrefixedField4 != null || ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equalsIgnoreCase(matchSinglePrefixedField5) || "false".equalsIgnoreCase(matchSinglePrefixedField5)) {
                str = matchSinglePrefixedField4;

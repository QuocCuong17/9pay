...
public final class Code39Reader extends OneDReader {
    ...
    static final int[] CHARACTER_ENCODINGS = {52, BaselineTIFFTagSet.TAG_FREE_BYTE_COUNTS, 97, 352, 49, 304, 112, 37, BaselineTIFFTagSet.TAG_T4_OPTIONS, 100, BaselineTIFFTagSet.TAG_CELL_LENGTH, 73, FaxTIFFTagSet.TAG_CONSECUTIVE_BAD_LINES, 25, BaselineTIFFTagSet.TAG_MIN_SAMPLE_VALUE, 88, 13, 268, 76, 28, BaselineTIFFTagSet.TAG_COMPRESSION, 67, BaselineTIFFTagSet.TAG_TILE_WIDTH, 19, BaselineTIFFTagSet.TAG_ORIENTATION, 82, 7, BaselineTIFFTagSet.TAG_PHOTOMETRIC_INTERPRETATION, 70, 22, 385, CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256, 448, CipherSuite.TLS_DHE_PSK_WITH_AES_256_CBC_SHA, 400, 208, 133, 388, CipherSuite.TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA256, 168, CipherSuite.TLS_DHE_DSS_WITH_AES_128_GCM_SHA256, 138, 42};
    ...
    public Result decodeRow(int i, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        while (true) {
            ...
            if (patternToChar == '*') {
                ...
                float f = i;
                Result result = new Result(sb, null, new ResultPoint[]{new ResultPoint((r2[1] + r2[0]) / 2.0f, f), new ResultPoint(nextSet + (i4 / 2.0f), f)}, BarcodeFormat.CODE_39);

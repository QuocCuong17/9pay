...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{BaselineTIFFTagSet.TAG_JPEG_DC_TABLES}, "GR");
            add(new int[]{528}, ExpandedProductParsedResult.POUND);
            add(new int[]{BaselineTIFFTagSet.TAG_Y_CB_CR_COEFFICIENTS}, "CY");
            add(new int[]{BaselineTIFFTagSet.TAG_Y_CB_CR_POSITIONING}, "MK");
            add(new int[]{535}, "MT");
            add(new int[]{539}, "IE");
            ...
            add(new int[]{590}, "PL");
            add(new int[]{594}, "RO");
            add(new int[]{HttpStatusCodeRange.DEFAULT_MAX}, "HU");

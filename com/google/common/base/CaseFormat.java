...
public abstract class CaseFormat {
    ...
    public static final CaseFormat LOWER_HYPHEN = new CaseFormat("LOWER_HYPHEN", 0, CharMatcher.is('-'), Parameters.DEFAULT_OPTION_PREFIXES) { // from class: com.google.common.base.CaseFormat.1
    ...
    String convert(CaseFormat format, String s) {
        ...
        while (true) {
            ...
            if (i == 0) {
                ...
                sb.append(format.normalizeWord(s.substring(i, i2)));
            }
        ...
        java.util.Objects.requireNonNull(sb);
        sb.append(format.normalizeWord(s.substring(i)));
        return sb.toString();
    }

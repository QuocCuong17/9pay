...
public final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        private void bmix64(long k1, long k2) {
            ...
            this.h1 = j2;
            this.h1 = (j2 * 5) + 1390208809;
            long mixK2 = mixK2(k2) ^ j;
            this.h2 = mixK2;
            long rotateLeft2 = Long.rotateLeft(mixK2, 31);
            this.h2 = rotateLeft2;
            long j3 = rotateLeft2 + this.h1;
            this.h2 = j3;
            this.h2 = (j3 * 5) + 944331445;
        }
        ...
        protected void processRemaining(ByteBuffer bb) {
            ...
            switch (bb.remaining()) {
                case 1:
                    j = 0;
                    j7 = UnsignedBytes.toInt(bb.get(0)) ^ j;
                    this.h1 ^= mixK1(j7);
                    this.h2 ^= mixK2(j15);
                    return;
                case 2:
                ...
                case 6:
                    ...
                    return;
                case 7:
                    j6 = (UnsignedBytes.toInt(bb.get(6)) << 48) ^ 0;
                    j5 = j6 ^ (UnsignedBytes.toInt(bb.get(5)) << 40);
                    j4 = j5 ^ (UnsignedBytes.toInt(bb.get(4)) << 32);
                    j3 = j4 ^ (UnsignedBytes.toInt(bb.get(3)) << 24);
                    j2 = j3 ^ (UnsignedBytes.toInt(bb.get(2)) << 16);
                ...
                case 9:
                    j9 = 0;
                    j8 = j9 ^ UnsignedBytes.toInt(bb.get(8));
                    j7 = bb.getLong() ^ 0;
                    j15 = j8;
                    this.h1 ^= mixK1(j7);
                    this.h2 ^= mixK2(j15);
                ...
                case 10:
                    j10 = 0;
                    j9 = j10 ^ (UnsignedBytes.toInt(bb.get(9)) << 8);
                    j8 = j9 ^ UnsignedBytes.toInt(bb.get(8));
                    j7 = bb.getLong() ^ 0;
                    j15 = j8;
                    this.h1 ^= mixK1(j7);
                ...
                case 11:
                    j11 = 0;
                    j10 = j11 ^ (UnsignedBytes.toInt(bb.get(10)) << 16);
                    j9 = j10 ^ (UnsignedBytes.toInt(bb.get(9)) << 8);
                    j8 = j9 ^ UnsignedBytes.toInt(bb.get(8));
                    j7 = bb.getLong() ^ 0;
                    j15 = j8;
                ...
                case 12:
                    j12 = 0;
                    j11 = j12 ^ (UnsignedBytes.toInt(bb.get(11)) << 24);
                    j10 = j11 ^ (UnsignedBytes.toInt(bb.get(10)) << 16);
                    j9 = j10 ^ (UnsignedBytes.toInt(bb.get(9)) << 8);
                    j8 = j9 ^ UnsignedBytes.toInt(bb.get(8));
                    j7 = bb.getLong() ^ 0;
                ...
                case 13:
                    j13 = 0;
                    j12 = j13 ^ (UnsignedBytes.toInt(bb.get(12)) << 32);
                    j11 = j12 ^ (UnsignedBytes.toInt(bb.get(11)) << 24);
                    j10 = j11 ^ (UnsignedBytes.toInt(bb.get(10)) << 16);
                    j9 = j10 ^ (UnsignedBytes.toInt(bb.get(9)) << 8);
                    j8 = j9 ^ UnsignedBytes.toInt(bb.get(8));
                ...
                case 14:
                    j14 = 0;
                    j13 = j14 ^ (UnsignedBytes.toInt(bb.get(13)) << 40);
                    j12 = j13 ^ (UnsignedBytes.toInt(bb.get(12)) << 32);
                    j11 = j12 ^ (UnsignedBytes.toInt(bb.get(11)) << 24);
                    j10 = j11 ^ (UnsignedBytes.toInt(bb.get(10)) << 16);
                    j9 = j10 ^ (UnsignedBytes.toInt(bb.get(9)) << 8);
                    ...
                    return;
                case 15:
                    j14 = (UnsignedBytes.toInt(bb.get(14)) << 48) ^ 0;
                    j13 = j14 ^ (UnsignedBytes.toInt(bb.get(13)) << 40);
                    j12 = j13 ^ (UnsignedBytes.toInt(bb.get(12)) << 32);
                    j11 = j12 ^ (UnsignedBytes.toInt(bb.get(11)) << 24);
                    j10 = j11 ^ (UnsignedBytes.toInt(bb.get(10)) << 16);

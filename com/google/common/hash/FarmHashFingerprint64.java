    ...
    private static long hashLength65Plus(byte[] bytes, int offset, int length) {
        ...
        while (true) {
            ...
            if (i6 == i2) {
                ...
                long rotateRight4 = Long.rotateRight(rotateRight3 + load642 + jArr[0] + LittleEndianByteArray.load64(bytes, i4 + 8), 37) * j4;
                long rotateRight5 = Long.rotateRight(load642 + jArr[1] + LittleEndianByteArray.load64(bytes, i4 + 48), 42) * j4;
                long j5 = rotateRight4 ^ (jArr2[1] * 9);
                long load643 = rotateRight5 + (jArr[0] * 9) + LittleEndianByteArray.load64(bytes, i4 + 40);
                long rotateRight6 = Long.rotateRight(j3 + jArr2[0], 33) * j4;
                weakHashLength32WithSeeds(bytes, i4, jArr[1] * j4, j5 + jArr2[0], jArr);
                weakHashLength32WithSeeds(bytes, i4 + 32, rotateRight6 + jArr2[1], load643 + LittleEndianByteArray.load64(bytes, i4 + 16), jArr2);
                return hashLength16(hashLength16(jArr[0], jArr2[0], j4) + (shiftMix(load643) * K0) + j5, hashLength16(jArr[1], jArr2[1], j4) + rotateRight6, j4);
            }
            i5 = i6;
            shiftMix = j3;
            j2 = load642;

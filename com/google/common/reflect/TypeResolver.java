...
public final class TypeResolver {
    ...
    private static class WildcardCapturer {
        ...
        private final AtomicInteger f74id;
        ...
        TypeVariable<?> captureAsTypeVariable(Type[] upperBounds) {
            return Types.newArtificialTypeVariable(WildcardCapturer.class, "capture#" + this.f74id.incrementAndGet() + "-of ? extends " + Joiner.on(Typography.amp).join(upperBounds), upperBounds);
        }

        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeParam) {
            return new WildcardCapturer(this, this.f74id) { // from class: com.google.common.reflect.TypeResolver.WildcardCapturer.1
        ...
        private WildcardCapturer notForTypeVariable() {
            return new WildcardCapturer(this.f74id);
        }

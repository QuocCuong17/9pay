...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    */
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        ...
        if (!attributeSet.getAttributeBooleanValue(NAMESPACE_ANDROID, WorkflowModule.Properties.Section.Component.SubType.Text.SINGLE_LINE, true) || attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "lines", 1) != 1 || attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "minLines", 1) != 1 || attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "maxLines", 1) != 1) {

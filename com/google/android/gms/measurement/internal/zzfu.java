...
public final class zzfu extends zzku implements zzaf {
    ...
    */
                        ...
                        return new com.google.android.gms.internal.measurement.zzu("internal.appMetadata", new Callable() { // from class: com.google.android.gms.measurement.internal.zzfn
                            ...
                            public final Object call() {
                                ...
                                if (zzj != null) {
                                    String zzy = zzj.zzy();
                                    if (zzy != null) {
                                        hashMap.put(App.JsonKeys.APP_VERSION, zzy);
                                    }
    ...
    public final boolean zzv(String str) {
        zzg();
        zzC(str);
        return this.zza.get(str) != null && (((Set) this.zza.get(str)).contains(ProfilingTraceData.JsonKeys.DEVICE_MODEL) || ((Set) this.zza.get(str)).contains(DeviceRequestsHelper.DEVICE_INFO_PARAM));
    }
    ...
    public final boolean zzy(String str) {
        zzg();
        zzC(str);
        return this.zza.get(str) != null && (((Set) this.zza.get(str)).contains("os_version") || ((Set) this.zza.get(str)).contains(DeviceRequestsHelper.DEVICE_INFO_PARAM));
    }

        ...
        if (cCTDestination.getSupportedEncodings().contains(Encoding.of(WorkflowRequestType.JSON))) {
            this.zza = new Lazy(new Provider() { // from class: com.google.android.gms.internal.mlkit_common.zzmv
                ...
                public final Object get() {
                    return TransportFactory.this.getTransport("FIREBASE_ML_SDK", byte[].class, Encoding.of(WorkflowRequestType.JSON), new Transformer() { // from class: com.google.android.gms.internal.mlkit_common.zzmx

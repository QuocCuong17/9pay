...
final class zzbn implements ObjectEncoderContext {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzbn zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzbn zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzbl zzj = zzj(fieldDescriptor);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzbn zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());

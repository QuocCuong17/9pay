...
public final class zzol implements zzok {
    ...
    static {
        ...
        zzj = zza2.zzd("measurement.store.max_stored_events_per_app", SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US);
        ...
        zzn = zza2.zzd("measurement.alarm_manager.minimum_interval", 60000L);
        zzo = zza2.zzd("measurement.upload.minimum_delay", 500L);
        zzp = zza2.zzd("measurement.monitoring.sample_period_millis", 86400000L);
        zzq = zza2.zzd("measurement.upload.realtime_upload_interval", Renderer.DEFAULT_DURATION_TO_PROGRESS_US);
        ...
        zzz = zza2.zzd("measurement.upload.initial_upload_delay_time", C.DEFAULT_SEEK_FORWARD_INCREMENT_MS);
        ...
        zzG = zza2.zzd("measurement.upload.max_events_per_day", SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US);
        ...
        zzM = zza2.zzd("measurement.upload.retry_time", 1800000L);

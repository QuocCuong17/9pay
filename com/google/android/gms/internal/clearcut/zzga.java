                ...
                if (name2.startsWith("set")) {
                    ...
                    try {
                        ...
                        if (((Boolean) cls.getMethod(valueOf.length() != 0 ? "has".concat(valueOf) : new String("has"), new Class[0]).invoke(obj, new Object[0])).booleanValue()) {
                            ...
                            zza(substring, cls.getMethod(valueOf2.length() != 0 ? WorkflowRequestType.Method.GET.concat(valueOf2) : new String(WorkflowRequestType.Method.GET), new Class[0]).invoke(obj, new Object[0]), stringBuffer, stringBuffer2);
                        }

...
public class GoogleApiManager implements Handler.Callback {
    ...
    private long zag = Renderer.DEFAULT_DURATION_TO_PROGRESS_US;
    ...
    public final boolean handleMessage(Message message) {
        ...
        switch (message.what) {
            case 1:
                this.zag = true == ((Boolean) message.obj).booleanValue() ? Renderer.DEFAULT_DURATION_TO_PROGRESS_US : 300000L;

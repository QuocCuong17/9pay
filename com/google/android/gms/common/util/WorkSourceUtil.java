...
public class WorkSourceUtil {
    ...
    static {
        ...
        if (PlatformVersion.isAtLeastJellyBeanMR2()) {
            ...
            zzd = method7;
            Method method8 = WorkSource.class.getMethod(WorkflowRequestType.Method.GET, Integer.TYPE);
            zze = method8;
            if (PlatformVersion.isAtLeastJellyBeanMR2()) {
                try {
        ...
        zzd = method72;
        Method method82 = WorkSource.class.getMethod(WorkflowRequestType.Method.GET, Integer.TYPE);
        zze = method82;
        if (PlatformVersion.isAtLeastJellyBeanMR2()) {
        }
        method3 = null;

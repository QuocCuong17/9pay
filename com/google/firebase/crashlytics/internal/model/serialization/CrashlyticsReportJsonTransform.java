...
public class CrashlyticsReportJsonTransform {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                case -2118372775:
                    ...
                    break;
                case -1962630338:
                    if (nextName.equals(AnalyticsLogger.Keys.SDK_VERSION)) {
                        c = 1;
                        break;
                    }
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    builder.setInternalKeys(parseArray(jsonReader, new ObjectParser() { // from class: com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform$$ExternalSyntheticLambda6
                        @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.ObjectParser
                        public final Object parse(JsonReader jsonReader2) {
                    ...
                    break;
                case 3:
                    builder.setCustomAttributes(parseArray(jsonReader, new ObjectParser() { // from class: com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform$$ExternalSyntheticLambda6
                        @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.ObjectParser
                        public final Object parse(JsonReader jsonReader2) {
                            CrashlyticsReport.CustomAttribute parseCustomAttribute;
                            parseCustomAttribute = CrashlyticsReportJsonTransform.parseCustomAttribute(jsonReader2);
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    builder.setBinaries(parseArray(jsonReader, new ObjectParser() { // from class: com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform$$ExternalSyntheticLambda5
                        @Override // com.google.firebase.crashlytics.internal.model.serialization.CrashlyticsReportJsonTransform.ObjectParser
                        public final Object parse(JsonReader jsonReader2) {
    ...
    private static CrashlyticsReport.Session.Event.Application.Execution.Exception parseEventExecutionException(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                case 0:
                    builder.setFrames(parseArray(jsonReader, CrashlyticsReportJsonTransform$$ExternalSyntheticLambda2.INSTANCE));
                    break;
                case 1:

...
public final /* data */ class SessionDetails {
    ...
    public int hashCode() {
        return (((((this.sessionId.hashCode() * 31) + this.firstSessionId.hashCode()) * 31) + this.sessionIndex) * 31) + TransactionState$ModuleData$$ExternalSyntheticBackport0.m(this.sessionStartTimestampUs);
    }

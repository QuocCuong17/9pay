...
public final class SessionInitiator {
    ...
    public SessionInitiator(TimeProvider timeProvider, CoroutineContext backgroundDispatcher, SessionInitiateListener sessionInitiateListener, SessionsSettings sessionsSettings, SessionGenerator sessionGenerator) {
        ...
        this.backgroundTime = timeProvider.mo908elapsedRealtimeUwyO8pc();
        initiateSession();
    ...
    public final void appBackgrounded() {
        this.backgroundTime = this.timeProvider.mo908elapsedRealtimeUwyO8pc();
    }

    public final void appForegrounded() {
        if (Duration.m2527compareToLRDsOJo(Duration.m2563minusLRDsOJo(this.timeProvider.mo908elapsedRealtimeUwyO8pc(), this.backgroundTime), this.sessionsSettings.m911getSessionRestartTimeoutUwyO8pc()) > 0) {
            initiateSession();
        }
    }

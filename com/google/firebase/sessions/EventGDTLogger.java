...
public final class EventGDTLogger implements EventGDTLoggerInterface {
    ...
    public void log(SessionEvent sessionEvent) {
        ...
        this.transportFactoryProvider.get().getTransport(AQS_LOG_SOURCE, SessionEvent.class, Encoding.of(WorkflowRequestType.JSON), new Transformer() { // from class: com.google.firebase.sessions.EventGDTLogger$$ExternalSyntheticLambda0

...
public final class SessionsSettings {
    ...
    public final long m911getSessionRestartTimeoutUwyO8pc() {
        Duration mo909getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo909getSessionRestartTimeoutFghU774();
        if (mo909getSessionRestartTimeoutFghU774 != null) {
            long rawValue = mo909getSessionRestartTimeoutFghU774.getRawValue();
            if (m910isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration mo909getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo909getSessionRestartTimeoutFghU774();
        if (mo909getSessionRestartTimeoutFghU7742 != null) {
            long rawValue2 = mo909getSessionRestartTimeoutFghU7742.getRawValue();
            if (m910isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m910isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m2562isPositiveimpl(sessionRestartTimeout) && Duration.m2557isFiniteimpl(sessionRestartTimeout);
    }

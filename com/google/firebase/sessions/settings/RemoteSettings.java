...
public final class RemoteSettings implements SettingsProvider {
    ...
    public Duration mo909getSessionRestartTimeoutFghU774() {
        Integer sessionRestartTimeout = this.settingsCache.sessionRestartTimeout();
        if (sessionRestartTimeout == null) {
            return null;
        }
        Duration.Companion companion = Duration.INSTANCE;
        return Duration.m2526boximpl(DurationKt.toDuration(sessionRestartTimeout.intValue(), DurationUnit.SECONDS));
    }
        ...
        try {
            if (continuation instanceof RemoteSettings$updateSettings$1) {
                ...
                if ((remoteSettings$updateSettings$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    Task<String> id2 = remoteSettings.firebaseInstallationsApi.getId();
                    Intrinsics.checkNotNullExpressionValue(id2, "firebaseInstallationsApi.id");
                    remoteSettings$updateSettings$1.L$0 = remoteSettings;
                    remoteSettings$updateSettings$1.L$1 = mutex;
                    remoteSettings$updateSettings$1.label = 2;
                    Object await = TasksKt.await(id2, remoteSettings$updateSettings$1);

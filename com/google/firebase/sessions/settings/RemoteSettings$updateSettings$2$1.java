            ...
            case 0:
                ...
                if (bool == null) {
                    ...
                    if (num2 != null) {
                        ...
                        this.L$2 = null;
                        this.label = 4;
                        if (settingsCache4.updateSessionCacheDuration(num4, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                        unit = Unit.INSTANCE;
                        if (unit == null) {

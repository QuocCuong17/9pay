...
public final /* data */ class DataCollectionStatus {
    ...
    public int hashCode() {
        return (((this.performance.hashCode() * 31) + this.crashlytics.hashCode()) * 31) + InAppPurchase$$ExternalSyntheticBackport0.m(this.sessionSamplingRate);
    }

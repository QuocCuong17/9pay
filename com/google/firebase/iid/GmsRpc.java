...
public class GmsRpc {
    ...
    private Bundle setDefaultAttributesToBundle(String str, String str2, String str3, Bundle bundle) {
        ...
        bundle.putString(FormFragment.ARG_SUBTYPE, str2);
    ...
    public Task<?> deleteInstanceId(String str) {
        ...
        bundle.putString("iid-operation", TransactionState.ModuleData.ACTION_DELETE);
        bundle.putString(TransactionState.ModuleData.ACTION_DELETE, "1");
        return extractResponseWhenComplete(startRpc(str, ProxyConfig.MATCH_ALL_SCHEMES, ProxyConfig.MATCH_ALL_SCHEMES, bundle));
    }

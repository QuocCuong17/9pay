...
public class FcmBroadcastProcessor {
    ...
    public FcmBroadcastProcessor(Context context) {
        ...
        this.executor = DashDownloader$$ExternalSyntheticLambda0.INSTANCE;
    }
    ...
    public static /* synthetic */ Task lambda$startMessagingService$2(Context context, Intent intent, boolean z, Task task) throws Exception {
        return (PlatformVersion.isAtLeastO() && ((Integer) task.getResult()).intValue() == 402) ? bindToMessagingService(context, intent, z).continueWith(DashDownloader$$ExternalSyntheticLambda0.INSTANCE, new Continuation() { // from class: com.google.firebase.messaging.FcmBroadcastProcessor$$ExternalSyntheticLambda2
            @Override // com.google.android.gms.tasks.Continuation
    ...
    private static Task<Integer> bindToMessagingService(Context context, Intent intent, boolean z) {
        ...
        return serviceConnection.sendIntent(intent).continueWith(DashDownloader$$ExternalSyntheticLambda0.INSTANCE, new Continuation() { // from class: com.google.firebase.messaging.FcmBroadcastProcessor$$ExternalSyntheticLambda1
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task) {

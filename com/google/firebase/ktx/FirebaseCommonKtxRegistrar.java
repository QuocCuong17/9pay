...
public final class FirebaseCommonKtxRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        return CollectionsKt.listOf((Object[]) new Component[]{LibraryVersionComponent.create(FirebaseKt.LIBRARY_NAME, BuildConfig.VERSION_NAME), build, build2, build3, build4});
    }
}

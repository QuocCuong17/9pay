    ...
    private FieldsData getBoundFields(Gson gson, TypeToken<?> typeToken, Class<?> cls, boolean z, boolean z2) {
        ...
        while (cls2 != Object.class) {
            ...
            while (i3 < length) {
                ...
                boolean includeField = includeField(field, z6);
                ...
                if (includeField || includeField2) {
                    ...
                    if (z2) {
                        if (!Modifier.isStatic(field.getModifiers())) {
                            ...
                            i2 = length;
                            z4 = r7;
                            BoundField createBoundField = createBoundField(gson, field, method, str, TypeToken.get(resolve), includeField, z7);
                            if (z3) {
                    ...
                    i2 = length;
                    z4 = r7;
                    BoundField createBoundField2 = createBoundField(gson, field, method, str, TypeToken.get(resolve2), includeField, z7);
                    if (z3) {
                    }
                    if (includeField) {
                        throw createDuplicateFieldException(cls, str, boundField.field, field);

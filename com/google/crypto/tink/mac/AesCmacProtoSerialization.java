...
public final class AesCmacProtoSerialization {
    ...
    static {
        ...
        PARAMETERS_SERIALIZER = ParametersSerializer.create(new ParametersSerializer.ParametersSerializationFunction() { // from class: com.google.crypto.tink.mac.AesCmacProtoSerialization$$ExternalSyntheticLambda3
        ...
        PARAMETERS_PARSER = ParametersParser.create(new ParametersParser.ParametersParsingFunction() { // from class: com.google.crypto.tink.mac.AesCmacProtoSerialization$$ExternalSyntheticLambda2
        ...
        KEY_SERIALIZER = KeySerializer.create(new KeySerializer.KeySerializationFunction() { // from class: com.google.crypto.tink.mac.AesCmacProtoSerialization$$ExternalSyntheticLambda1
        ...
        KEY_PARSER = KeyParser.create(new KeyParser.KeyParsingFunction() { // from class: com.google.crypto.tink.mac.AesCmacProtoSerialization$$ExternalSyntheticLambda0

...
final class Field25519 {
    ...
    public static byte[] contract(long[] inputLimbs) {
        ...
        for (int i11 = 2; i11 < 10; i11 += 2) {
            copyOf[i11] = copyOf[i11] - (67108863 & gte);
            int i12 = i11 + 1;
            copyOf[i12] = copyOf[i12] - j;
        }
        ...
        for (int i14 = 0; i14 < 10; i14++) {
            int[] iArr = EXPAND_START;
            bArr[iArr[i14]] = (byte) (bArr[r6] | (copyOf[i14] & 255));
            bArr[iArr[i14] + 1] = (byte) (bArr[r6] | ((copyOf[i14] >> 8) & 255));
            bArr[iArr[i14] + 2] = (byte) (bArr[r6] | ((copyOf[i14] >> 16) & 255));
            bArr[iArr[i14] + 3] = (byte) (bArr[r3] | ((copyOf[i14] >> 24) & 255));
        }
        return bArr;
    }

...
public final class HkdfPrfProtoSerialization {
    ...
    static {
        ...
        PARAMETERS_SERIALIZER = ParametersSerializer.create(new ParametersSerializer.ParametersSerializationFunction() { // from class: com.google.crypto.tink.prf.HkdfPrfProtoSerialization$$ExternalSyntheticLambda3
        ...
        PARAMETERS_PARSER = ParametersParser.create(new ParametersParser.ParametersParsingFunction() { // from class: com.google.crypto.tink.prf.HkdfPrfProtoSerialization$$ExternalSyntheticLambda2
        ...
        KEY_SERIALIZER = KeySerializer.create(new KeySerializer.KeySerializationFunction() { // from class: com.google.crypto.tink.prf.HkdfPrfProtoSerialization$$ExternalSyntheticLambda1
        ...
        KEY_PARSER = KeyParser.create(new KeyParser.KeyParsingFunction() { // from class: com.google.crypto.tink.prf.HkdfPrfProtoSerialization$$ExternalSyntheticLambda0

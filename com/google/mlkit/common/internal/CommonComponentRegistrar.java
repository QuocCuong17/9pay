...
public class CommonComponentRegistrar implements ComponentRegistrar {
    ...
    public final List getComponents() {
        return zzao.zzk(SharedPrefManager.COMPONENT, Component.builder(ModelFileHelper.class).add(Dependency.required((Class<?>) MlKitContext.class)).factory(new ComponentFactory() { // from class: com.google.mlkit.common.internal.zza

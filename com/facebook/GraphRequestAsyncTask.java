        ...
        try {
            ...
            try {
                if (this.connection == null) {
                    ...
                    executeConnectionAndWait = GraphRequest.INSTANCE.executeConnectionAndWait(this.connection, this.requests);
                }

...
public final class NativeProtocol {
    ...
    /* JADX WARN: Removed duplicated region for block: B:18:0x0089 A[Catch: all -> 0x0095, TRY_ENTER, TryCatch #1 {all -> 0x0095, blocks: (B:6:0x000c, B:29:0x0091, B:30:0x0094, B:18:0x0089), top: B:5:0x000c }] */
    /* JADX WARN: Removed duplicated region for block: B:20:0x006b A[EXC_TOP_SPLITTER, LOOP:0: B:20:0x006b->B:23:0x0071, LOOP_START, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:29:0x0091 A[Catch: all -> 0x0095, TryCatch #1 {all -> 0x0095, blocks: (B:6:0x000c, B:29:0x0091, B:30:0x0094, B:18:0x0089), top: B:5:0x000c }] */
    /*
    ...
    */
    private final TreeSet<Integer> fetchAllAvailableProtocolVersionsForAppInfo(NativeAppInfo appInfo) {
        ...
        try {
            ...
            try {
                try {
                    providerInfo = FacebookSdk.getApplicationContext().getPackageManager().resolveContentProvider(appInfo.getPackage() + PLATFORM_PROVIDER, 0);
    ...
    public static final class MessengerAppInfo extends NativeAppInfo {
        ...
        public Void m620getLoginActivity() {
            return null;
        }
        ...
        public /* bridge */ /* synthetic */ String getLoginActivity() {
            return (String) m620getLoginActivity();
        }
    }
    ...
    public static final class EffectTestAppInfo extends NativeAppInfo {
        /* renamed from: getLoginActivity, reason: collision with other method in class */
        public Void m619getLoginActivity() {
            return null;
        }
        ...
        @Override // com.facebook.internal.NativeProtocol.NativeAppInfo
        public /* bridge */ /* synthetic */ String getLoginActivity() {
            return (String) m619getLoginActivity();
        }
    }

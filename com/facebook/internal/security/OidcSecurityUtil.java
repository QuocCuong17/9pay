...
public final class OidcSecurityUtil {
    ...
    public static final String getRawKeyFromEndPoint(final String kid) {
        ...
        FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.internal.security.OidcSecurityUtil$$ExternalSyntheticLambda0
            ...
            public final void run() {
                OidcSecurityUtil.getRawKeyFromEndPoint$lambda$1(url, objectRef, kid, reentrantLock, newCondition);
            }
        });
    ...
    public static final PublicKey getPublicKeyFromString(String key) {
        ...
        byte[] decode = Base64.decode(StringsKt.replace$default(StringsKt.replace$default(StringsKt.replace$default(key, IOUtils.LINE_SEPARATOR_UNIX, "", false, 4, (Object) null), "-----BEGIN PUBLIC KEY-----", "", false, 4, (Object) null), "-----END PUBLIC KEY-----", "", false, 4, (Object) null), 0);

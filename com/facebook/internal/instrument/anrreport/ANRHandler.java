...
public final class ANRHandler {
    ...
    public static final void sendANRReports() {
        ...
        try {
            ...
            final List sortedWith = CollectionsKt.sortedWith(arrayList2, new Comparator() { // from class: com.facebook.internal.instrument.anrreport.ANRHandler$$ExternalSyntheticLambda1
                @Override // java.util.Comparator
                public final int compare(Object obj2, Object obj3) {
                    int sendANRReports$lambda$2;
                    sendANRReports$lambda$2 = ANRHandler.sendANRReports$lambda$2((InstrumentData) obj2, (InstrumentData) obj3);
            ...
            InstrumentUtility.sendReports("anr_reports", jSONArray, new GraphRequest.Callback() { // from class: com.facebook.internal.instrument.anrreport.ANRHandler$$ExternalSyntheticLambda0
                ...
                public final void onCompleted(GraphResponse graphResponse) {
                    ANRHandler.sendANRReports$lambda$5(sortedWith, graphResponse);
                }
            });
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, ANRHandler.class);

...
public final class FeatureManager {
    ...
    public enum Feature {
        ...
        Share(PDButton.FLAG_RADIOS_IN_UNISON);
        ...
        public final Feature getParent() {
            int i = this.code;
            if ((i & 255) > 0) {
                return INSTANCE.fromInt(i & InputDeviceCompat.SOURCE_ANY);
            }
            if ((65280 & i) > 0) {
                return INSTANCE.fromInt(i & SupportMenu.CATEGORY_MASK);
            }
            if ((16711680 & i) > 0) {
                return INSTANCE.fromInt(i & (-16777216));
            }

        ...
        try {
            ...
            for (Map map : arrayList) {
                ...
                for (String str : map.keySet()) {
                    CustomEventField invoke = CustomEventField.INSTANCE.invoke(str);
                    ...
                    if (invoke != null && sectionCustomEventFieldMapping != null) {
                        ...
                        if (section != null) {
                            if (section == ConversionsAPISection.CUSTOM_DATA) {
                                ...
                                Object transformValue$facebook_core_release = transformValue$facebook_core_release(str, obj);

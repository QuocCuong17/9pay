...
public final class HashUtils {
    ...
    @JvmStatic
    public static final String computeChecksumWithPackageManager(Context context, Long nanosTimeout) {
        ...
        try {
            ...
            method.invoke(context.getPackageManager(), context.getPackageName(), false, obj, CollectionsKt.toMutableList((Collection) mutableList), newProxyInstance);

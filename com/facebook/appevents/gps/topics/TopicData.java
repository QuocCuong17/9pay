...
public final /* data */ class TopicData {
    ...
    public int hashCode() {
        return (((TransactionState$ModuleData$$ExternalSyntheticBackport0.m(this.taxonomyVersion) * 31) + TransactionState$ModuleData$$ExternalSyntheticBackport0.m(this.modelVersion)) * 31) + this.topicId;
    }

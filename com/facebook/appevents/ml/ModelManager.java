...
public final class ModelManager {
    ...
    /* JADX WARN: Removed duplicated region for block: B:26:0x005c A[Catch: all -> 0x007c, Exception -> 0x0080, TryCatch #2 {Exception -> 0x0080, all -> 0x007c, blocks: (B:6:0x000d, B:8:0x001f, B:13:0x002c, B:14:0x0037, B:16:0x0045, B:18:0x004b, B:20:0x0073, B:23:0x0053, B:26:0x005c, B:27:0x0032), top: B:5:0x000d }] */
    /*
    ...
    */
    ...
    public static final class TaskHandler {
        ...
        /* compiled from: ModelManager.kt */
        @Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010 \n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0003\u001a\u0004\u0018\u00010\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006J\u0018\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\fH\u0002J\"\u0010\r\u001a\u00020\b2\b\u0010\u000e\u001a\u0004\u0018\u00010\n2\u0006\u0010\u000f\u001a\u00020\n2\u0006\u0010\u0010\u001a\u00020\u0011H\u0002J\u000e\u0010\u0012\u001a\u00020\b2\u0006\u0010\u0013\u001a\u00020\u0004J\u001c\u0010\u0012\u001a\u00020\b2\u0006\u0010\u0014\u001a\u00020\u00042\f\u0010\u0015\u001a\b\u0012\u0004\u0012\u00020\u00040\u0016¨\u0006\u0017"}, d2 = {"Lcom/facebook/appevents/ml/ModelManager$TaskHandler$Companion;", "", "()V", "build", "Lcom/facebook/appevents/ml/ModelManager$TaskHandler;", WorkflowRequestType.JSON, "Lorg/json/JSONObject;", "deleteOldFiles", "", "useCase", "", "versionId", "", "download", ShareConstants.MEDIA_URI, "name", "onComplete", "Lcom/facebook/appevents/internal/FileDownloadTask$Callback;", Constant.METHOD_EXECUTE, "handler", "master", "slaves", "", "facebook-core_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
        /* loaded from: classes2.dex */
            ...
            public final TaskHandler build(JSONObject json) {
                ...
                if (json != null) {
                    try {
                        ...
                        i = json.getInt(ModelManager.VERSION_ID_KEY);
            ...
            public static final void execute$lambda$1(List slaves, File file) {
                ...
                if (build != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        TaskHandler.INSTANCE.download(taskHandler.getRuleUri(), taskHandler.getUseCase() + '_' + taskHandler.getVersionId() + "_rule", new FileDownloadTask.Callback() { // from class: com.facebook.appevents.ml.ModelManager$TaskHandler$Companion$$ExternalSyntheticLambda0
                            @Override // com.facebook.appevents.internal.FileDownloadTask.Callback

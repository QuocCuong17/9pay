...
public final class AuthenticationToken implements Parcelable {
    ...
    private final boolean isValidSignature(String headerString, String claimsString, String sigString, String kid) {
        try {
            ...
            return OidcSecurityUtil.verify(OidcSecurityUtil.getPublicKeyFromString(rawKeyFromEndPoint), headerString + FilenameUtils.EXTENSION_SEPARATOR + claimsString, sigString);

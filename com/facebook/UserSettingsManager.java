...
public final class UserSettingsManager {
    ...
    public static final void initializeCodelessSetupEnabledAsync$lambda$0(long j) {
        ...
        try {
            if (advertiserIDCollectionEnabled.m577getValue() && (queryAppSettings = FetchedAppSettingsManager.queryAppSettings(FacebookSdk.getApplicationId(), false)) != null && queryAppSettings.getCodelessEventsEnabled()) {
    ...
    private final void logIfSDKSettingsChanged() {
        ...
        try {
            if (isInitialized.get() && FacebookSdk.isInitialized()) {
                Context applicationContext = FacebookSdk.getApplicationContext();
                int i3 = 0;
                int i4 = ((autoInitEnabled.m577getValue() ? 1 : 0) << 0) | 0 | ((autoLogAppEventsEnabledLocally.m577getValue() ? 1 : 0) << 1) | ((advertiserIDCollectionEnabled.m577getValue() ? 1 : 0) << 2) | ((monitorEnabled.m577getValue() ? 1 : 0) << 3);
                SharedPreferences sharedPreferences = userSettingPref;
    ...
    public static final boolean getAutoInitEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return autoInitEnabled.m577getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    */
    private final boolean checkAutoLogAppEventsEnabled() {
        ...
        try {
            ...
            if (cachedMigratedAutoLogValuesInAppSettings != null && !cachedMigratedAutoLogValuesInAppSettings.isEmpty()) {
                z = false;
                if (!z) {
                    return autoLogAppEventsEnabledLocally.m577getValue();
                }
    ...
    public static final boolean getAdvertiserIDCollectionEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return advertiserIDCollectionEnabled.m577getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getCodelessSetupEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return codelessSetupEnabled.m577getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final boolean getMonitorEnabled() {
        ...
        try {
            INSTANCE.initializeIfNotInitialized();
            return monitorEnabled.m577getValue();
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, UserSettingsManager.class);
            return false;
        }
    ...
    public static final class UserSetting {
        ...
        public final boolean m577getValue() {

...
public abstract class LoginMethodHandler implements Parcelable {
    ...
    public static final class Companion {
        ...
        */
        public final AccessToken createAccessTokenFromWebBundle(Collection<String> requestedPermissions, Bundle bundle, AccessTokenSource source, String applicationId) throws FacebookException {
                            ...
                            if (string2 != null) {
                                ...
                                if (str3.length() > 0) {
                                    ...
                                    if (Utility.isNullOrEmpty(string3)) {
                                        return new AccessToken(string3, applicationId, getUserIDFromSignedRequest(bundle.getString("signed_request")), collection, arrayList, arrayList2, source, bundleLongAsDate, new Date(), bundleLongAsDate2, bundle.getString("graph_domain"));
                                    }
                                    return null;
                                }
                            }

...
public final class PKCEUtil {
    ...
    public static final String generateCodeVerifier() {
        ...
        List plus = CollectionsKt.plus((Collection<? extends char>) CollectionsKt.plus((Collection<? extends char>) CollectionsKt.plus((Collection<? extends Character>) CollectionsKt.plus((Collection<? extends char>) CollectionsKt.plus((Collection) CollectionsKt.plus((Iterable) new CharRange('a', 'z'), (Iterable) new CharRange('A', Matrix.MATRIX_TYPE_ZERO)), (Iterable) new CharRange('0', '9')), '-'), Character.valueOf(FilenameUtils.EXTENSION_SEPARATOR)), '_'), '~');

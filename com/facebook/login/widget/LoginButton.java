...
public class LoginButton extends FacebookButtonBase {
    ...
    private final void checkToolTipSettings() {
        ...
        try {
            ...
            if (i == 1) {
                ...
                FacebookSdk.getExecutor().execute(new Runnable() { // from class: com.facebook.login.widget.LoginButton$$ExternalSyntheticLambda2
    ...
    public static final void checkToolTipSettings$lambda$3(String appId, final LoginButton this$0) {
        ...
        this$0.getActivity().runOnUiThread(new Runnable() { // from class: com.facebook.login.widget.LoginButton$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    protected final void parseLoginButtonAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        try {
            ...
            try {
                ...
                ToolTipMode fromInt = ToolTipMode.INSTANCE.fromInt(obtainStyledAttributes.getInt(R.styleable.com_facebook_login_view_com_facebook_tooltip_mode, ToolTipMode.INSTANCE.getDEFAULT().getIntValue()));
                if (fromInt == null) {
                    fromInt = ToolTipMode.INSTANCE.getDEFAULT();
                }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {
            ...
            setMeasuredDimension(Button.resolveSize(Math.max(loginButtonWidth, measureButtonWidth(str)), widthMeasureSpec), compoundPaddingTop);
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
        }
    }
    ...
    protected final int getLoginButtonWidth(int widthMeasureSpec) {
        ...
        try {
            ...
            if (str == null) {
                ...
                if (Button.resolveSize(measureButtonWidth, widthMeasureSpec) < measureButtonWidth) {
                ...
                if (LoginButton.this.confirmLogout) {
                    ...
                    builder.setMessage(string).setCancelable(true).setPositiveButton(string2, new DialogInterface.OnClickListener() { // from class: com.facebook.login.widget.LoginButton$LoginClickListener$$ExternalSyntheticLambda0
                        ...
                        public final void onClick(DialogInterface dialogInterface, int i) {
                            LoginButton.LoginClickListener.performLogout$lambda$2(LoginManager.this, dialogInterface, i);
                        }

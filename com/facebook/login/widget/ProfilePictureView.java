...
public final class ProfilePictureView extends FrameLayout {
    ...
    public final void refreshImage(boolean force) {
        ...
        try {
            ...
            if (str != null) {
                if (!(str.length() == 0) && !isUnspecifiedDimensions()) {
    ...
    private final void sendImageRequest(boolean allowCachedResponse) {
        ...
        try {
            ...
            ImageRequest build = new ImageRequest.Builder(context, profilePictureUri).setAllowCachedRedirects(allowCachedResponse).setCallerTag(this).setCallback(new ImageRequest.Callback() { // from class: com.facebook.login.widget.ProfilePictureView$$ExternalSyntheticLambda0
                @Override // com.facebook.internal.ImageRequest.Callback
                public final void onCompleted(ImageResponse imageResponse) {
                    ProfilePictureView.sendImageRequest$lambda$2(ProfilePictureView.this, imageResponse);
                }
            }).build();
            ImageRequest imageRequest = this.lastRequest;
            if (imageRequest != null) {

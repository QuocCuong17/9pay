...
public final class FacebookRequestError implements Parcelable {
    ...
    /* compiled from: FacebookRequestError.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0017\b\u0000\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0003¢\u0006\u0002\u0010\u0005J\u0011\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0003H\u0086\u0002R\u000e\u0010\u0004\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Lcom/facebook/FacebookRequestError$Range;", "", "start", "", TtmlNode.END, "(II)V", "contains", "", "value", "facebook-core_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* loaded from: classes2.dex */
                ...
                if (singleResult.has("code")) {
                    ...
                    if (stringPropertyAsJSON != null && (stringPropertyAsJSON instanceof JSONObject)) {
                        if (((JSONObject) stringPropertyAsJSON).has("error")) {
                            ...
                            optString = jSONObject != null ? jSONObject.optString("type", null) : null;
                            ...
                            str = jSONObject != null ? jSONObject.optString(FacebookRequestError.ERROR_USER_MSG_KEY, null) : null;
                            str2 = jSONObject != null ? jSONObject.optString(FacebookRequestError.ERROR_USER_TITLE_KEY, null) : null;
                            z = jSONObject != null ? jSONObject.optBoolean(FacebookRequestError.ERROR_IS_TRANSIENT_KEY, false) : false;
                            r11 = true;
                            str3 = optString2;
                            optInt = r12;
                            r12 = optInt2;
                            ...
                            if (!((JSONObject) stringPropertyAsJSON).has("error_code") && !((JSONObject) stringPropertyAsJSON).has(FacebookRequestError.ERROR_MSG_KEY) && !((JSONObject) stringPropertyAsJSON).has(FacebookRequestError.ERROR_REASON_KEY)) {
                                ...
                                str2 = null;
                                if (r11) {
                                    return new FacebookRequestError(i, r12, optInt, str4, str3, str2, str, (JSONObject) stringPropertyAsJSON, singleResult, batchResult, connection, null, z, null);
                                }
                            }

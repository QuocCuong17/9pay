...
public final class HostnameCache {
    ...
    HostnameCache(long j) {
        this(j, new Callable() { // from class: io.sentry.HostnameCache$$ExternalSyntheticLambda1
    ...
    private void updateCache() {
        try {
            this.executorService.submit(new Callable() { // from class: io.sentry.HostnameCache$$ExternalSyntheticLambda0
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return HostnameCache.this.m1131lambda$updateCache$1$iosentryHostnameCache();
                }
    ...
    public /* synthetic */ Void m1131lambda$updateCache$1$iosentryHostnameCache() throws Exception {
        try {

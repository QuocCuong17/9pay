...
final class EnvelopeFileObserver extends FileObserver {
    ...
    public void onEvent(int i, String str) {
        ...
        Hint createWithTypeCheckHint = HintUtils.createWithTypeCheckHint(new CachedEnvelopeHint(this.flushTimeoutMillis, this.logger));
        this.envelopeSender.processEnvelopeFile(this.rootPath + File.separator + str, createWithTypeCheckHint);
    }

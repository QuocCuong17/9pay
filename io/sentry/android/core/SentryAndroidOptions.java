...
public final class SentryAndroidOptions extends SentryOptions {
    ...
    private SdkVersion createSdkVersion() {
        SdkVersion updateSdkVersion = SdkVersion.updateSdkVersion(getSdkVersion(), BuildConfig.SENTRY_ANDROID_SDK_NAME, "6.30.0");
        updateSdkVersion.addPackage("maven:io.sentry:sentry-android-core", "6.30.0");

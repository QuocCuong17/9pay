...
public final class ActivityLifecycleIntegration implements Integration, Closeable, Application.ActivityLifecycleCallbacks {
        ...
        if (z) {
            ...
            transactionOptions.setTransactionFinishedCallback(new TransactionFinishedCallback() { // from class: io.sentry.android.core.ActivityLifecycleIntegration$$ExternalSyntheticLambda5
                ...
                public final void execute(ITransaction iTransaction) {
                    ActivityLifecycleIntegration.this.m1152x4339eaa7(weakReference, activityName, iTransaction);
                }
            });
            ...
            if (this.timeToFullDisplaySpanEnabled && this.fullyDisplayedReporter != null && this.options != null) {
                ...
                try {
                    ...
                    this.ttfdAutoCloseFuture = this.options.getExecutorService().schedule(new Runnable() { // from class: io.sentry.android.core.ActivityLifecycleIntegration$$ExternalSyntheticLambda8
                        @Override // java.lang.Runnable
                        public final void run() {
                            ActivityLifecycleIntegration.this.m1153xd0749c28(startChild3, startChild2);
                        }
                    }, 30000L);
            ...
            this.hub.configureScope(new ScopeCallback() { // from class: io.sentry.android.core.ActivityLifecycleIntegration$$ExternalSyntheticLambda4
                ...
                public final void run(Scope scope) {
                    ActivityLifecycleIntegration.this.m1154x5daf4da9(startTransaction, scope);
                }
            });
    ...
    public /* synthetic */ void m1152x4339eaa7(WeakReference weakReference, String str, ITransaction iTransaction) {
    ...
    public void m1154x5daf4da9(final Scope scope, final ITransaction iTransaction) {
        scope.withTransaction(new Scope.IWithTransaction() { // from class: io.sentry.android.core.ActivityLifecycleIntegration$$ExternalSyntheticLambda2
            ...
            public final void accept(ITransaction iTransaction2) {
                ActivityLifecycleIntegration.this.m1147xd15ba770(scope, iTransaction, iTransaction2);
            }
        });
    }

    /* renamed from: lambda$applyScope$3$io-sentry-android-core-ActivityLifecycleIntegration, reason: not valid java name */
    public /* synthetic */ void m1147xd15ba770(Scope scope, ITransaction iTransaction, ITransaction iTransaction2) {
    ...
    public void m1148x44f2e05d(final Scope scope, final ITransaction iTransaction) {
        scope.withTransaction(new Scope.IWithTransaction() { // from class: io.sentry.android.core.ActivityLifecycleIntegration$$ExternalSyntheticLambda1
            @Override // io.sentry.Scope.IWithTransaction
            public final void accept(ITransaction iTransaction2) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void lambda$clearScope$4(ITransaction iTransaction, Scope scope, ITransaction iTransaction2) {
    ...
    private void finishTransaction(final ITransaction iTransaction, ISpan iSpan, ISpan iSpan2) {
        ...
        if (iHub != null) {
            iHub.configureScope(new ScopeCallback() { // from class: io.sentry.android.core.ActivityLifecycleIntegration$$ExternalSyntheticLambda3
                @Override // io.sentry.ScopeCallback
                public final void run(Scope scope) {
                    ActivityLifecycleIntegration.this.m1148x44f2e05d(iTransaction, scope);
                }
            });
        }
    }
    ...
    public synchronized void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        if (fullyDisplayedReporter != null) {
            fullyDisplayedReporter.registerFullyDrawnListener(new FullyDisplayedReporter.FullyDisplayedReporterListener() { // from class: io.sentry.android.core.ActivityLifecycleIntegration$$ExternalSyntheticLambda0
                @Override // io.sentry.FullyDisplayedReporter.FullyDisplayedReporterListener
                public final void onFullyDrawn() {
                    ActivityLifecycleIntegration.this.m1149x7f71294d(iSpan);
                }
            });
        }
    }
    ...
    public synchronized void onActivityResumed(Activity activity) {
        if (this.performanceEnabled) {
            ...
            if (this.buildInfoProvider.getSdkInfoVersion() >= 16 && findViewById != null) {
                FirstDrawDoneListener.registerForNextDraw(findViewById, new Runnable() { // from class: io.sentry.android.core.ActivityLifecycleIntegration$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        ActivityLifecycleIntegration.this.m1150x90c9b07d(iSpan2, iSpan);
                    }
                ...
                this.mainHandler.post(new Runnable() { // from class: io.sentry.android.core.ActivityLifecycleIntegration$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        ActivityLifecycleIntegration.this.m1151x1e0461fe(iSpan2, iSpan);
                    }
                });
            }
        }
    ...
    public void m1151x1e0461fe(ISpan iSpan, ISpan iSpan2) {
        SentryAndroidOptions sentryAndroidOptions = this.options;
    ...
    public void m1149x7f71294d(ISpan iSpan) {
        SentryAndroidOptions sentryAndroidOptions = this.options;
    ...
    public void m1153xd0749c28(ISpan iSpan, ISpan iSpan2) {
        if (iSpan == null || iSpan.isFinished()) {
            return;
        }

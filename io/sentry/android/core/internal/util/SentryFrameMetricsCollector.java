...
public final class SentryFrameMetricsCollector implements Application.ActivityLifecycleCallbacks {
        ...
        if ((context instanceof Application) && buildInfoProvider.getSdkInfoVersion() >= 24) {
            ...
            new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: io.sentry.android.core.internal.util.SentryFrameMetricsCollector$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    SentryFrameMetricsCollector.this.m1166x2ab0da68();
                }
            });
            try {
            ...
            this.frameMetricsAvailableListener = new Window.OnFrameMetricsAvailableListener() { // from class: io.sentry.android.core.internal.util.SentryFrameMetricsCollector$$ExternalSyntheticLambda0
                @Override // android.view.Window.OnFrameMetricsAvailableListener
                public final void onFrameMetricsAvailable(Window window, FrameMetrics frameMetrics, int i) {
                    SentryFrameMetricsCollector.this.m1167x94e06287(buildInfoProvider, window, frameMetrics, i);
                }
            };
        }
    }
    ...
    public /* synthetic */ void m1166x2ab0da68() {
    ...
    public /* synthetic */ void m1167x94e06287(BuildInfoProvider buildInfoProvider, Window window, FrameMetrics frameMetrics, int i) {
        float refreshRate;

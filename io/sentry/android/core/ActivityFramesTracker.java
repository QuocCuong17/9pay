...
public final class ActivityFramesTracker {
        ...
        if (isFrameMetricsAggregatorAvailable()) {
            runSafelyOnUiThread(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    ActivityFramesTracker.this.m1143xd056273f(activity);
                }
    ...
    public /* synthetic */ void m1143xd056273f(Activity activity) {
    ...
    public synchronized void setMetrics(final Activity activity, SentryId sentryId) {
        if (isFrameMetricsAggregatorAvailable()) {
            runSafelyOnUiThread(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    ActivityFramesTracker.this.m1145lambda$setMetrics$1$iosentryandroidcoreActivityFramesTracker(activity);
                }
            }, null);
    ...
    public /* synthetic */ void m1145lambda$setMetrics$1$iosentryandroidcoreActivityFramesTracker(Activity activity) {
    ...
    public synchronized void stop() {
        if (isFrameMetricsAggregatorAvailable()) {
            runSafelyOnUiThread(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ActivityFramesTracker.this.m1146lambda$stop$2$iosentryandroidcoreActivityFramesTracker();
                }
    ...
    public /* synthetic */ void m1146lambda$stop$2$iosentryandroidcoreActivityFramesTracker() {
        ...
        try {
            if (AndroidMainThreadChecker.getInstance().isMainThread()) {
                ...
                this.handler.post(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        ActivityFramesTracker.this.m1144x49051cca(runnable, str);
                    }
                });
            }
    ...
    public /* synthetic */ void m1144x49051cca(Runnable runnable, String str) {
        try {
            runnable.run();
        } catch (Throwable unused) {
            if (str != null) {

...
public final class LifecycleWatcher implements DefaultLifecycleObserver {
        ...
        if (this.enableSessionTracking) {
            ...
            this.hub.configureScope(new ScopeCallback() { // from class: io.sentry.android.core.LifecycleWatcher$$ExternalSyntheticLambda0
                ...
                public final void run(Scope scope) {
                    LifecycleWatcher.this.m1159lambda$startSession$0$iosentryandroidcoreLifecycleWatcher(scope);
                }
            });
    ...
    public /* synthetic */ void m1159lambda$startSession$0$iosentryandroidcoreLifecycleWatcher(Scope scope) {
        Session session;

...
public final class SentryTracer implements ITransaction {
    ...
    public void finish(SpanStatus spanStatus, SentryDate sentryDate, boolean z) {
        ...
        if (!this.transactionOptions.isWaitForChildren() || hasAllChildrenFinished()) {
            ...
            List<PerformanceCollectionData> m1126lambda$start$0$iosentryDefaultTransactionPerformanceCollector = transactionPerformanceCollector != null ? transactionPerformanceCollector.m1126lambda$start$0$iosentryDefaultTransactionPerformanceCollector(this) : null;
            ProfilingTraceData onTransactionFinish = (Boolean.TRUE.equals(isSampled()) && Boolean.TRUE.equals(isProfileSampled())) ? this.hub.getOptions().getTransactionProfiler().onTransactionFinish(this, m1126lambda$start$0$iosentryDefaultTransactionPerformanceCollector) : null;
            if (m1126lambda$start$0$iosentryDefaultTransactionPerformanceCollector != null) {
                m1126lambda$start$0$iosentryDefaultTransactionPerformanceCollector.clear();
            }
            ...
            this.hub.configureScope(new ScopeCallback() { // from class: io.sentry.SentryTracer$$ExternalSyntheticLambda1
                ...
                public final void run(Scope scope) {
                    SentryTracer.this.m1140lambda$finish$1$iosentrySentryTracer(scope);
                }
            });
    ...
    public /* synthetic */ void m1140lambda$finish$1$iosentrySentryTracer(final Scope scope) {
        scope.withTransaction(new Scope.IWithTransaction() { // from class: io.sentry.SentryTracer$$ExternalSyntheticLambda0
            @Override // io.sentry.Scope.IWithTransaction
            public final void accept(ITransaction iTransaction) {
                SentryTracer.this.m1139lambda$finish$0$iosentrySentryTracer(scope, iTransaction);
            }
        });
    }

    /* renamed from: lambda$finish$0$io-sentry-SentryTracer, reason: not valid java name */
    public /* synthetic */ void m1139lambda$finish$0$iosentrySentryTracer(Scope scope, ITransaction iTransaction) {
    ...
    private ISpan createChild(SpanId spanId, String str, String str2, SentryDate sentryDate, Instrumenter instrumenter, SpanOptions spanOptions) {
        ...
        Span span = new Span(this.root.getTraceId(), spanId, this, str, this.hub, sentryDate, spanOptions, new SpanFinishedCallback() { // from class: io.sentry.SentryTracer$$ExternalSyntheticLambda3
            ...
            public final void execute(Span span2) {
                SentryTracer.this.m1138lambda$createChild$2$iosentrySentryTracer(span2);
            }
        });
    ...
    public /* synthetic */ void m1138lambda$createChild$2$iosentrySentryTracer(Span span) {

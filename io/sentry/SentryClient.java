...
public final class SentryClient implements ISentryClient {
            ...
            if (scope != null) {
                return scope.withSession(new Scope.IWithSession() { // from class: io.sentry.SentryClient$$ExternalSyntheticLambda0
                    ...
                    public final void accept(Session session) {
                        SentryClient.this.m1137lambda$updateSessionData$1$iosentrySentryClient(sentryEvent, hint, session);
                    }
                });
            }
    ...
    public /* synthetic */ void m1137lambda$updateSessionData$1$iosentrySentryClient(SentryEvent sentryEvent, Hint hint, Session session) {
        if (session != null) {
            String str = null;

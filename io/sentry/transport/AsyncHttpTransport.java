...
public final class AsyncHttpTransport implements ITransport {
    ...
    private static void markHintWhenSendingFailed(Hint hint, final boolean z) {
        HintUtils.runIfHasType(hint, SubmissionResult.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$$ExternalSyntheticLambda1
            @Override // io.sentry.util.HintUtils.SentryConsumer
            public final void accept(Object obj) {
                ((SubmissionResult) obj).setResult(false);
            }
        });
        HintUtils.runIfHasType(hint, Retryable.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$$ExternalSyntheticLambda0
            @Override // io.sentry.util.HintUtils.SentryConsumer
            public final void accept(Object obj) {
    ...
    public final class EnvelopeSender implements Runnable {
        ...
        public /* synthetic */ void m1197x71a92bcf(TransportResult transportResult, SubmissionResult submissionResult) {
        ...
        private TransportResult flush() {
            ...
            HintUtils.runIfHasType(this.hint, DiskFlushNotification.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$EnvelopeSender$$ExternalSyntheticLambda0
                @Override // io.sentry.util.HintUtils.SentryConsumer
                public final void accept(Object obj) {
                    AsyncHttpTransport.EnvelopeSender.this.m1193xad3aa5c9((DiskFlushNotification) obj);
                }
            });
            if (AsyncHttpTransport.this.transportGate.isConnected()) {
                ...
                try {
                    ...
                    if (send.getResponseCode() >= 400 && send.getResponseCode() != 429) {
                        HintUtils.runIfDoesNotHaveType(this.hint, Retryable.class, new HintUtils.SentryNullableConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$EnvelopeSender$$ExternalSyntheticLambda6
                            @Override // io.sentry.util.HintUtils.SentryNullableConsumer
                            public final void accept(Object obj) {
                                AsyncHttpTransport.EnvelopeSender.this.m1194xd68efb0a(attachReportToEnvelope, obj);
                            }
                        });
                    }
                    ...
                    HintUtils.runIfHasType(this.hint, Retryable.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$EnvelopeSender$$ExternalSyntheticLambda2
                        ...
                        public final void accept(Object obj, Class cls) {
                            AsyncHttpTransport.EnvelopeSender.this.m1195x2937a58c(attachReportToEnvelope, obj, cls);
                        }
                    });
            ...
            HintUtils.runIfHasType(this.hint, Retryable.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$EnvelopeSender$$ExternalSyntheticLambda3
                ...
                @Override // io.sentry.util.HintUtils.SentryHintFallback
                public final void accept(Object obj, Class cls) {
                    AsyncHttpTransport.EnvelopeSender.this.m1196x7be0500e(obj, cls);
                }
            });
        ...
        public /* synthetic */ void m1193xad3aa5c9(DiskFlushNotification diskFlushNotification) {
        ...
        public /* synthetic */ void m1194xd68efb0a(SentryEnvelope sentryEnvelope, Object obj) {
        ...
        public /* synthetic */ void m1195x2937a58c(SentryEnvelope sentryEnvelope, Object obj, Class cls) {
        ...
        public /* synthetic */ void m1196x7be0500e(Object obj, Class cls) {
            LogUtils.logNotInstanceOf(cls, obj, AsyncHttpTransport.this.options.getLogger());

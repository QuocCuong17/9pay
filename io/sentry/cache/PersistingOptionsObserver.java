...
public final class PersistingOptionsObserver implements IOptionsObserver {
    ...
    private void serializeToDisk(final Runnable runnable) {
        try {
            this.options.getExecutorService().submit(new Runnable() { // from class: io.sentry.cache.PersistingOptionsObserver$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    PersistingOptionsObserver.this.m1168x5a11aa57(runnable);
                }
            });
        } catch (Throwable th) {
    ...
    public /* synthetic */ void m1168x5a11aa57(Runnable runnable) {
        try {
            runnable.run();
        } catch (Throwable th) {
    ...
    public void setRelease(final String str) {
        serializeToDisk(new Runnable() { // from class: io.sentry.cache.PersistingOptionsObserver$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                PersistingOptionsObserver.this.m1172lambda$setRelease$1$iosentrycachePersistingOptionsObserver(str);
            }
        });
    }

    /* renamed from: lambda$setRelease$1$io-sentry-cache-PersistingOptionsObserver, reason: not valid java name */
    public /* synthetic */ void m1172lambda$setRelease$1$iosentrycachePersistingOptionsObserver(String str) {
        if (str == null) {
    ...
    public void setSdkVersion(final SdkVersion sdkVersion) {
        serializeToDisk(new Runnable() { // from class: io.sentry.cache.PersistingOptionsObserver$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                PersistingOptionsObserver.this.m1173lambda$setSdkVersion$3$iosentrycachePersistingOptionsObserver(sdkVersion);
            }
        });
    }

    /* renamed from: lambda$setSdkVersion$3$io-sentry-cache-PersistingOptionsObserver, reason: not valid java name */
    public /* synthetic */ void m1173lambda$setSdkVersion$3$iosentrycachePersistingOptionsObserver(SdkVersion sdkVersion) {
        if (sdkVersion == null) {
    ...
    public void setDist(final String str) {
        serializeToDisk(new Runnable() { // from class: io.sentry.cache.PersistingOptionsObserver$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                PersistingOptionsObserver.this.m1169lambda$setDist$4$iosentrycachePersistingOptionsObserver(str);
            }
        });
    }

    /* renamed from: lambda$setDist$4$io-sentry-cache-PersistingOptionsObserver, reason: not valid java name */
    public /* synthetic */ void m1169lambda$setDist$4$iosentrycachePersistingOptionsObserver(String str) {
        if (str == null) {
    ...
    public /* synthetic */ void m1174lambda$setTags$6$iosentrycachePersistingOptionsObserver(Map map) {
        store(map, "tags.json");
    }
    ...
    public void setTags(final Map<String, String> map) {
        serializeToDisk(new Runnable() { // from class: io.sentry.cache.PersistingOptionsObserver$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                PersistingOptionsObserver.this.m1174lambda$setTags$6$iosentrycachePersistingOptionsObserver(map);
            }
        });
    }

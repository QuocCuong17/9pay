...
public final class Gpu implements JsonUnknown, JsonSerializable {
    ...
    public boolean equals(Object obj) {
        ...
        Gpu gpu = (Gpu) obj;
        return Objects.equals(this.name, gpu.name) && Objects.equals(this.f132id, gpu.f132id) && Objects.equals(this.vendorId, gpu.vendorId) && Objects.equals(this.vendorName, gpu.vendorName) && Objects.equals(this.memorySize, gpu.memorySize) && Objects.equals(this.apiType, gpu.apiType) && Objects.equals(this.multiThreadedRendering, gpu.multiThreadedRendering) && Objects.equals(this.version, gpu.version) && Objects.equals(this.npotSupport, gpu.npotSupport);
    }

    public int hashCode() {
        return Objects.hash(this.name, this.f132id, this.vendorId, this.vendorName, this.memorySize, this.apiType, this.multiThreadedRendering, this.version, this.npotSupport);
    }
    ...
    public void serialize(ObjectWriter objectWriter, ILogger iLogger) throws IOException {
        ...
        if (this.f132id != null) {
            objectWriter.name("id").value(this.f132id);
        }
            ...
            while (jsonObjectReader.peek() == JsonToken.NAME) {
                ...
                switch (c) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        gpu.f132id = jsonObjectReader.nextIntegerOrNull();
                        break;
                    case 4:

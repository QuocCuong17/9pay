...
public final class User implements JsonUnknown, JsonSerializable {
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            ...
            switch (c) {
                case 0:
                    ...
                    break;
                case 1:
                    user.f134id = value instanceof String ? (String) value : null;
                    break;
                case 2:
    ...
    public boolean equals(Object obj) {
        ...
        User user = (User) obj;
        return Objects.equals(this.email, user.email) && Objects.equals(this.f134id, user.f134id) && Objects.equals(this.username, user.username) && Objects.equals(this.segment, user.segment) && Objects.equals(this.ipAddress, user.ipAddress);
    }

    public int hashCode() {
        return Objects.hash(this.email, this.f134id, this.username, this.segment, this.ipAddress);
    }
    ...
    public void serialize(ObjectWriter objectWriter, ILogger iLogger) throws IOException {
        ...
        if (this.f134id != null) {
            objectWriter.name("id").value(this.f134id);
        }
            ...
            while (jsonObjectReader.peek() == JsonToken.NAME) {
                ...
                switch (c) {
                    case 0:
                        ...
                        break;
                    case 1:
                        user.f134id = jsonObjectReader.nextStringOrNull();
                        break;
                    case 2:

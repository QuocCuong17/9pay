...
public final class Scope {
    ...
    public Session withSession(IWithSession iWithSession) {
        ...
        synchronized (this.sessionLock) {
            ...
            m1141clone = this.session != null ? this.session.m1141clone() : null;
        }
        return m1141clone;
    }
    ...
    public SessionPair startSession() {
        ...
        synchronized (this.sessionLock) {
            ...
            if (this.options.getRelease() != null) {
                ...
                sessionPair = new SessionPair(this.session.m1141clone(), session != null ? session.m1141clone() : null);
            } else {
    ...
    public Session endSession() {
        ...
        synchronized (this.sessionLock) {
            ...
            if (this.session != null) {
                this.session.end();
                Session m1141clone = this.session.m1141clone();
                this.session = null;
                session = m1141clone;
            }
        }

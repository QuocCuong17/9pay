...
public final class ProfilingTransactionData implements JsonUnknown, JsonSerializable {
    ...
    public ProfilingTransactionData(ITransaction iTransaction, Long l, Long l2) {
        this.f129id = iTransaction.getEventId().toString();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f129id.equals(profilingTransactionData.f129id) && this.traceId.equals(profilingTransactionData.traceId) && this.name.equals(profilingTransactionData.name) && this.relativeStartNs.equals(profilingTransactionData.relativeStartNs) && this.relativeStartCpuMs.equals(profilingTransactionData.relativeStartCpuMs) && Objects.equals(this.relativeEndCpuMs, profilingTransactionData.relativeEndCpuMs) && Objects.equals(this.relativeEndNs, profilingTransactionData.relativeEndNs) && Objects.equals(this.unknown, profilingTransactionData.unknown);
    }

    public int hashCode() {
        return Objects.hash(this.f129id, this.traceId, this.name, this.relativeStartNs, this.relativeEndNs, this.relativeStartCpuMs, this.relativeEndCpuMs, this.unknown);
    }

    @Override // io.sentry.JsonSerializable
    public void serialize(ObjectWriter objectWriter, ILogger iLogger) throws IOException {
        objectWriter.beginObject();
        objectWriter.name("id").value(iLogger, this.f129id);
                ...
                switch (c) {
                    ...
                    case 2:
                        ...
                        if (nextStringOrNull == null) {
                            ...
                            profilingTransactionData.f129id = nextStringOrNull;
                            break;
                        }
                    case 3:

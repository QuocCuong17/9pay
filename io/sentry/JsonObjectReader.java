...
public final class JsonObjectReader extends JsonReader {
    ...
    public <T> List<T> nextList(ILogger iLogger, JsonDeserializer<T> jsonDeserializer) throws IOException {
        if (peek() == JsonToken.NULL) {
            nextNull();
            return null;
        }
        ...
        do {
            try {
                ...
                iLogger.log(SentryLevel.ERROR, "Failed to deserialize object in list.", e);
            }
    ...
    public <T> Map<String, T> nextMapOrNull(ILogger iLogger, JsonDeserializer<T> jsonDeserializer) throws IOException {
        ...
        while (true) {
            try {
                ...
                iLogger.log(SentryLevel.ERROR, "Failed to deserialize object in map.", e);
            }
    ...
    public static Date dateOrNull(String str, ILogger iLogger) {
        ...
        try {
            ...
            iLogger.log(SentryLevel.DEBUG, "Error when deserializing UTC timestamp format, it might be millis timestamp format.", e);
            try {

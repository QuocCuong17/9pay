            ...
            while (jsonObjectReader.peek() == JsonToken.NAME) {
                ...
                switch (c) {
                    ...
                    case 1:
                        ...
                        sentryEvent.threads = new SentryValues(jsonObjectReader.nextList(iLogger, new SentryThread.Deserializer()));
                    ...
                    case 7:
                        jsonObjectReader.beginObject();
                        jsonObjectReader.nextName();
                        sentryEvent.exception = new SentryValues(jsonObjectReader.nextList(iLogger, new SentryException.Deserializer()));
                        jsonObjectReader.endObject();
                        break;
                    case '\b':

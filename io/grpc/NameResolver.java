...
public abstract class NameResolver {
    ...
    public static final class ConfigOrError {
        ...
        private ConfigOrError(Object obj) {
            this.config = Preconditions.checkNotNull(obj, HVRetakeActivity.CONFIG_TAG);
            this.status = null;
        }
        ...
        public String toString() {
            if (this.config != null) {
                return MoreObjects.toStringHelper(this).add(HVRetakeActivity.CONFIG_TAG, this.config).toString();
            }

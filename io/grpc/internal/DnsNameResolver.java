...
public class DnsNameResolver extends NameResolver {
        ...
        public void run() {
            ...
            try {
                try {
                    ...
                    r1 = internalResolutionResult != null && internalResolutionResult.error == null;
    ...
    public static final class SrvRecord {
        ...
        public String toString() {
            return MoreObjects.toStringHelper(this).add(URLProtectionSpaceContract.FeedEntry.COLUMN_NAME_HOST, this.host).add(URLProtectionSpaceContract.FeedEntry.COLUMN_NAME_PORT, this.port).toString();
        }
    }

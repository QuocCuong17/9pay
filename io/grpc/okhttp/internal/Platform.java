...
public class Platform {
    ...
    private static Platform findPlatform() {
        ...
        try {
            ...
            try {
                ...
                return new JdkWithJettyBootPlatform(cls2.getMethod("put", SSLSocket.class, cls3), cls2.getMethod(WorkflowRequestType.Method.GET, SSLSocket.class), cls2.getMethod("remove", SSLSocket.class), Class.forName("org.eclipse.jetty.alpn.ALPN$ClientProvider"), Class.forName("org.eclipse.jetty.alpn.ALPN$ServerProvider"), provider);
            }
    ...
    private static class JettyNegoProvider implements InvocationHandler {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
            ...
            if ((name.equals("protocolSelected") || name.equals(FormFragment.KEY_SELECTED)) && objArr.length == 1) {

...
public class AccessibilityBridge extends AccessibilityNodeProvider {
    ...
    public int getHoveredObjectId() {
        return this.hoveredObject.f123id;
    }
    ...
    public AccessibilityNodeInfo createAccessibilityNodeInfo(int i) {
        ...
        if (semanticsNode.platformViewId == -1 || !this.platformViewsAccessibilityDelegate.usesVirtualDisplay(semanticsNode.platformViewId)) {
            ...
            if (semanticsNode2 != null) {
                obtainAccessibilityNodeInfo2.setFocused(semanticsNode2.f123id == i);
            }
            SemanticsNode semanticsNode3 = this.accessibilityFocusedSemanticsNode;
            if (semanticsNode3 != null) {
                obtainAccessibilityNodeInfo2.setAccessibilityFocused(semanticsNode3.f123id == i);
            }
            if (semanticsNode.hasFlag(Flag.IS_TEXT_FIELD)) {
                ...
                if (semanticsNode4 != null && semanticsNode4.f123id == i) {
            ...
            if (semanticsNode.parent == null) {
                ...
                obtainAccessibilityNodeInfo2.setParent(this.rootAccessibilityView, semanticsNode.parent.f123id);
            }
            ...
            if (semanticsNode5 != null && semanticsNode5.f123id == i) {
            ...
            for (SemanticsNode semanticsNode6 : semanticsNode.childrenInTraversalOrder) {
                if (!semanticsNode6.hasFlag(Flag.IS_HIDDEN)) {
                    ...
                    obtainAccessibilityNodeInfo2.addChild(this.rootAccessibilityView, semanticsNode6.f123id);
                }
            }
        ...
        return this.accessibilityViewEmbedder.getRootNode(platformViewById2, semanticsNode.f123id, semanticsNode.getGlobalRect());
    }
    ...
    public boolean performAction(int i, int i2, Bundle bundle) {
        ...
        switch (i2) {
            ...
            case 64:
                ...
                hashMap.put("nodeId", Integer.valueOf(semanticsNode.f123id));
            ...
            case 128:
                ...
                if (semanticsNode2 != null && semanticsNode2.f123id == i) {
            ...
            default:
                ...
                this.accessibilityChannel.dispatchSemanticsAction(i, Action.CUSTOM_ACTION, Integer.valueOf(customAccessibilityAction.f122id));
                return true;
        }
    }
    ...
    private boolean performCursorMoveAction(SemanticsNode semanticsNode, int i, Bundle bundle, boolean z) {
        ...
        if (i3 != semanticsNode.textSelectionBase || i4 != semanticsNode.textSelectionExtent) {
            ...
            AccessibilityEvent obtainAccessibilityEvent = obtainAccessibilityEvent(semanticsNode.f123id, 8192);
            obtainAccessibilityEvent.getText().add(str);
    ...
    public AccessibilityNodeInfo findFocus(int i) {
        if (i == 1) {
            ...
            if (semanticsNode == null) {
                ...
                return createAccessibilityNodeInfo(semanticsNode.f123id);
            }
        } else if (i != 2) {
            return null;
        }
        ...
        return createAccessibilityNodeInfo(semanticsNode2.f123id);
    }
    ...
    public CustomAccessibilityAction getOrCreateAccessibilityAction(int i) {
        ...
        customAccessibilityAction2.f122id = i;
    ...
    public boolean onAccessibilityHoverEvent(MotionEvent motionEvent, boolean z) {
        ...
        if (hitTest != null && hitTest.platformViewId != -1) {
            ...
            return this.accessibilityViewEmbedder.onAccessibilityHoverEvent(hitTest.f123id, motionEvent);
        }
    ...
    public void onTouchExplorationExit() {
        ...
        if (semanticsNode != null) {
            sendAccessibilityEvent(semanticsNode.f123id, 256);
    ...
    private void handleTouchExploration(float f, float f2, boolean z) {
        ...
        if (hitTest != null) {
            sendAccessibilityEvent(hitTest.f123id, 128);
        }
        SemanticsNode semanticsNode = this.hoveredObject;
        if (semanticsNode != null) {
            sendAccessibilityEvent(semanticsNode.f123id, 256);
    ...
    void updateSemantics(ByteBuffer byteBuffer, String[] strArr, ByteBuffer[] byteBufferArr) {
        ...
        for (SemanticsNode semanticsNode4 : arrayList2) {
            if (!this.flutterNavigationStack.contains(Integer.valueOf(semanticsNode4.f123id))) {
        ...
        if (semanticsNode3 != null && (semanticsNode3.f123id != this.previousRouteId || arrayList2.size() != this.flutterNavigationStack.size())) {
            this.previousRouteId = semanticsNode3.f123id;
            onWindowNameChange(semanticsNode3);
        }
        this.flutterNavigationStack.clear();
        Iterator it = arrayList2.iterator();
        while (it.hasNext()) {
            this.flutterNavigationStack.add(Integer.valueOf(((SemanticsNode) it.next()).f123id));
        }
        ...
        while (it3.hasNext()) {
            ...
            if (semanticsNode5.didScroll()) {
                AccessibilityEvent obtainAccessibilityEvent = obtainAccessibilityEvent(semanticsNode5.f123id, 4096);
            ...
            if (semanticsNode5.hasFlag(Flag.IS_LIVE_REGION) && semanticsNode5.didChangeLabel()) {
                sendWindowContentChangeEvent(semanticsNode5.f123id);
            }
            SemanticsNode semanticsNode6 = this.accessibilityFocusedSemanticsNode;
            if (semanticsNode6 != null && semanticsNode6.f123id == semanticsNode5.f123id && !semanticsNode5.hadFlag(Flag.IS_SELECTED) && semanticsNode5.hasFlag(Flag.IS_SELECTED)) {
                AccessibilityEvent obtainAccessibilityEvent2 = obtainAccessibilityEvent(semanticsNode5.f123id, 4);
            ...
            if (semanticsNode7 != null && semanticsNode7.f123id == semanticsNode5.f123id && ((semanticsNode2 = this.lastInputFocusedSemanticsNode) == null || semanticsNode2.f123id != this.inputFocusedSemanticsNode.f123id)) {
                this.lastInputFocusedSemanticsNode = this.inputFocusedSemanticsNode;
                sendAccessibilityEvent(obtainAccessibilityEvent(semanticsNode5.f123id, 8));
            ...
            if (semanticsNode8 != null && semanticsNode8.f123id == semanticsNode5.f123id && semanticsNode5.hadFlag(Flag.IS_TEXT_FIELD) && semanticsNode5.hasFlag(Flag.IS_TEXT_FIELD) && ((semanticsNode = this.accessibilityFocusedSemanticsNode) == null || semanticsNode.f123id == this.inputFocusedSemanticsNode.f123id)) {
                ...
                AccessibilityEvent createTextChangedEvent = createTextChangedEvent(semanticsNode5.f123id, str, str2);
                ...
                if (semanticsNode5.previousTextSelectionBase != semanticsNode5.textSelectionBase || semanticsNode5.previousTextSelectionExtent != semanticsNode5.textSelectionExtent) {
                    AccessibilityEvent obtainAccessibilityEvent3 = obtainAccessibilityEvent(semanticsNode5.f123id, 8192);
    ...
    private void onWindowNameChange(SemanticsNode semanticsNode) {
        ...
        AccessibilityEvent obtainAccessibilityEvent = obtainAccessibilityEvent(semanticsNode.f123id, 32);
    ...
    private void willRemoveSemanticsNode(SemanticsNode semanticsNode) {
        ...
        if (semanticsNode2 == semanticsNode) {
            sendAccessibilityEvent(semanticsNode2.f123id, 65536);
            this.accessibilityFocusedSemanticsNode = null;
        }
    ...
    public void reset() {
        ...
        if (semanticsNode != null) {
            sendAccessibilityEvent(semanticsNode.f123id, 65536);
        }
        this.accessibilityFocusedSemanticsNode = null;
        this.hoveredObject = null;
        sendWindowContentChangeEvent(0);
    ...
    public enum Flag {
        ...
        IS_CHECK_STATE_MIXED(PDButton.FLAG_RADIOS_IN_UNISON),

...
class AccessibilityViewEmbedder {
    ...
    public AccessibilityNodeInfo createAccessibilityNodeInfo(int i) {
        ...
        if (viewAndId == null || !this.embeddedViewToDisplayBounds.containsKey(viewAndId.view) || viewAndId.view.getAccessibilityNodeProvider() == null || (createAccessibilityNodeInfo = viewAndId.view.getAccessibilityNodeProvider().createAccessibilityNodeInfo(viewAndId.f124id)) == null) {
            return null;
        }
    ...
    public boolean performAction(int i, int i2, Bundle bundle) {
        ...
        return accessibilityNodeProvider.performAction(viewAndId.f124id, i2, bundle);
    }
    ...
    public static class ViewAndId {
        ...
        public boolean equals(Object obj) {
            ...
            return this.f124id == viewAndId.f124id && this.view.equals(viewAndId.view);
        }

        public int hashCode() {
            return ((this.view.hashCode() + 31) * 31) + this.f124id;
        }
    }
        ...
        private ReflectionAccessors() {
            ...
            if (Build.VERSION.SDK_INT <= 26) {
                ...
                try {
                    ...
                    method4 = Class.forName("android.util.LongArray").getMethod(WorkflowRequestType.Method.GET, Integer.TYPE);
                    method3 = null;

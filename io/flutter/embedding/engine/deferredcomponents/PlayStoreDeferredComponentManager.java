...
public class PlayStoreDeferredComponentManager implements DeferredComponentManager {
    ...
    public void installDeferredComponent(final int i, final String str) {
        ...
        if (str2 == null) {
            ...
            this.splitInstallManager.startInstall(SplitInstallRequest.newBuilder().addModule(str2).build()).addOnSuccessListener(new OnSuccessListener() { // from class: io.flutter.embedding.engine.deferredcomponents.PlayStoreDeferredComponentManager$$ExternalSyntheticLambda1
                public final void onSuccess(Object obj) {
                    PlayStoreDeferredComponentManager.this.m1012x3d4be899(str2, i, (Integer) obj);
                }
            }).addOnFailureListener(new OnFailureListener() { // from class: io.flutter.embedding.engine.deferredcomponents.PlayStoreDeferredComponentManager$$ExternalSyntheticLambda0
                public final void onFailure(Exception exc) {
                    PlayStoreDeferredComponentManager.this.m1013x6bfd52b8(i, str, exc);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m1012x3d4be899(String str, int i, Integer num) {
    ...
    public /* synthetic */ void m1013x6bfd52b8(int i, String str, Exception exc) {
    ...
    public void loadDartLibrary(int i, String str) {
        if (verifyJNI() && i >= 0) {
            ...
            if (str2 == null) {
                str2 = this.flutterApplicationInfo.aotSharedLibraryName + Parameters.DEFAULT_OPTION_PREFIXES + i + ".part.so";
            }
            String str3 = Build.SUPPORTED_ABIS[0];
            String replace = str3.replace(Parameters.DEFAULT_OPTION_PREFIXES, "_");
            ...
            while (it.hasNext()) {
                arrayList3.add(((String) it.next()) + "!lib/" + str3 + RemoteSettings.FORWARD_SLASH_STRING + str2);
            }

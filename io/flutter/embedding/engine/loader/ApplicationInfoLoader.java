...
public final class ApplicationInfoLoader {
    ...
    public static final String PUBLIC_AOT_SHARED_LIBRARY_NAME = FlutterLoader.class.getName() + FilenameUtils.EXTENSION_SEPARATOR + "aot-shared-library-name";
    public static final String PUBLIC_VM_SNAPSHOT_DATA_KEY = FlutterLoader.class.getName() + FilenameUtils.EXTENSION_SEPARATOR + "vm-snapshot-data";
    public static final String PUBLIC_ISOLATE_SNAPSHOT_DATA_KEY = FlutterLoader.class.getName() + FilenameUtils.EXTENSION_SEPARATOR + "isolate-snapshot-data";
    public static final String PUBLIC_FLUTTER_ASSETS_DIR_KEY = FlutterLoader.class.getName() + FilenameUtils.EXTENSION_SEPARATOR + "flutter-assets-dir";

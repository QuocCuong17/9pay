    ...
    void sendUserSettingsToFlutter() {
        ...
        if (this.textServicesManager != null) {
            if (Build.VERSION.SDK_INT >= 31) {
                boolean anyMatch = this.textServicesManager.getEnabledSpellCheckerInfos().stream().anyMatch(new Predicate() { // from class: io.flutter.embedding.android.FlutterView$$ExternalSyntheticLambda0
                ...
                if (this.textServicesManager.isSpellCheckerEnabled()) {
                }
            }
            z = true;

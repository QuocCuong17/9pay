...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo2519minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2665minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo2518elapsedNowUwyO8pc() {
        return Duration.m2563minusLRDsOJo(this.mark.mo2518elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo2521plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2564plusLRDsOJo(this.adjustment, duration), null);
    }
}

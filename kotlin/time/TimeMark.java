...
public interface TimeMark {
    ...
    TimeMark mo2519minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo2521plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m2666plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2665minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo2521plusLRDsOJo(Duration.m2581unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m2561isNegativeimpl(timeMark.mo2518elapsedNowUwyO8pc());
        }

...
public final class DurationKt {
    ...
    private static final long m2655timesmvk6XK0(int i, long j) {
        return Duration.m2566timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m2654timeskIfJnKk(double d, long j) {
        return Duration.m2565timesUwyO8pc(j, d);
    }

    /* JADX WARN: Removed duplicated region for block: B:43:0x009a A[LOOP:1: B:35:0x006c->B:43:0x009a, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:44:0x00a8 A[EDGE_INSN: B:44:0x00a8->B:45:0x00a8 BREAK  A[LOOP:1: B:35:0x006c->B:43:0x009a], SYNTHETIC] */
    /*
    ...
    */
    public static final long parseDuration(String str, boolean z) {
        ...
        long m2631getZEROUwyO8pc = Duration.INSTANCE.m2631getZEROUwyO8pc();
        ...
        if (str.charAt(i) == 'P') {
            ...
            while (i2 < length) {
                if (str.charAt(i2) != 'T') {
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        long m2564plusLRDsOJo = Duration.m2564plusLRDsOJo(m2631getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "substring(...)");
                        m2631getZEROUwyO8pc = Duration.m2564plusLRDsOJo(m2564plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        m2631getZEROUwyO8pc = Duration.m2564plusLRDsOJo(m2631getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
                    obj2 = obj;
            ...
            if (StringsKt.regionMatches(str, i, "Infinity", 0, Math.max(length - i, 8), true)) {
                m2631getZEROUwyO8pc = Duration.INSTANCE.m2629getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                if (z5 && str.charAt(i) == '(' && StringsKt.last(str) == ')') {
                    i++;
                    length--;
                    if (i == length) {
                        throw new IllegalArgumentException("No components");
                ...
                while (i < length) {
                    ...
                    String str6 = str4;
                    int indexOf$default2 = StringsKt.indexOf$default((CharSequence) str5, FilenameUtils.EXTENSION_SEPARATOR, 0, false, 6, (Object) null);
                    if (indexOf$default2 > 0) {
                        ...
                        long m2564plusLRDsOJo2 = Duration.m2564plusLRDsOJo(m2631getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "substring(...)");
                        m2631getZEROUwyO8pc = Duration.m2564plusLRDsOJo(m2564plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m2631getZEROUwyO8pc = Duration.m2564plusLRDsOJo(m2631getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
        ...
        return z2 ? Duration.m2581unaryMinusUwyO8pc(m2631getZEROUwyO8pc) : m2631getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m2528constructorimpl(j << 1);
    }

    public static final long durationOfMillis(long j) {
        return Duration.m2528constructorimpl((j << 1) + 1);
    }

    public static final long durationOf(long j, int i) {
        return Duration.m2528constructorimpl((j << 1) + i);
    }

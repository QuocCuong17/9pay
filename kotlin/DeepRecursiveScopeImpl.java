    ...
    public final R runCallLoop() {
        ...
        while (true) {
            ...
            if (continuation != null) {
                obj = DeepRecursiveKt.UNDEFINED_RESULT;
                if (!Result.m1204equalsimpl0(obj, r)) {
                    ...
                    try {
                        ...
                        if (wrapWithContinuationImpl != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            ...
                            continuation.resumeWith(Result.m1202constructorimpl(wrapWithContinuationImpl));
                        }
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.INSTANCE;
                        continuation.resumeWith(Result.m1202constructorimpl(ResultKt.createFailure(th)));
                    }
                }
            } else {

...
public class Base64 {
    ...
    public final int encodeIntoByteArrayImpl$kotlin_stdlib(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        if (i11 == 1) {
            ...
            int i20 = i2 + 1;
            destination[i2] = access$getBase64UrlEncodeMap$p[i19 >>> 12];
            int i21 = i20 + 1;
            destination[i20] = access$getBase64UrlEncodeMap$p[(i19 >>> 6) & 63];
            int i22 = i21 + 1;
            destination[i21] = access$getBase64UrlEncodeMap$p[i19 & 63];
            i2 = i22 + 1;
    ...
    private final int decodeImpl(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        while (true) {
            ...
            if (i4 == i && i5 + 3 < endIndex) {
                int i6 = i5 + 1;
                int i7 = access$getBase64UrlDecodeMap$p[source[i5] & 255];
                int i8 = i6 + 1;
            ...
            if (i17 >= 0) {
                ...
                if (i17 == -2) {
                    i5 = handlePaddingSymbol(source, i5, endIndex, i4);
                    break;
                }
        ...
        int skipIllegalSymbolsIfMime = skipIllegalSymbolsIfMime(source, i5, endIndex);

...
public final class HexExtensionsKt {
    ...
    */
    ...
    public static final int formattedStringLength(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        long j = i8 + (((i9 * i8) + ((i2 - 1) / i3)) * i4) + (((r2 - i8) - r4) * i5) + (i * (i6 + 2 + i7));
        if (RangesKt.intRangeContains((ClosedRange<Integer>) new IntRange(0, Integer.MAX_VALUE), j)) {
            return (int) j;
        }
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m1422toStringimpl(ULong.m1376constructorimpl(j))));
    }
    ...
    private static final long hexToLongImpl(String str, int i, int i2, HexFormat hexFormat, int i3) {
        ...
        checkContainsAt(str, suffix, length, i2, DynamicLink.Builder.KEY_SUFFIX);
    ...
    private static final int decimalFromHexDigitAt(String str, int i) {
        ...
        if (charAt <= 127) {
            int[] iArr = HEX_DIGITS_TO_DECIMAL;
            if (iArr[charAt] >= 0) {
                return iArr[charAt];
            }
        }

...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m2411getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m1376constructorimpl = ((int) ULong.m1376constructorimpl(j ^ ULong.m1376constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m1376constructorimpl2 = (m1376constructorimpl + ((int) ULong.m1376constructorimpl(j2 ^ ULong.m1376constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return m1376constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m1422toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m1422toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m2437fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {

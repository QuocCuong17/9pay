...
class GroupingKt__GroupingKt extends GroupingKt__GroupingJVMKt {
    ...
    public static final <T, K, R> Map<K, R> aggregate(Grouping<T, ? extends K> grouping, Function4<? super K, ? super R, ? super T, ? super Boolean, ? extends R> operation) {
        ...
        while (sourceIterator.hasNext()) {
            ...
            WakelockPlusApi$Companion$codec$2 wakelockPlusApi$Companion$codec$2 = (Object) linkedHashMap.get(keyOf);
            linkedHashMap.put(keyOf, operation.invoke(keyOf, wakelockPlusApi$Companion$codec$2, next, Boolean.valueOf(wakelockPlusApi$Companion$codec$2 == null && !linkedHashMap.containsKey(keyOf))));
        }
    ...
    public static final <T, K, R, M extends Map<? super K, R>> M aggregateTo(Grouping<T, ? extends K> grouping, M destination, Function4<? super K, ? super R, ? super T, ? super Boolean, ? extends R> operation) {
        ...
        while (sourceIterator.hasNext()) {
            ?? next = sourceIterator.next();
            Object keyOf = grouping.keyOf(next);
            WakelockPlusApi$Companion$codec$2 wakelockPlusApi$Companion$codec$2 = (Object) destination.get(keyOf);
            destination.put(keyOf, operation.invoke(keyOf, wakelockPlusApi$Companion$codec$2, next, Boolean.valueOf(wakelockPlusApi$Companion$codec$2 == null && !destination.containsKey(keyOf))));
        }
        return destination;
    }
    ...
    public static final <T, K, R> Map<K, R> fold(Grouping<T, ? extends K> grouping, R r, Function2<? super R, ? super T, ? extends R> operation) {
        ...
        while (sourceIterator.hasNext()) {
            ...
            WakelockPlusFlutterError wakelockPlusFlutterError = (Object) linkedHashMap.get(keyOf);
            if (wakelockPlusFlutterError == null && !linkedHashMap.containsKey(keyOf)) {
                wakelockPlusFlutterError = (Object) r;
            }
            linkedHashMap.put(keyOf, operation.invoke(wakelockPlusFlutterError, next));
        }
        return linkedHashMap;
    }
    ...
    public static final <T, K, R, M extends Map<? super K, R>> M foldTo(Grouping<T, ? extends K> grouping, M destination, R r, Function2<? super R, ? super T, ? extends R> operation) {
        ...
        while (sourceIterator.hasNext()) {
            ?? next = sourceIterator.next();
            K keyOf = grouping.keyOf(next);
            WakelockPlusFlutterError wakelockPlusFlutterError = (Object) destination.get(keyOf);
            if (wakelockPlusFlutterError == null && !destination.containsKey(keyOf)) {
                wakelockPlusFlutterError = (Object) r;
            }
            destination.put(keyOf, operation.invoke(wakelockPlusFlutterError, next));
        }
        return destination;
    }
    ...
    public static final <S, T extends S, K> Map<K, S> reduce(Grouping<T, ? extends K> grouping, Function3<? super K, ? super S, ? super T, ? extends S> operation) {
        ...
        while (sourceIterator.hasNext()) {
            ...
            WakelockPlusApi$Companion$codec$2 wakelockPlusApi$Companion$codec$2 = (Object) linkedHashMap.get(keyOf);
            if (!(wakelockPlusApi$Companion$codec$2 == null && !linkedHashMap.containsKey(keyOf))) {
                s = operation.invoke(keyOf, wakelockPlusApi$Companion$codec$2, s);
            }
    ...
    public static final <S, T extends S, K, M extends Map<? super K, S>> M reduceTo(Grouping<T, ? extends K> grouping, M destination, Function3<? super K, ? super S, ? super T, ? extends S> operation) {
        ...
        while (sourceIterator.hasNext()) {
            ...
            Object keyOf = grouping.keyOf(s);
            WakelockPlusApi$Companion$codec$2 wakelockPlusApi$Companion$codec$2 = (Object) destination.get(keyOf);
            if (!(wakelockPlusApi$Companion$codec$2 == null && !destination.containsKey(keyOf))) {
                s = operation.invoke(keyOf, wakelockPlusApi$Companion$codec$2, s);
            }

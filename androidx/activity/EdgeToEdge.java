...
public final class EdgeToEdge {
    ...
    public static final void enable(ComponentActivity componentActivity, SystemBarStyle statusBarStyle, SystemBarStyle navigationBarStyle) {
        EdgeToEdgeApi21 edgeToEdgeBase;
        Intrinsics.checkNotNullParameter(componentActivity, "<this>");
        Intrinsics.checkNotNullParameter(statusBarStyle, "statusBarStyle");
        ...
        EdgeToEdgeBase edgeToEdgeBase2 = Impl;
        if (edgeToEdgeBase2 == null) {
            if (Build.VERSION.SDK_INT >= 30) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    edgeToEdgeBase = new EdgeToEdgeApi21();
                } else {
                    edgeToEdgeBase = new EdgeToEdgeBase();
                }
                Impl = edgeToEdgeBase;
            }
            edgeToEdgeBase2 = edgeToEdgeBase;
        }
        Window window = componentActivity.getWindow();
        Intrinsics.checkNotNullExpressionValue(window, "window");
        edgeToEdgeBase2.setUp(statusBarStyle, navigationBarStyle, window, decorView, booleanValue, booleanValue2);
        Window window2 = componentActivity.getWindow();
        Intrinsics.checkNotNullExpressionValue(window2, "window");
        edgeToEdgeBase2.adjustLayoutInDisplayCutoutMode(window2);
    }
}

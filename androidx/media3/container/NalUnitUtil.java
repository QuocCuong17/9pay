...
public final class NalUnitUtil {
    ...
    */
    public static SpsData parseSpsNalUnitPayload(byte[] bArr, int i, int i2) {
        ...
        if (readUnsignedExpGolombCodedInt6 == 0) {
            ...
            if (readUnsignedExpGolombCodedInt6 == 1) {
                ...
                int i19 = i16;
                int i20 = i3;
                int i21 = ((i20 != 44 || i20 == 86 || i20 == 100 || i20 == 110 || i20 == 122 || i20 == 244) && (readBits2 & 16) != 0) ? 0 : 16;
                int i22 = -1;
                if (parsableNalUnitBitArray.readBit()) {
                    i5 = i21;
                    i6 = -1;
                ...
                return new SpsData(i20, readBits2, readBits3, readUnsignedExpGolombCodedInt4, readUnsignedExpGolombCodedInt8, i19, i18, f, readUnsignedExpGolombCodedInt2, readUnsignedExpGolombCodedInt3, readBit, readBit2, readUnsignedExpGolombCodedInt5, readUnsignedExpGolombCodedInt6, i4, z, i22, i6, i7, i5);
            }
            i3 = readBits;
            i4 = 0;
        }
        ...
        return new SpsData(i202, readBits2, readBits3, readUnsignedExpGolombCodedInt4, readUnsignedExpGolombCodedInt82, i192, i182, f, readUnsignedExpGolombCodedInt2, readUnsignedExpGolombCodedInt3, readBit, readBit2, readUnsignedExpGolombCodedInt5, readUnsignedExpGolombCodedInt6, i4, z, i222, i6, i7, i5);
    }
    ...
    public static H265SpsData parseH265SpsNalUnitPayload(byte[] bArr, int i, int i2) {
        ...
        return new H265SpsData(readBits2, readBit, readBits3, i8, readUnsignedExpGolombCodedInt2, readUnsignedExpGolombCodedInt9, readUnsignedExpGolombCodedInt10, iArr, readBits4, readUnsignedExpGolombCodedInt, i14, i3, f, i17, i4, i5, i16);
    }

...
public final class Tracks {
    ...
    public Bundle toBundle() {
        Bundle bundle = new Bundle();
        bundle.putParcelableArrayList(FIELD_TRACK_GROUPS, BundleCollectionUtil.toBundleArrayList(this.groups, new Function() { // from class: androidx.media3.common.Tracks$$ExternalSyntheticLambda1
    ...
    public static Tracks fromBundle(Bundle bundle) {
        ...
        if (parcelableArrayList == null) {
            ...
            fromBundleList = BundleCollectionUtil.fromBundleList(new Function() { // from class: androidx.media3.common.Tracks$$ExternalSyntheticLambda0
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {

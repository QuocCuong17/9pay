...
public final class Format {
    ...
    public String toString() {
        return "Format(" + this.f17id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + ", " + this.colorInfo + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
    ...
    public Bundle toBundle(boolean z) {
        ...
        bundle.putString(FIELD_ID, this.f17id);
    ...
    public static Format fromBundle(Bundle bundle) {
        ...
        builder.setId((String) defaultIfNull(string, format.f17id)).setLabel((String) defaultIfNull(bundle.getString(FIELD_LABEL), format.label));

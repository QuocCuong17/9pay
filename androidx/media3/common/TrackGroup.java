...
public final class TrackGroup {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = ((527 + this.f22id.hashCode()) * 31) + Arrays.hashCode(this.formats);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f22id.equals(trackGroup.f22id) && Arrays.equals(this.formats, trackGroup.formats);
    }
    ...
    public Bundle toBundle() {
        ...
        bundle.putString(FIELD_ID, this.f22id);
        return bundle;
    }

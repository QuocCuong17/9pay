...
public final class CachedContent {
    ...
    public SimpleCacheSpan setLastTouchTimestamp(SimpleCacheSpan simpleCacheSpan, long j, boolean z) {
        ...
        if (z) {
            File cacheFile = SimpleCacheSpan.getCacheFile((File) Assertions.checkNotNull(file.getParentFile()), this.f23id, simpleCacheSpan.position, j);
    ...
    public int hashCode() {
        return (((this.f23id * 31) + this.key.hashCode()) * 31) + this.metadata.hashCode();
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f23id == cachedContent.f23id && this.key.equals(cachedContent.key) && this.cachedSpans.equals(cachedContent.cachedSpans) && this.metadata.equals(cachedContent.metadata);
    }

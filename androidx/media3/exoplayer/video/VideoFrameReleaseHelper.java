...
public final class VideoFrameReleaseHelper {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x005c, code lost:
        ...
        if (java.lang.Math.abs(r0 - r7.surfaceMediaFrameRate) >= (r7.frameRateEstimator.isSynced() && (r7.frameRateEstimator.getMatchingFrameDurationSumNs() > androidx.media3.exoplayer.video.VideoFrameReleaseHelper.MINIMUM_MATCHING_FRAME_DURATION_FOR_HIGH_CONFIDENCE_NS ? 1 : (r7.frameRateEstimator.getMatchingFrameDurationSumNs() == androidx.media3.exoplayer.video.VideoFrameReleaseHelper.MINIMUM_MATCHING_FRAME_DURATION_FOR_HIGH_CONFIDENCE_NS ? 0 : -1)) >= 0 ? androidx.media3.exoplayer.video.VideoFrameReleaseHelper.MINIMUM_MEDIA_FRAME_RATE_CHANGE_FOR_UPDATE_HIGH_CONFIDENCE : 1.0f)) goto L35;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x006a, code lost:
        ...
        if (r7.frameRateEstimator.getFramesWithoutSyncCount() >= 30) goto L35;
     */
    /*

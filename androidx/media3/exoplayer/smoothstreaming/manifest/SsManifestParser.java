...
public class SsManifestParser implements ParsingLoadable.Parser<SsManifest> {
    ...
    public static class QualityLevelParser extends ElementParser {
        ...
        public void parseStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            this.format = builder.setId(xmlPullParser.getAttributeValue(null, "Index")).setLabel((String) getNormalizedAttribute(KEY_NAME)).setSampleMimeType(fourCCToMimeType).setAverageBitrate(parseRequiredInt(xmlPullParser, KEY_BITRATE)).setLanguage((String) getNormalizedAttribute(KEY_LANGUAGE)).build();
        }

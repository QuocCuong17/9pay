...
public final class DefaultMediaSourceFactory implements MediaSourceFactory {
            ...
            if (!immutableList.isEmpty()) {
                ...
                for (int i = 0; i < immutableList.size(); i++) {
                    if (this.parseSubtitlesDuringExtraction) {
                        final Format build2 = new Format.Builder().setSampleMimeType(immutableList.get(i).mimeType).setLanguage(immutableList.get(i).language).setSelectionFlags(immutableList.get(i).selectionFlags).setRoleFlags(immutableList.get(i).roleFlags).setLabel(immutableList.get(i).label).setId(immutableList.get(i).f19id).build();
                        ProgressiveMediaSource.Factory factory = new ProgressiveMediaSource.Factory(this.dataSourceFactory, new ExtractorsFactory() { // from class: androidx.media3.exoplayer.source.DefaultMediaSourceFactory$$ExternalSyntheticLambda0
                            ...
                            public final Extractor[] createExtractors() {
                                return DefaultMediaSourceFactory.this.m325xeef04c56(build2);
                            }
    ...
    public /* synthetic */ Extractor[] m325xeef04c56(Format format) {
    ...
    public static final class DelegateFactoryLoader {
        ...
        private Supplier<MediaSource.Factory> loadSupplier(int i) throws ClassNotFoundException {
            ...
            if (i == 0) {
                ...
                if (i == 3) {
                    ...
                    supplier2 = new Supplier() { // from class: androidx.media3.exoplayer.source.DefaultMediaSourceFactory$DelegateFactoryLoader$$ExternalSyntheticLambda1
                        @Override // com.google.common.base.Supplier
                        public final Object get() {
                            MediaSource.Factory newInstance;
                    ...
                    supplier2 = new Supplier() { // from class: androidx.media3.exoplayer.source.DefaultMediaSourceFactory$DelegateFactoryLoader$$ExternalSyntheticLambda0
                        @Override // com.google.common.base.Supplier
                        public final Object get() {
                            return DefaultMediaSourceFactory.DelegateFactoryLoader.this.m326xa479647d(factory);
                        }
                    };
                } else {
        ...
        public /* synthetic */ MediaSource.Factory m326xa479647d(DataSource.Factory factory) {

...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
            ...
            if (handler == null) {
                ...
                handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.ServerSideAdInsertionMediaSource$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        ServerSideAdInsertionMediaSource.this.m341x8b1696bf(immutableMap, timeline);
                    }
                });
            }
        }
    ...
    public /* synthetic */ void m341x8b1696bf(ImmutableMap immutableMap, Timeline timeline) {
            ...
            loop0: while (true) {
                ...
                if (exoTrackSelectionArr[i] != null) {
                    ...
                    for (int i2 = 0; i2 < trackGroup.length; i2++) {
                        ...
                        if (format.equals(mediaLoadData.trackFormat) || (z && format.f17id != null && format.f17id.equals(mediaLoadData.trackFormat.f17id))) {
                            break loop0;
                        }
                    }
                }
    ...
    private static final class ServerSideAdInsertionTimeline extends ForwardingTimeline {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            period.set(period.f21id, period.uid, period.windowIndex, j2, j3, adPlaybackState, period.isPlaceholder);
            return period;
        }
    }

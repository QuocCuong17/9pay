    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        while (true) {
            ...
            if (exoTrackSelectionArr[i2] != null) {
                ...
                iArr2[i2] = Integer.parseInt(trackGroup.f22id.substring(0, trackGroup.f22id.indexOf(":")));
            } else {
                iArr2[i2] = -1;
            }
            i2++;
            ...
            if (i2 < mediaPeriodArr.length) {
                ...
                while (i5 < i4) {
                    ...
                    for (int i6 = 0; i6 < trackGroup.length; i6++) {
                        ...
                        sb.append(i2);
                        sb.append(":");
                        sb.append(format.f17id == null ? "" : format.f17id);
                        formatArr[i6] = buildUpon.setId(sb.toString()).build();
                    }
                    TrackGroup trackGroup2 = new TrackGroup(i2 + ":" + trackGroup.f22id, formatArr);

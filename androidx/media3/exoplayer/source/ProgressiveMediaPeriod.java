...
public final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    private final Runnable maybeFinishPrepareRunnable = new Runnable() { // from class: androidx.media3.exoplayer.source.ProgressiveMediaPeriod$$ExternalSyntheticLambda2
        @Override // java.lang.Runnable
        public final void run() {
            ProgressiveMediaPeriod.this.maybeFinishPrepare();
        }
    };
    private final Runnable onContinueLoadingRequestedRunnable = new Runnable() { // from class: androidx.media3.exoplayer.source.ProgressiveMediaPeriod$$ExternalSyntheticLambda0
        @Override // java.lang.Runnable
        public final void run() {
            ProgressiveMediaPeriod.this.m333x97cae34d();
        }
    };
    ...
    public /* synthetic */ void m333x97cae34d() {
        if (this.released) {
            return;
        }
    ...
    public void seekMap(final SeekMap seekMap) {
        this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ProgressiveMediaPeriod$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                ProgressiveMediaPeriod.this.m335x33ac0ff2(seekMap);
            }
        });
    }
    ...
    public void onLengthKnown() {
        this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ProgressiveMediaPeriod$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                ProgressiveMediaPeriod.this.m334xa2bd730d();
            }
        });
    }

    /* renamed from: lambda$onLengthKnown$2$androidx-media3-exoplayer-source-ProgressiveMediaPeriod, reason: not valid java name */
    public /* synthetic */ void m334xa2bd730d() {
    ...
    private TrackOutput prepareTrackOutput(TrackId trackId) {
        ...
        if (this.sampleQueuesBuilt) {
            Log.w(TAG, "Extractor added new track (id=" + trackId.f34id + ") after finishing tracks.");
    ...
    public void m335x33ac0ff2(SeekMap seekMap) {
    ...
    public static final class TrackId {
        ...
        public boolean equals(Object obj) {
            ...
            return this.f34id == trackId.f34id && this.isIcyTrack == trackId.isIcyTrack;
        }

        public int hashCode() {
            return (this.f34id * 31) + (this.isIcyTrack ? 1 : 0);
        }
    }

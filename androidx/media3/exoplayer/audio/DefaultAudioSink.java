...
public final class DefaultAudioSink implements AudioSink {
    ...
    public void configure(Format format, int i, int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if (i != 0) {
            ...
            i9 = i3;
            i10 = i4;
            bufferSizeInBytes = this.audioTrackBufferSizeProvider.getBufferSizeInBytes(getAudioTrackMinBufferSize(i4, intValue, i6), i6, i5, i3 != -1 ? i3 : 1, i4, i16, z2 ? 8.0d : 1.0d);
        }
        this.offloadDisabledUntilNextConfiguration = false;
        Configuration configuration = new Configuration(format, i2, i5, i9, i10, i8, i7, bufferSizeInBytes, audioProcessingPipeline, z2, z, this.tunneling);
    ...
    */
    ...
    private void maybeStartAudioCapabilitiesReceiver() {
        ...
        AudioCapabilitiesReceiver audioCapabilitiesReceiver = new AudioCapabilitiesReceiver(this.context, new AudioCapabilitiesReceiver.Listener() { // from class: androidx.media3.exoplayer.audio.DefaultAudioSink$$ExternalSyntheticLambda0

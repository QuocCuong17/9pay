...
public final class HlsSampleStreamWrapper implements Loader.Callback<Chunk>, Loader.ReleaseCallback, SequenceableLoader, ExtractorOutput, SampleQueue.UpstreamFormatChangedListener {
    ...
    public void prepareWithMultivariantPlaylistInfo(TrackGroup[] trackGroupArr, int i, int... iArr) {
        ...
        handler.post(new Runnable() { // from class: androidx.media3.exoplayer.hls.HlsSampleStreamWrapper$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
                ...
                if (sampleStreamArr[i4] == null) {
                    ...
                    if (this.trackGroupToSampleQueueIndex != null) {
                        ...
                        if (!z5) {
                            ...
                            z5 = (hlsSampleQueue.getReadIndex() == 0 || hlsSampleQueue.seekTo(j, true)) ? false : true;
                        }
                    }
                }
            }
    ...
    public void onPlaylistUpdated() {
        ...
        if (chunkPublicationState == 0) {
            this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.hls.HlsSampleStreamWrapper$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    HlsSampleStreamWrapper.this.m308x332ef84d(hlsMediaChunk);
                }
            });
    ...
    public /* synthetic */ void m308x332ef84d(HlsMediaChunk hlsMediaChunk) {
    ...
    private TrackGroupArray createTrackGroupArrayWithDrmInfo(TrackGroup[] trackGroupArr) {
        for (int i = 0; i < trackGroupArr.length; i++) {
            ...
            trackGroupArr[i] = new TrackGroup(trackGroup.f22id, formatArr);
        }

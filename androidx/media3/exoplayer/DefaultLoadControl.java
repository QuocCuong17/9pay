...
public class DefaultLoadControl implements LoadControl {
    ...
    public void onPrepared(PlayerId playerId) {
        ...
        Assertions.checkState(j == -1 || j == id2, "Players that share the same LoadControl must share the same playback thread. See ExoPlayer.Builder.setPlaybackLooper(Looper).");
        this.threadId = id2;

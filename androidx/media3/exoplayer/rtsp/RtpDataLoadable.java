...
public final class RtpDataLoadable implements Loader.Loadable {
            ...
            if (this.dataChannel == null) {
                ...
                this.playbackThreadHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.rtsp.RtpDataLoadable$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        RtpDataLoadable.this.m317lambda$load$0$androidxmedia3exoplayerrtspRtpDataLoadable(transport, rtpDataChannel);
                    }
                });
    ...
    public /* synthetic */ void m317lambda$load$0$androidxmedia3exoplayerrtspRtpDataLoadable(String str, RtpDataChannel rtpDataChannel) {

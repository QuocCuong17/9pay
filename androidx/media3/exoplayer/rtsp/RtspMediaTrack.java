    ...
    static RtpPayloadFormat generatePayloadFormat(MediaDescription mediaDescription) {
        ...
        switch (c) {
            ...
            case 4:
                ...
                break;
            case 5:
                builder.setWidth(352).setHeight(BaselineTIFFTagSet.TAG_FREE_OFFSETS);
                break;
            case 6:
                Assertions.checkArgument(!fmtpParametersAsMap.isEmpty(), "missing attribute fmtp");
            ...
            case 7:
                ...
                break;
            case '\b':
                builder.setWidth(BaselineTIFFTagSet.TAG_COLOR_MAP).setHeight(PsExtractor.VIDEO_STREAM_MASK);
                break;
            case '\t':
                builder.setWidth(BaselineTIFFTagSet.TAG_COLOR_MAP).setHeight(PsExtractor.VIDEO_STREAM_MASK);
                break;

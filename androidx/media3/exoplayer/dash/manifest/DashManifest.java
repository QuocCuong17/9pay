...
public class DashManifest implements FilterableManifest<DashManifest> {
    ...
    public final DashManifest copy(List<StreamKey> list) {
        ...
        while (true) {
            ...
            if (((StreamKey) linkedList.peek()).periodIndex != i) {
                ...
                arrayList.add(new Period(period.f29id, period.startMs - j2, copyAdaptationSets(period.adaptationSets, linkedList), period.eventStreams));
            }
            i++;
        }
    ...
    private static ArrayList<AdaptationSet> copyAdaptationSets(List<AdaptationSet> list, LinkedList<StreamKey> linkedList) {
        ...
        do {
            ...
            arrayList.add(new AdaptationSet(adaptationSet.f27id, adaptationSet.type, arrayList2, adaptationSet.accessibilityDescriptors, adaptationSet.essentialProperties, adaptationSet.supplementalProperties));

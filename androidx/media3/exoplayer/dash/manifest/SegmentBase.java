...
public abstract class SegmentBase {
    ...
    public static final class SegmentTemplate extends MultiSegmentBase {
        ...
        public RangedUri getInitialization(Representation representation) {
            ...
            if (urlTemplate != null) {
                return new RangedUri(urlTemplate.buildUri(representation.format.f17id, 0L, representation.format.bitrate, 0L), 0L, -1L);
            }
        ...
        public RangedUri getSegmentUrl(Representation representation, long j) {
            ...
            return new RangedUri(this.mediaTemplate.buildUri(representation.format.f17id, j, representation.format.bitrate, j2), 0L, -1L);
        }

...
public class FragmentedMp4Extractor implements Extractor {
    ...
    private static final byte[] PIFF_SAMPLE_ENCRYPTION_BOX_EXTENDED_TYPE = {-94, 57, 79, 82, 90, -101, 79, Ascii.DC4, -94, ISO7816.INS_REHABILITATE_CHV, 108, 66, 124, 100, ISOFileInfo.ENV_TEMP_EF, -12};
    ...
    public static ExtractorsFactory newFactory(final SubtitleParser.Factory factory) {
        return new ExtractorsFactory() { // from class: androidx.media3.extractor.mp4.FragmentedMp4Extractor$$ExternalSyntheticLambda0
            @Override // androidx.media3.extractor.ExtractorsFactory
            public final Extractor[] createExtractors() {
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> parseTraks = AtomParsers.parseTraks(containerAtom, new GaplessInfoHolder(), j, drmInitDataFromAtoms, (this.flags & 16) != 0, false, new Function() { // from class: androidx.media3.extractor.mp4.FragmentedMp4Extractor$$ExternalSyntheticLambda2
        ...
        if (this.trackBundles.size() == 0) {
            while (i < size2) {
                ...
                this.trackBundles.put(track.f40id, new TrackBundle(this.extractorOutput.track(i, track.type), trackSampleTable, getDefaultSampleValues(sparseArray, track.f40id)));
        ...
        while (i < size2) {
            ...
            this.trackBundles.get(track2.f40id).reset(trackSampleTable2, getDefaultSampleValues(sparseArray, track2.f40id));
            i++;
        }
    }

...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    */
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> parseTraks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder, C.TIME_UNSET, null, (this.flags & 1) != 0, z, new Function() { // from class: androidx.media3.extractor.mp4.Mp4Extractor$$ExternalSyntheticLambda2
        ...
        while (i3 < parseTraks.size()) {
            ...
            if (trackSampleTable.sampleCount == 0) {
                ...
                MetadataUtil.setFormatMetadata(i7, parseMdtaFromMeta, buildUpon, metadataArr);

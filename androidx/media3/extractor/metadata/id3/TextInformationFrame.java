...
public final class TextInformationFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        return Util.areEqual(this.f38id, textInformationFrame.f38id) && Util.areEqual(this.description, textInformationFrame.description) && this.values.equals(textInformationFrame.values);
    }

    public int hashCode() {
        int hashCode = (527 + this.f38id.hashCode()) * 31;
    ...
    public String toString() {
        return this.f38id + ": description=" + this.description + ": values=" + this.values;
    }

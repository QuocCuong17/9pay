...
public final class UrlLinkFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f38id.equals(urlLinkFrame.f38id) && Util.areEqual(this.description, urlLinkFrame.description) && Util.areEqual(this.url, urlLinkFrame.url);
    }
    ...
    public String toString() {
        return this.f38id + ": url=" + this.url;
    }

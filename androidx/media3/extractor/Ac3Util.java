...
public final class Ac3Util {
    ...
    private static final int[] BITRATE_BY_HALF_FRMSIZECOD = {32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, BaselineTIFFTagSet.TAG_COLOR_MAP, RendererCapabilities.DECODER_SUPPORT_MASK, 448, 512, 576, 640};
    private static final int[] SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = {69, 87, 104, 121, 139, CipherSuite.TLS_PSK_WITH_AES_128_CBC_SHA256, 208, 243, BaselineTIFFTagSet.TAG_ROWS_PER_STRIP, 348, 417, 487, 557, 696, 835, 975, 1114, 1253, 1393};
    ...
    public static int parseAc3SyncframeAudioSampleCount(ByteBuffer byteBuffer) {
        if (((byteBuffer.get(byteBuffer.position() + 5) & 248) >> 3) > 10) {
            return BLOCKS_PER_SYNCFRAME_BY_NUMBLKSCOD[((byteBuffer.get(byteBuffer.position() + 4) & ISO7816.INS_GET_RESPONSE) >> 6) != 3 ? (byteBuffer.get(byteBuffer.position() + 4) & ISO7816.INS_DECREASE) >> 4 : 3] * 256;
        }

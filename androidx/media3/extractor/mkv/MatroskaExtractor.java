...
public class MatroskaExtractor implements Extractor {
    ...
    private static final byte[] SUBRIP_PREFIX = {49, 10, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, 58, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, 58, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, ISO7816.INS_UNBLOCK_CHV, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, 32, 45, 45, 62, 32, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, 58, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, 58, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, ISO7816.INS_UNBLOCK_CHV, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, 10};
    ...
    private static final byte[] VTT_PREFIX = {87, 69, 66, 86, 84, 84, 10, 10, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, 58, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, 58, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, 46, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, 32, 45, 45, 62, 32, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, 58, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, 58, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, 46, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, ISO7816.INS_DECREASE, 10};
                ...
                if (i8 == 2) {
                    ...
                    while (true) {
                        ...
                        do {
                            ...
                            i5 = this.scratch.getData()[i9 - 1] & 255;
                    ...
                    this.blockSampleSizes[i4 - 1] = ((i2 - this.blockTrackNumberLength) - i9) - i14;
                } else {
                    if (i8 != 3) {
                        ...
                        if (i15 < i17 - 1) {
                            ...
                            while (true) {
                                ...
                                if ((this.scratch.getData()[i18] & i20) != 0) {
                                    ...
                                    track3 = track4;
                                    long j3 = (~i20) & this.scratch.getData()[i18] & b;
                                    int i22 = i18 + 1;
                                    while (true) {
                                        j2 = j3;
                                        if (i22 >= i21) {
                                        ...
                                        j3 = (j2 << 8) | (this.scratch.getData()[i22] & b);
                                        i22++;
                                        i21 = i21;
                                        b = 255;
                                    }
                            ...
                            track2 = track4;
                            this.blockSampleSizes[i17 - 1] = ((i2 - this.blockTrackNumberLength) - i9) - i16;
                            break;
                        }
                    }
                }
            ...
            switch (c) {
                ...
                case '\t':
                    ...
                    if (MimeTypes.isAudio(str3)) {
                        ...
                        if (this.projectionType == 0 && Float.compare(this.projectionPoseYaw, 0.0f) == 0 && Float.compare(this.projectionPosePitch, 0.0f) == 0) {
                            ...
                            builder.setWidth(this.width).setHeight(this.height).setPixelWidthHeightRatio(f).setRotationDegrees(i8).setProjectionData(this.projectionData).setStereoMode(this.stereoMode).setColorInfo(build);
                            i4 = 2;
                        }
                        i8 = i5;
                        builder.setWidth(this.width).setHeight(this.height).setPixelWidthHeightRatio(f).setRotationDegrees(i8).setProjectionData(this.projectionData).setStereoMode(this.stereoMode).setColorInfo(build);
                ...
                case 2:
                    if (parseMsAcmCodecPrivate(new ParsableByteArray(getCodecPrivate(this.codecId)))) {
                        ...
                        str3 = str5;
                        int i82 = 0;
                        int i92 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                        builder = new Format.Builder();
                        if (MimeTypes.isAudio(str3)) {
                        }
                        if (this.name != null) {
                    ...
                    str3 = str5;
                    int i822 = 0;
                    int i922 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 3:
                    ...
                    str3 = str5;
                    int i8222 = 0;
                    int i9222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 4:
                    ...
                    str3 = str5;
                    int i82222 = 0;
                    int i92222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 5:
                    ...
                    str3 = str5;
                    int i822222 = 0;
                    int i922222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 6:
                    ...
                    str3 = str5;
                    int i8222222 = 0;
                    int i9222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 7:
                    ...
                    str3 = str5;
                    int i82222222 = 0;
                    int i92222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case '\b':
                    ...
                    str3 = str5;
                    int i822222222 = 0;
                    int i922222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case '\n':
                    ...
                    str3 = str5;
                    int i8222222222 = 0;
                    int i9222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 11:
                    ...
                    str3 = str5;
                    int i82222222222 = 0;
                    int i92222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case '\f':
                    ...
                    str3 = str5;
                    int i822222222222 = 0;
                    int i922222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case '\r':
                    ...
                    int i9222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 14:
                    ...
                    int i92222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 21:
                    ...
                    str3 = str5;
                    int i822222222222222 = 0;
                    int i922222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 16:
                    ...
                    str3 = str5;
                    int i8222222222222222 = 0;
                    int i9222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 17:
                    ...
                    str3 = str5;
                    int i82222222222222222 = 0;
                    int i92222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 18:
                    ...
                    str3 = str5;
                    int i822222222222222222 = 0;
                    int i922222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 19:
                    ...
                    str3 = str5;
                    int i8222222222222222222 = 0;
                    int i9222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 20:
                    ...
                    str3 = str5;
                    int i82222222222222222222 = 0;
                    int i92222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 22:
                    if (this.audioBitDepth != 32) {
                        ...
                        str3 = str5;
                        int i822222222222222222222 = 0;
                        int i922222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                        builder = new Format.Builder();
                        if (MimeTypes.isAudio(str3)) {
                        }
                        if (this.name != null) {
                    ...
                    str3 = str5;
                    int i8222222222222222222222 = 0;
                    int i9222222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 23:
                    ...
                    if (i12 == 8) {
                        ...
                        str3 = str5;
                        int i82222222222222222222222 = 0;
                        int i92222222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                        builder = new Format.Builder();
                        if (MimeTypes.isAudio(str3)) {
                        }
                        if (this.name != null) {
                    ...
                    if (i12 == 16) {
                        ...
                        if (i12 != 32) {
                            ...
                            str3 = str5;
                            int i822222222222222222222222 = 0;
                            int i922222222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                            builder = new Format.Builder();
                            if (MimeTypes.isAudio(str3)) {
                            }
                            if (this.name != null) {
                    ...
                    str3 = str5;
                    int i8222222222222222222222222 = 0;
                    int i9222222222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 24:
                    ...
                    if (pcmEncoding == 0) {
                        ...
                        str3 = str5;
                        int i82222222222222222222222222 = 0;
                        int i92222222222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                        builder = new Format.Builder();
                        if (MimeTypes.isAudio(str3)) {
                        }
                        if (this.name != null) {
                    ...
                    str3 = str5;
                    int i822222222222222222222222222 = 0;
                    int i922222222222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 25:
                    ...
                    str3 = str5;
                    int i8222222222222222222222222222 = 0;
                    int i9222222222222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 26:
                    ...
                    str3 = str5;
                    int i82222222222222222222222222222 = 0;
                    int i92222222222222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 27:
                    ...
                    str3 = str5;
                    int i822222222222222222222222222222 = 0;
                    int i922222222222222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 28:
                    ...
                    str3 = str5;
                    int i8222222222222222222222222222222 = 0;
                    int i9222222222222222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 29:
                    ...
                    str3 = str5;
                    int i82222222222222222222222222222222 = 0;
                    int i92222222222222222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 30:
                    ...
                    str3 = str5;
                    int i822222222222222222222222222222222 = 0;
                    int i922222222222222222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                ...
                case 31:
                    ...
                    str3 = str5;
                    int i8222222222222222222222222222222222 = 0;
                    int i9222222222222222222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    ...
                    return;
                case ' ':
                    i7 = MatroskaExtractor.OPUS_MAX_INPUT_SIZE;
                    ...
                    str3 = str5;
                    int i82222222222222222222222222222222222 = 0;
                    int i92222222222222222222222222222222222 = (this.flagDefault ? 1 : 0) | 0 | (this.flagForced ? 2 : 0);
                    builder = new Format.Builder();
                    if (MimeTypes.isAudio(str3)) {
                    }
                    if (this.name != null) {
                    }
                    Format build22222222222222222222222222222222222 = builder.setId(i).setSampleMimeType(str3).setMaxInputSize(i3).setLanguage(this.language).setSelectionFlags(i92222222222222222222222222222222222).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
                    TrackOutput track2222222222222222222222222222222222 = extractorOutput.track(this.number, i4);
                    this.output = track2222222222222222222222222222222222;
                    track2222222222222222222222222222222222.format(build22222222222222222222222222222222222);
                    return;
                default:

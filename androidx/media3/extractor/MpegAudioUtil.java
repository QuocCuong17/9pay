...
public final class MpegAudioUtil {
    ...
    public static final class Header {
        ...
        public boolean setForHeaderData(int i) {
            ...
            if (i3 == 3) {
                ...
                int i9 = CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA;
                if (i2 == 3) {
                    int i10 = i3 == 2 ? MpegAudioUtil.BITRATE_V1_L2[i4 - 1] : MpegAudioUtil.BITRATE_V1_L3[i4 - 1];
                    this.bitrate = i10;
                    this.frameSize = ((i10 * CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA) / this.sampleRate) + i7;
                } else {
    ...
    public static int getFrameSize(int i) {
        ...
        int i9 = CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA;
        if (i2 == 3) {
            return ((i6 * CipherSuite.TLS_DHE_PSK_WITH_AES_128_CBC_SHA) / i7) + i8;
        }
        if (i3 == 1) {
            i9 = 72;
        }

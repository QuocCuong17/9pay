...
public final class CueDecoder {
    ...
    public CuesWithTiming decode(long j, byte[] bArr, int i, int i2) {
        ...
        obtain.recycle();
        return new CuesWithTiming(BundleCollectionUtil.fromBundleList(CueGroup$$ExternalSyntheticLambda0.INSTANCE, (ArrayList) Assertions.checkNotNull(readBundle.getParcelableArrayList(BUNDLE_FIELD_CUES))), j, readBundle.getLong("d"));
    }
}

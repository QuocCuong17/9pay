    ...
    public static final class CueBuilder {
        ...
        public void parsePaletteSection(ParsableByteArray parsableByteArray, int i) {
            ...
            while (i3 < i2) {
                ...
                this.colors[readUnsignedByte] = Util.constrainValue((int) (d + (d3 * 1.772d)), 0, 255) | (Util.constrainValue((int) ((d - (0.34414d * d3)) - (d2 * 0.71414d)), 0, 255) << 8) | (readUnsignedByte5 << 24) | (Util.constrainValue(i4, 0, 255) << 16);
                i3 = i5 + 1;
            }
            this.colorsSet = true;
        }

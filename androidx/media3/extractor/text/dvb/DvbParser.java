...
public final class DvbParser implements SubtitleParser {
    ...
    private static final byte[] defaultMap4To8 = {0, 17, ISO7816.INS_MSE, 51, ISO7816.INS_REHABILITATE_CHV, 85, 102, 119, -120, -103, -86, ByteSourceJsonBootstrapper.UTF8_BOM_2, -52, -35, -18, -1};
        ...
        switch (readBits) {
            ...
            case 17:
                ...
                if (readBits2 == subtitleService.subtitlePageId && pageComposition2 != null) {
                    ...
                    if (pageComposition2.state == 0 && (regionComposition = subtitleService.regions.get(parseRegionComposition.f43id)) != null) {
                        parseRegionComposition.mergeFrom(regionComposition);
                    }
                    subtitleService.regions.put(parseRegionComposition.f43id, parseRegionComposition);
                    break;
                }
                break;
            case 18:
                if (readBits2 == subtitleService.subtitlePageId) {
                    ...
                    subtitleService.cluts.put(parseClutDefinition.f41id, parseClutDefinition);
                    break;
                    ...
                    subtitleService.ancillaryCluts.put(parseClutDefinition2.f41id, parseClutDefinition2);
                    break;
                }
                break;
            case 19:
                if (readBits2 == subtitleService.subtitlePageId) {
                    ...
                    subtitleService.objects.put(parseObjectData.f42id, parseObjectData);
                    break;
                } else if (readBits2 == subtitleService.ancillaryPageId) {
                    ObjectData parseObjectData2 = parseObjectData(parsableBitArray);
                    subtitleService.ancillaryObjects.put(parseObjectData2.f42id, parseObjectData2);
                    break;
                }
                break;
            case 20:

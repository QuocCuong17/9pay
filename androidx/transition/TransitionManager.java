...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo377clone = transition.mo377clone();
        mo377clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo377clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo377clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo377clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo377clone = transition.mo377clone();
        sceneChangeSetup(viewGroup, mo377clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo377clone);
    }

    ...
    public int parseProto2Message(T t, byte[] bArr, int i, int i2, int i3, ArrayDecoders.Registers registers) throws IOException {
        ...
        while (true) {
            if (i23 < i21) {
                ...
                byte b = bArr2[i23];
                if (b < 0) {
                    i6 = ArrayDecoders.decodeVarint32(b, bArr2, i29, registers2);
                    i5 = registers2.int1;
                } else {
                    i5 = b;
                    i6 = i29;
                ...
                int i31 = i5 & 7;
                if (i30 > i27) {
                    positionForFieldNumber = messageSchema2.positionForFieldNumber(i30, i24 / 3);
                } else {
                    ...
                    if (type <= 17) {
                        ...
                        switch (type) {
                            ...
                            case 14:
                                ...
                                if (i31 != 1) {
                                    ...
                                    i18 = i6;
                                    unsafe2.putLong(t, offset, ArrayDecoders.decodeFixed64(bArr2, i6));
                                    i23 = i18 + 8;
                                    i26 |= i36;
                                    i22 = i3;
                                    i24 = i17;
                            ...
                            case 13:
                                ...
                                if (i31 != 5) {
                                    ...
                                    unsafe2.putInt(t3, offset, ArrayDecoders.decodeFixed32(bArr2, i6));
                                    i23 = i6 + 4;
                                    i26 |= i36;
                                    i24 = i17;
                                    i25 = i19;
                            ...
                            case 7:
                                ...
                                if (i31 != 0) {
                                    ...
                                    i23 = ArrayDecoders.decodeVarint64(bArr2, i6, registers2);
                            ...
                            case 8:
                                ...
                                if (i31 != 2) {
                                    ...
                                    if ((i33 & 536870912) == 0) {
                                        i23 = ArrayDecoders.decodeString(bArr2, i6, registers2);
                                    } else {
                                        i23 = ArrayDecoders.decodeStringRequireUtf8(bArr2, i6, registers2);
                                    }
                            ...
                            case 9:
                                ...
                                if (i31 != 2) {
                                    ...
                                    i20 = i2;
                                    i23 = ArrayDecoders.decodeMessageField(messageSchema2.getMessageFieldSchema(i17), bArr2, i6, i20, registers2);
                                    if ((i26 & i36) == 0) {
                                        unsafe2.putObject(t3, offset, registers2.object1);
                                    } else {
                            ...
                            case 10:
                                ...
                                if (i31 != 2) {
                                    ...
                                    i23 = ArrayDecoders.decodeBytes(bArr2, i6, registers2);
                                    unsafe2.putObject(t3, offset, registers2.object1);
                                    i26 |= i36;
                                    i22 = i3;
                                    i24 = i17;
                            ...
                            case 12:
                                ...
                                if (i31 != 0) {
                                    ...
                                    i23 = ArrayDecoders.decodeVarint32(bArr2, i6, registers2);
                            ...
                            case 16:
                                ...
                                if (i31 != 0) {
                                    ...
                                    bArr2 = bArr;
                                    decodeVarint64 = ArrayDecoders.decodeVarint64(bArr2, i6, registers2);
                            ...
                            case 17:
                                if (i31 != 3) {
                                    ...
                                    i7 = i30;
                                    i19 = i34;
                                    i23 = ArrayDecoders.decodeGroupField(messageSchema2.getMessageFieldSchema(i39), bArr, i6, i2, (i30 << 3) | 4, registers);
                                    if ((i26 & i36) == 0) {
                                        unsafe2.putObject(t3, offset, registers2.object1);
                                    } else {
                                        unsafe2.putObject(t3, offset, Internal.mergeMessage(unsafe2.getObject(t3, offset), registers2.object1));
                        ...
                        if (type != 27) {
                            ...
                            if (type <= 49) {
                                ...
                                unsafe = unsafe2;
                                i15 = i34;
                                i23 = parseRepeatedField(t, bArr, i40, i2, i34, i7, i31, i13, i33, type, offset, registers);
                            } else {
                                unsafe = unsafe2;
                                i14 = i40;
                                i15 = i34;
                                i11 = i28;
                                if (type != 50) {
                                    i23 = parseOneofField(t, bArr, i14, i2, i15, i7, i31, i33, type, offset, i13, registers);
                                } else if (i31 == 2) {
                                    i23 = parseMapField(t, bArr, i14, i2, i13, offset, registers);
                                }
                            }
                        } else if (i31 == 2) {
                            ...
                            i23 = ArrayDecoders.decodeMessageList(messageSchema2.getMessageFieldSchema(i32), i34, bArr, i40, i2, protobufList, registers);
                            i22 = i3;
                            i25 = i34;
                            i27 = i7;
                            i24 = i32;
                ...
                if (i9 != i12 || i12 == 0) {
                    ...
                    if (this.hasExtensions && registers.extensionRegistry != ExtensionRegistryLite.getEmptyRegistry()) {
                        i23 = ArrayDecoders.decodeExtensionOrUnknownField(i9, bArr, i8, i2, t, this.defaultInstance, this.unknownFieldSchema, registers);
                    } else {
                        i23 = ArrayDecoders.decodeUnknownField(i9, bArr, i8, i2, getMutableUnknownFields(t), registers);
                    }
                    t3 = t;
                    bArr2 = bArr;
                    i21 = i2;

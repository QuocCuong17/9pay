...
public final class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    public void collectEffects(List<? extends SpecialEffectsController.Operation> operations, boolean isPop) {
        ...
        while (it2.hasNext()) {
            ...
            arrayList.add(new AnimationInfo(next, isPop));
            arrayList2.add(new TransitionInfo(next, isPop, !isPop ? next != operation5 : next != operation3));
    ...
    private final void createTransitionEffect(List<TransitionInfo> transitionInfos, boolean isPop, SpecialEffectsController.Operation firstOut, SpecialEffectsController.Operation lastIn) {
        ...
        ArrayList<TransitionInfo> arrayList7 = arrayList6;
        ...
        loop3: while (true) {
            obj = null;
            for (TransitionInfo transitionInfo2 : arrayList7) {
                if (!transitionInfo2.hasSharedElementTransition() || firstOut == null || lastIn == null) {
                    ...
                    if (FragmentManager.isLoggingEnabled(2)) {
                        ...
                        Iterator<String> it = sharedElementTargetNames.iterator();
                        while (true) {
                            arrayList2 = arrayList9;
                            if (!it.hasNext()) {
                                break;
        ...
        if (obj == null) {
            if (!(arrayList8 instanceof Collection) || !arrayList8.isEmpty()) {
                ...
                while (it4.hasNext()) {
                    if (!(((TransitionInfo) it4.next()).getTransition() == null)) {
                        z = false;
                        break;
                    }
                }
        ...
        while (it5.hasNext()) {
            ((TransitionInfo) it5.next()).getOperation().addEffect(transitionEffect);
        }
    }
    ...
    public static final class TransitionEffect extends SpecialEffectsController.Effect {
        ...
        public void onCommit(final ViewGroup container) {
            ...
            if (container.isLaidOut()) {
                ...
                for (final SpecialEffectsController.Operation operation : arrayList) {
                    this.transitionImpl.setListenerForTransitionEnd(operation.getFragment(), component2, this.transitionSignal, new Runnable() { // from class: androidx.fragment.app.DefaultSpecialEffectsController$TransitionEffect$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {

...
public class FragmentStateManager {
    ...
    public Bundle saveState() {
        ...
        if (this.mFragment.mState > -1) {
            ...
            Bundle m230lambda$attachController$4$androidxfragmentappFragmentManager = this.mFragment.mChildFragmentManager.m230lambda$attachController$4$androidxfragmentappFragmentManager();
            if (!m230lambda$attachController$4$androidxfragmentappFragmentManager.isEmpty()) {
                bundle.putBundle(CHILD_FRAGMENT_MANAGER_KEY, m230lambda$attachController$4$androidxfragmentappFragmentManager);
            }
            if (this.mFragment.mView != null) {
                saveViewState();
            }

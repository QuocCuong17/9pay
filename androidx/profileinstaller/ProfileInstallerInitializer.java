...
public class ProfileInstallerInitializer implements Initializer<Result> {
    ...
    void delayAfterFirstFrame(final Context context) {
        Choreographer16Impl.postFrameCallback(new Runnable() { // from class: androidx.profileinstaller.ProfileInstallerInitializer$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                ProfileInstallerInitializer.this.m375xfbd6c934(context);
            }
        });
    }
    ...
    public void m375xfbd6c934(final Context context) {
        Handler handler;

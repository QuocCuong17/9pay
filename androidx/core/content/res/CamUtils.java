...
final class CamUtils {
    ...
    public static void xyzFromInt(int i, float[] fArr) {
        ...
        fArr[0] = (fArr2[0][0] * linearized) + (fArr2[0][1] * linearized2) + (fArr2[0][2] * linearized3);
        fArr[1] = (fArr2[1][0] * linearized) + (fArr2[1][1] * linearized2) + (fArr2[1][2] * linearized3);
        fArr[2] = (linearized * fArr2[2][0]) + (linearized2 * fArr2[2][1]) + (linearized3 * fArr2[2][2]);
    }

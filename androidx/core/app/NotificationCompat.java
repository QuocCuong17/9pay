...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m192clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m193clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            if (Api23Impl.getIcon(action) == null && action.icon != 0) {
                return new Action(action.icon, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, isContextual, isAuthenticationRequired);
            }
            return new Action(Api23Impl.getIcon(action) != null ? IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action)) : null, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, isContextual, isAuthenticationRequired);
        }
        return new Action(action.icon, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, isContextual, isAuthenticationRequired);
    }

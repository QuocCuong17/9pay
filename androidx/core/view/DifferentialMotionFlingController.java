...
public class DifferentialMotionFlingController {
    ...
    public DifferentialMotionFlingController(Context context, DifferentialMotionFlingTarget differentialMotionFlingTarget) {
        this(context, differentialMotionFlingTarget, new FlingVelocityThresholdCalculator() { // from class: androidx.core.view.DifferentialMotionFlingController$$ExternalSyntheticLambda1
        ...
        }, new DifferentialVelocityProvider() { // from class: androidx.core.view.DifferentialMotionFlingController$$ExternalSyntheticLambda0
    ...
    public void onMotionEvent(MotionEvent motionEvent, int i) {
        ...
        float max = Math.max(-iArr[1], Math.min(currentVelocity, iArr[1]));

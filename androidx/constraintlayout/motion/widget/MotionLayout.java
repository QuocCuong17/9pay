...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    */
    ...
    public void transitionToState(int id2, int screenWidth, int screenHeight, int duration) {
        ...
        MotionScene motionScene = this.mScene;
        if (motionScene != null && motionScene.mStateSet != null && (convertToConstraintSet = this.mScene.mStateSet.convertToConstraintSet(this.mCurrentState, id2, screenWidth, screenHeight)) != -1) {
    ...
    public class Model {
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            sb10.append(str5);
            Log.v(MotionLayout.TAG, str + sb10.toString() + " ---  " + child);
        }
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Log.v(MotionLayout.TAG, str2 + "  " + name + " " + constraintWidget + " " + sb8);
            }

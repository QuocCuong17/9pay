...
public class Debug {
    ...
    public static String getState(MotionLayout layout, int stateId, int len) {
        ...
        return resourceEntryName.replaceAll(CharBuffer.allocate((resourceEntryName.length() - len) / length).toString().replace((char) 0, FilenameUtils.EXTENSION_SEPARATOR) + "_", "_");
    }

...
public class ConstraintLayoutStates {
    ...
    public boolean needsToChange(int id2, float width, float height) {
        ...
        State valueAt = id2 == -1 ? this.mStateList.valueAt(0) : this.mStateList.get(i);
    ...
    public void updateConstraints(int id2, float width, float height) {
        ...
        State state2 = this.mStateList.get(id2);
        ...
        if (constraintsChangedListener3 != null) {
            constraintsChangedListener3.preLayoutChange(id2, i);
        }
        constraintSet.applyTo(this.mConstraintLayout);
        ConstraintsChangedListener constraintsChangedListener4 = this.mConstraintsChangedListener;
        if (constraintsChangedListener4 != null) {
            constraintsChangedListener4.postLayoutChange(id2, i);
        }
    }

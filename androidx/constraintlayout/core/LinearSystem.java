...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f11id == -1 || solverVariable.f11id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f11id] == null) {
                if (solverVariable.f11id != -1) {
                    solverVariable.reset();
                }
    ...
    public SolverVariable createErrorVariable(int i, String str) {
        ...
        this.mNumColumns++;
        acquireSolverVariable.f11id = i2;
    ...
    */
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f11id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f11id]) {
                    return i2;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f11id] = true;
            }
            if (pivotCandidate != null) {
    ...
    public void addEquality(SolverVariable solverVariable, int i) {
        if (USE_BASIC_SYNONYMS && solverVariable.definitionId == -1) {
            ...
            for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
                SolverVariable solverVariable2 = this.mCache.mIndexedVariables[i2];
                if (solverVariable2 != null && solverVariable2.isSynonym && solverVariable2.synonym == solverVariable.f11id) {

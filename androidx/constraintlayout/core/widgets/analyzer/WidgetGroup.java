...
public class WidgetGroup {
    ...
    private String getOrientationString() {
        ...
        return i == 0 ? "Horizontal" : i == 1 ? "Vertical" : i == 2 ? PDTableAttributeObject.SCOPE_BOTH : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }

    public String toString() {
        String str = getOrientationString() + " [" + this.f12id + "] <";
    ...
    public void cleanup(ArrayList<WidgetGroup> arrayList) {
        ...
        if (this.moveTo != -1 && size > 0) {
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (this.moveTo == widgetGroup.f12id) {

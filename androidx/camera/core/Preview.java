...
public final class Preview extends UseCase {
    ...
    SessionConfig.Builder createPipeline(final String str, final PreviewConfig previewConfig, final Size size) {
        ...
        createFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.Preview$$ExternalSyntheticLambda0
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                Preview.this.m138lambda$createPipeline$0$androidxcameracorePreview(str, previewConfig, size, sessionConfig, sessionError);
            }
        });
        return createFrom;
    }
    ...
    public /* synthetic */ void m138lambda$createPipeline$0$androidxcameracorePreview(String str, PreviewConfig previewConfig, Size size, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {

...
public final class ImageCapture extends UseCase {
    ...
    ImageCapture(ImageCaptureConfig imageCaptureConfig) {
        ...
        this.mClosingListener = new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda7
    ...
    */
    SessionConfig.Builder createPipeline(final String str, final ImageCaptureConfig imageCaptureConfig, final Size size) {
        ...
        if (imageCaptureConfig.getImageReaderProxyProvider() != null) {
            ...
            this.mImageCaptureRequestProcessor = new ImageCaptureRequestProcessor(2, new ImageCaptureRequestProcessor.ImageCaptor() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda4
                ...
                public final ListenableFuture capture(ImageCapture.ImageCaptureRequest imageCaptureRequest) {
                    return ImageCapture.this.m125lambda$createPipeline$1$androidxcameracoreImageCapture(imageCaptureRequest);
                }
            ...
            createFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda8
                @Override // androidx.camera.core.impl.SessionConfig.ErrorListener
                public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                    ImageCapture.this.m126lambda$createPipeline$2$androidxcameracoreImageCapture(str, imageCaptureConfig, size, sessionConfig, sessionError);
                }
            });
            return createFrom;
        }
        ...
        terminationFuture2.addListener(new ZslControlImpl$$ExternalSyntheticLambda1(safeCloseImageReaderProxy2), CameraXExecutors.mainThreadExecutor());
        createFrom.addNonRepeatingSurface(this.mDeferrableSurface);
        createFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda8
            @Override // androidx.camera.core.impl.SessionConfig.ErrorListener
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
    ...
    public /* synthetic */ void m126lambda$createPipeline$2$androidxcameracoreImageCapture(String str, ImageCaptureConfig imageCaptureConfig, Size size, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        clearPipeline();
    ...
    public void m128lambda$takePicture$3$androidxcameracoreImageCapture(final Executor executor, final OnImageCapturedCallback onImageCapturedCallback) {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    ImageCapture.this.m128lambda$takePicture$3$androidxcameracoreImageCapture(executor, onImageCapturedCallback);
                }
            });
        } else {
    ...
    /* renamed from: takePicture, reason: merged with bridge method [inline-methods] */
    public void m129lambda$takePicture$4$androidxcameracoreImageCapture(final OutputFileOptions outputFileOptions, final Executor executor, final OnImageSavedCallback onImageSavedCallback) {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda12
                @Override // java.lang.Runnable
                public final void run() {
                    ImageCapture.this.m129lambda$takePicture$4$androidxcameracoreImageCapture(outputFileOptions, executor, onImageSavedCallback);
                }
            });
            return;
        }
    ...
    private void sendImageCaptureRequest(Executor executor, final OnImageCapturedCallback onImageCapturedCallback, boolean z) {
        ...
        if (camera == null) {
            executor.execute(new Runnable() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda11
                @Override // java.lang.Runnable
                public final void run() {
                    ImageCapture.this.m127x1bb57f01(onImageCapturedCallback);
                }
            });
            return;
        }
    ...
    public /* synthetic */ void m127x1bb57f01(OnImageCapturedCallback onImageCapturedCallback) {
    ...
    public ListenableFuture<ImageProxy> m125lambda$createPipeline$1$androidxcameracoreImageCapture(final ImageCaptureRequest imageCaptureRequest) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda9
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return ImageCapture.this.m130lambda$takePictureInternal$9$androidxcameracoreImageCapture(imageCaptureRequest, completer);
            }
        });
    }

    /* renamed from: lambda$takePictureInternal$9$androidx-camera-core-ImageCapture, reason: not valid java name */
    public /* synthetic */ Object m130lambda$takePictureInternal$9$androidxcameracoreImageCapture(ImageCaptureRequest imageCaptureRequest, final CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public void onDetached() {
        ...
        listenableFuture.addListener(new Runnable() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
    ...
    ListenableFuture<Void> issueTakePicture(final ImageCaptureRequest imageCaptureRequest) {
        ...
        if (this.mProcessingImageReader != null) {
            ...
            this.mProcessingImageReader.setOnProcessingErrorCallback(CameraXExecutors.directExecutor(), new ProcessingImageReader.OnProcessingErrorCallback() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda5
        ...
        return Futures.transform(getCameraControl().submitStillCaptureRequests(arrayList, this.mCaptureMode, this.mFlashType), new Function() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda0
    ...
    public static class ImageCaptureRequest {
        ...
        void dispatchImage(ImageProxy imageProxy) {
            ...
            try {
                this.mListenerExecutor.execute(new Runnable() { // from class: androidx.camera.core.ImageCapture$ImageCaptureRequest$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        ImageCapture.ImageCaptureRequest.this.m131xf35699e1(settableImageProxy);
                    }
                });
        ...
        public /* synthetic */ void m131xf35699e1(ImageProxy imageProxy) {
            ...
            if (this.mDispatched.compareAndSet(false, true)) {
                try {
                    this.mListenerExecutor.execute(new Runnable() { // from class: androidx.camera.core.ImageCapture$ImageCaptureRequest$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            ImageCapture.ImageCaptureRequest.this.m132xe8eba4db(i, str, th);
                        }
                    });
                } catch (RejectedExecutionException unused) {
                    Logger.e(ImageCapture.TAG, "Unable to post to the supplied executor.");
        ...
        public /* synthetic */ void m132xe8eba4db(int i, String str, Throwable th) {
    ...
    public static final class Builder implements UseCaseConfig.Builder<ImageCapture, ImageCaptureConfig, Builder>, ImageOutputConfig.Builder<Builder>, IoConfig.Builder<Builder> {
        ...
        public Builder setTargetClass(Class<ImageCapture> cls) {
            ...
            if (getMutableConfig().retrieveOption(ImageCaptureConfig.OPTION_TARGET_NAME, null) == null) {
                setTargetName(cls.getCanonicalName() + Parameters.DEFAULT_OPTION_PREFIXES + UUID.randomUUID());
            }
            return this;
        }

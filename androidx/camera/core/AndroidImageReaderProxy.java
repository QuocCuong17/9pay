...
public class AndroidImageReaderProxy implements ImageReaderProxy {
        ...
        synchronized (this.mLock) {
            this.mImageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() { // from class: androidx.camera.core.AndroidImageReaderProxy$$ExternalSyntheticLambda0
                ...
                public final void onImageAvailable(ImageReader imageReader) {
                    AndroidImageReaderProxy.this.m112x2fd48a6(executor, onImageAvailableListener, imageReader);
                }
    ...
    public /* synthetic */ void m111x4985bb07(ImageReaderProxy.OnImageAvailableListener onImageAvailableListener) {
    ...
    public /* synthetic */ void m112x2fd48a6(Executor executor, final ImageReaderProxy.OnImageAvailableListener onImageAvailableListener, ImageReader imageReader) {
        executor.execute(new Runnable() { // from class: androidx.camera.core.AndroidImageReaderProxy$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                AndroidImageReaderProxy.this.m111x4985bb07(onImageAvailableListener);
            }
        });
    }

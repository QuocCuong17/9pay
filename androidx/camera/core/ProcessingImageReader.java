...
public class ProcessingImageReader implements ImageReaderProxy {
    ...
    public class AnonymousClass2 implements ImageReaderProxy.OnImageAvailableListener {
                ...
                if (executor != null) {
                    executor.execute(new Runnable() { // from class: androidx.camera.core.ProcessingImageReader$2$$ExternalSyntheticLambda0
                        ...
                        public final void run() {
                            ProcessingImageReader.AnonymousClass2.this.m141x3c329d5d(onImageAvailableListener);
                        }
                    });
                } else {
        ...
        public /* synthetic */ void m141x3c329d5d(ImageReaderProxy.OnImageAvailableListener onImageAvailableListener) {
            onImageAvailableListener.onImageAvailable(ProcessingImageReader.this);
        }
    }
    ...
    void closeAndCompleteFutureIfNecessary() {
        ...
        this.mUnderlyingCaptureProcessorCloseFuture.addListener(new Runnable() { // from class: androidx.camera.core.ProcessingImageReader$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                ProcessingImageReader.this.m139x76c5121f(completer);
            }
    ...
    public /* synthetic */ void m139x76c5121f(CallbackToFutureAdapter.Completer completer) {
                ...
                if (this.mCloseFuture == null) {
                    this.mCloseFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.ProcessingImageReader$$ExternalSyntheticLambda1
                        ...
                        public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                            return ProcessingImageReader.this.m140xf1cfc5d5(completer);
                        }
                    });
                }
    ...
    public /* synthetic */ Object m140xf1cfc5d5(CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (this.mLock) {

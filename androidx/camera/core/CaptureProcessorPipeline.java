...
public class CaptureProcessorPipeline implements CaptureProcessor {
    ...
    public void onResolutionUpdate(Size size) {
        ...
        this.mIntermediateImageReader.setOnImageAvailableListener(new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.core.CaptureProcessorPipeline$$ExternalSyntheticLambda1
            @Override // androidx.camera.core.impl.ImageReaderProxy.OnImageAvailableListener
            public final void onImageAvailable(ImageReaderProxy imageReaderProxy) {
                CaptureProcessorPipeline.this.m120x3f602b2(imageReaderProxy);
            }
        }, CameraXExecutors.directExecutor());
    }

    /* renamed from: lambda$onResolutionUpdate$1$androidx-camera-core-CaptureProcessorPipeline, reason: not valid java name */
    public /* synthetic */ void m120x3f602b2(ImageReaderProxy imageReaderProxy) {
        ...
        try {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.CaptureProcessorPipeline$$ExternalSyntheticLambda3
                ...
                public final void run() {
                    CaptureProcessorPipeline.this.m119x8e7bdc71(acquireNextImage);
                }
            });
    ...
    public void m119x8e7bdc71(ImageProxy imageProxy) {
        boolean z;
        synchronized (this.mLock) {
            z = this.mClosed;
        }
    ...
    public ListenableFuture<Void> getCloseFuture() {
        ...
        synchronized (this.mLock) {
            if (this.mClosed && !this.mProcessing) {
                nonCancellationPropagating = Futures.transform(this.mUnderlyingCaptureProcessorsCloseFuture, new Function() { // from class: androidx.camera.core.CaptureProcessorPipeline$$ExternalSyntheticLambda0
                ...
                if (this.mCloseFuture == null) {
                    this.mCloseFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.CaptureProcessorPipeline$$ExternalSyntheticLambda2
                        ...
                        public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                            return CaptureProcessorPipeline.this.m118x1c495a06(completer);
                        }
                    });
                }
    ...
    public /* synthetic */ Object m118x1c495a06(CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (this.mLock) {

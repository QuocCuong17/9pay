...
public final class ImageSaver implements Runnable {
        ...
        if (saveImageToTempFile != null) {
            this.mSequentialIoExecutor.execute(new Runnable() { // from class: androidx.camera.core.ImageSaver$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    ImageSaver.this.m135lambda$run$0$androidxcameracoreImageSaver(saveImageToTempFile);
                }
            });
        }
    }
    ...
    */
    public void m135lambda$run$0$androidxcameracoreImageSaver(File file) {
        Uri uri;
        SaveError saveError;
        String str;
    ...
    private void postSuccess(final Uri uri) {
        try {
            this.mUserCallbackExecutor.execute(new Runnable() { // from class: androidx.camera.core.ImageSaver$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ImageSaver.this.m134lambda$postSuccess$1$androidxcameracoreImageSaver(uri);
                }
            });
    ...
    public /* synthetic */ void m134lambda$postSuccess$1$androidxcameracoreImageSaver(Uri uri) {
    ...
    private void postError(final SaveError saveError, final String str, final Throwable th) {
        try {
            this.mUserCallbackExecutor.execute(new Runnable() { // from class: androidx.camera.core.ImageSaver$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ImageSaver.this.m133lambda$postError$2$androidxcameracoreImageSaver(saveError, str, th);
                }
            });
        } catch (RejectedExecutionException unused) {
    ...
    public /* synthetic */ void m133lambda$postError$2$androidxcameracoreImageSaver(SaveError saveError, String str, Throwable th) {

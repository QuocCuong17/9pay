...
public class SurfaceSorter {
        ...
        if (this.mHasQuirk) {
            Collections.sort(list, new Comparator() { // from class: androidx.camera.core.internal.compat.workaround.SurfaceSorter$$ExternalSyntheticLambda0
                ...
                public final int compare(Object obj, Object obj2) {
                    return SurfaceSorter.this.m165xa3d7ce91((DeferrableSurface) obj, (DeferrableSurface) obj2);
                }
            });
        }
    }
    ...
    public /* synthetic */ int m165xa3d7ce91(DeferrableSurface deferrableSurface, DeferrableSurface deferrableSurface2) {

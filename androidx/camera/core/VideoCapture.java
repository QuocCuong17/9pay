...
public final class VideoCapture extends UseCase {
    ...
    public void m147lambda$startRecording$0$androidxcameracoreVideoCapture(final OutputFileOptions outputFileOptions, final Executor executor, final OnVideoSavedCallback onVideoSavedCallback) {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.VideoCapture$$ExternalSyntheticLambda7
                ...
                public final void run() {
                    VideoCapture.this.m147lambda$startRecording$0$androidxcameracoreVideoCapture(outputFileOptions, executor, onVideoSavedCallback);
                }
            });
            return;
        }
        ...
        this.mRecordingFuture.addListener(new Runnable() { // from class: androidx.camera.core.VideoCapture$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                VideoCapture.this.m148lambda$startRecording$2$androidxcameracoreVideoCapture();
            }
            ...
            try {
                ...
                if (this.mIsAudioEnabled.get()) {
                    this.mAudioHandler.post(new Runnable() { // from class: androidx.camera.core.VideoCapture$$ExternalSyntheticLambda5
                        @Override // java.lang.Runnable
                        public final void run() {
                            VideoCapture.this.m149lambda$startRecording$3$androidxcameracoreVideoCapture(videoSavedListenerWrapper);
                        }
                    });
                }
                ...
                this.mVideoHandler.post(new Runnable() { // from class: androidx.camera.core.VideoCapture$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        VideoCapture.this.m150lambda$startRecording$4$androidxcameracoreVideoCapture(videoSavedListenerWrapper, cameraId, attachedSurfaceResolution, outputFileOptions, completer);
                    }
                });
    ...
    public /* synthetic */ void m148lambda$startRecording$2$androidxcameracoreVideoCapture() {
        this.mRecordingFuture = null;
        if (getCamera() != null) {
    ...
    public /* synthetic */ void m150lambda$startRecording$4$androidxcameracoreVideoCapture(OnVideoSavedCallback onVideoSavedCallback, String str, Size size, OutputFileOptions outputFileOptions, CallbackToFutureAdapter.Completer completer) {
    ...
    public void m151lambda$stopRecording$5$androidxcameracoreVideoCapture() {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.VideoCapture$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.this.m151lambda$stopRecording$5$androidxcameracoreVideoCapture();
                }
            });
            return;
        }
    ...
    public void onDetached() {
        m151lambda$stopRecording$5$androidxcameracoreVideoCapture();
        ...
        if (listenableFuture != null) {
            listenableFuture.addListener(new Runnable() { // from class: androidx.camera.core.VideoCapture$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.this.m146lambda$onDetached$6$androidxcameracoreVideoCapture();
                }
            }, CameraXExecutors.mainThreadExecutor());
        } else {
            m146lambda$onDetached$6$androidxcameracoreVideoCapture();
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: releaseResources, reason: merged with bridge method [inline-methods] */
    public void m146lambda$onDetached$6$androidxcameracoreVideoCapture() {
    ...
    boolean videoEncode(OnVideoSavedCallback onVideoSavedCallback, String str, Size size, OutputFileOptions outputFileOptions) {
        ...
        while (!z && !z2) {
            ...
            int dequeueOutputBuffer = this.mVideoEncoder.dequeueOutputBuffer(this.mVideoBufferInfo, Renderer.DEFAULT_DURATION_TO_PROGRESS_US);
    ...
    public boolean m149lambda$startRecording$3$androidxcameracoreVideoCapture(OnVideoSavedCallback onVideoSavedCallback) {
        long j = 0;
        boolean z = false;
    ...
    */
    ...
    public static final class VideoSavedListenerWrapper implements OnVideoSavedCallback {
        ...
        public /* synthetic */ void m153x99849d14(OutputFileResults outputFileResults) {
        ...
        public void onVideoSaved(final OutputFileResults outputFileResults) {
            try {
                this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.VideoCapture$VideoSavedListenerWrapper$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        VideoCapture.VideoSavedListenerWrapper.this.m153x99849d14(outputFileResults);
                    }
                });
        ...
        public void onError(final int i, final String str, final Throwable th) {
            try {
                this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.VideoCapture$VideoSavedListenerWrapper$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        VideoCapture.VideoSavedListenerWrapper.this.m152xe8a64259(i, str, th);
                    }
                });
            } catch (RejectedExecutionException unused) {
                Logger.e(VideoCapture.TAG, "Unable to post to the supplied executor.");
        ...
        public /* synthetic */ void m152xe8a64259(int i, String str, Throwable th) {

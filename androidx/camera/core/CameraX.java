...
public final class CameraX {
        ...
        synchronized (this.mInitializeLock) {
            ...
            future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda1
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return CameraX.this.m115lambda$initInternal$0$androidxcameracoreCameraX(context, completer);
                }
            });
        }
        return future;
    ...
    public /* synthetic */ Object m115lambda$initInternal$0$androidxcameracoreCameraX(Context context, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    private void initAndRetryRecursively(final Executor executor, final long j, final Context context, final CallbackToFutureAdapter.Completer<Void> completer) {
        executor.execute(new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda2
            ...
            public final void run() {
                CameraX.this.m114lambda$initAndRetryRecursively$2$androidxcameracoreCameraX(context, executor, completer, j);
            }
        });
    }

    /* renamed from: lambda$initAndRetryRecursively$2$androidx-camera-core-CameraX, reason: not valid java name */
    public /* synthetic */ void m114lambda$initAndRetryRecursively$2$androidxcameracoreCameraX(Context context, final Executor executor, final CallbackToFutureAdapter.Completer completer, final long j) {
        try {
            ...
            if (SystemClock.elapsedRealtime() - j < 2500) {
                ...
                HandlerCompat.postDelayed(this.mSchedulerHandler, new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        CameraX.this.m113lambda$initAndRetryRecursively$1$androidxcameracoreCameraX(executor, j, completer);
                    }
                }, RETRY_TOKEN, 500L);
                return;
            }
    ...
    public /* synthetic */ void m113lambda$initAndRetryRecursively$1$androidxcameracoreCameraX(Executor executor, long j, CallbackToFutureAdapter.Completer completer) {
        ...
        synchronized (this.mInitializeLock) {
            ...
            if (i == 3 || i == 4) {
                ...
                this.mShutdownInternalFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda0
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return CameraX.this.m117lambda$shutdownInternal$4$androidxcameracoreCameraX(completer);
                    }
                });
            }
    ...
    public /* synthetic */ Object m117lambda$shutdownInternal$4$androidxcameracoreCameraX(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mCameraRepository.deinit().addListener(new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                CameraX.this.m116lambda$shutdownInternal$3$androidxcameracoreCameraX(completer);
            }
    ...
    public /* synthetic */ void m116lambda$shutdownInternal$3$androidxcameracoreCameraX(CallbackToFutureAdapter.Completer completer) {

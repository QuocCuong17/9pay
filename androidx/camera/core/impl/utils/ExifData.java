...
public class ExifData {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag(ExifInterface.TAG_IMAGE_WIDTH, 256, 3, 4), new ExifTag(ExifInterface.TAG_IMAGE_LENGTH, 257, 3, 4), new ExifTag(ExifInterface.TAG_MAKE, BaselineTIFFTagSet.TAG_MAKE, 2), new ExifTag(ExifInterface.TAG_MODEL, BaselineTIFFTagSet.TAG_MODEL, 2), new ExifTag(ExifInterface.TAG_ORIENTATION, BaselineTIFFTagSet.TAG_ORIENTATION, 3), new ExifTag(ExifInterface.TAG_X_RESOLUTION, BaselineTIFFTagSet.TAG_X_RESOLUTION, 5), new ExifTag(ExifInterface.TAG_Y_RESOLUTION, BaselineTIFFTagSet.TAG_Y_RESOLUTION, 5), new ExifTag(ExifInterface.TAG_RESOLUTION_UNIT, BaselineTIFFTagSet.TAG_RESOLUTION_UNIT, 3), new ExifTag(ExifInterface.TAG_SOFTWARE, 305, 2), new ExifTag(ExifInterface.TAG_DATETIME, 306, 2), new ExifTag(ExifInterface.TAG_Y_CB_CR_POSITIONING, BaselineTIFFTagSet.TAG_Y_CB_CR_POSITIONING, 3), new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_EXIF_IFD_POINTER, EXIFParentTIFFTagSet.TAG_EXIF_IFD_POINTER, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4)};
        IFD_TIFF_TAGS = exifTagArr;
        ExifTag[] exifTagArr2 = {new ExifTag(ExifInterface.TAG_EXPOSURE_TIME, EXIFTIFFTagSet.TAG_EXPOSURE_TIME, 5), new ExifTag(ExifInterface.TAG_F_NUMBER, EXIFTIFFTagSet.TAG_F_NUMBER, 5), new ExifTag(ExifInterface.TAG_EXPOSURE_PROGRAM, EXIFTIFFTagSet.TAG_EXPOSURE_PROGRAM, 3), new ExifTag(ExifInterface.TAG_PHOTOGRAPHIC_SENSITIVITY, EXIFTIFFTagSet.TAG_ISO_SPEED_RATINGS, 3), new ExifTag(ExifInterface.TAG_SENSITIVITY_TYPE, 34864, 3), new ExifTag(ExifInterface.TAG_EXIF_VERSION, EXIFTIFFTagSet.TAG_EXIF_VERSION, 2), new ExifTag(ExifInterface.TAG_DATETIME_ORIGINAL, EXIFTIFFTagSet.TAG_DATE_TIME_ORIGINAL, 2), new ExifTag(ExifInterface.TAG_DATETIME_DIGITIZED, EXIFTIFFTagSet.TAG_DATE_TIME_DIGITIZED, 2), new ExifTag(ExifInterface.TAG_COMPONENTS_CONFIGURATION, EXIFTIFFTagSet.TAG_COMPONENTS_CONFIGURATION, 7), new ExifTag(ExifInterface.TAG_SHUTTER_SPEED_VALUE, EXIFTIFFTagSet.TAG_SHUTTER_SPEED_VALUE, 10), new ExifTag(ExifInterface.TAG_APERTURE_VALUE, EXIFTIFFTagSet.TAG_APERTURE_VALUE, 5), new ExifTag(ExifInterface.TAG_BRIGHTNESS_VALUE, EXIFTIFFTagSet.TAG_BRIGHTNESS_VALUE, 10), new ExifTag(ExifInterface.TAG_EXPOSURE_BIAS_VALUE, EXIFTIFFTagSet.TAG_EXPOSURE_BIAS_VALUE, 10), new ExifTag(ExifInterface.TAG_MAX_APERTURE_VALUE, EXIFTIFFTagSet.TAG_MAX_APERTURE_VALUE, 5), new ExifTag(ExifInterface.TAG_METERING_MODE, EXIFTIFFTagSet.TAG_METERING_MODE, 3), new ExifTag(ExifInterface.TAG_LIGHT_SOURCE, EXIFTIFFTagSet.TAG_LIGHT_SOURCE, 3), new ExifTag(ExifInterface.TAG_FLASH, EXIFTIFFTagSet.TAG_FLASH, 3), new ExifTag(ExifInterface.TAG_FOCAL_LENGTH, EXIFTIFFTagSet.TAG_FOCAL_LENGTH, 5), new ExifTag(ExifInterface.TAG_SUBSEC_TIME, EXIFTIFFTagSet.TAG_SUB_SEC_TIME, 2), new ExifTag(ExifInterface.TAG_SUBSEC_TIME_ORIGINAL, EXIFTIFFTagSet.TAG_SUB_SEC_TIME_ORIGINAL, 2), new ExifTag(ExifInterface.TAG_SUBSEC_TIME_DIGITIZED, EXIFTIFFTagSet.TAG_SUB_SEC_TIME_DIGITIZED, 2), new ExifTag(ExifInterface.TAG_FLASHPIX_VERSION, EXIFTIFFTagSet.TAG_FLASHPIX_VERSION, 7), new ExifTag(ExifInterface.TAG_COLOR_SPACE, EXIFTIFFTagSet.TAG_COLOR_SPACE, 3), new ExifTag(ExifInterface.TAG_PIXEL_X_DIMENSION, EXIFTIFFTagSet.TAG_PIXEL_X_DIMENSION, 3, 4), new ExifTag(ExifInterface.TAG_PIXEL_Y_DIMENSION, EXIFTIFFTagSet.TAG_PIXEL_Y_DIMENSION, 3, 4), new ExifTag(TAG_INTEROPERABILITY_IFD_POINTER, EXIFTIFFTagSet.TAG_INTEROPERABILITY_IFD_POINTER, 4), new ExifTag(ExifInterface.TAG_FOCAL_PLANE_RESOLUTION_UNIT, EXIFTIFFTagSet.TAG_FOCAL_PLANE_RESOLUTION_UNIT, 3), new ExifTag(ExifInterface.TAG_SENSING_METHOD, EXIFTIFFTagSet.TAG_SENSING_METHOD, 3), new ExifTag(ExifInterface.TAG_FILE_SOURCE, EXIFTIFFTagSet.TAG_FILE_SOURCE, 7), new ExifTag(ExifInterface.TAG_SCENE_TYPE, EXIFTIFFTagSet.TAG_SCENE_TYPE, 7), new ExifTag(ExifInterface.TAG_CUSTOM_RENDERED, EXIFTIFFTagSet.TAG_CUSTOM_RENDERED, 3), new ExifTag(ExifInterface.TAG_EXPOSURE_MODE, EXIFTIFFTagSet.TAG_EXPOSURE_MODE, 3), new ExifTag(ExifInterface.TAG_WHITE_BALANCE, EXIFTIFFTagSet.TAG_WHITE_BALANCE, 3), new ExifTag(ExifInterface.TAG_SCENE_CAPTURE_TYPE, EXIFTIFFTagSet.TAG_SCENE_CAPTURE_TYPE, 3), new ExifTag(ExifInterface.TAG_CONTRAST, EXIFTIFFTagSet.TAG_CONTRAST, 3), new ExifTag(ExifInterface.TAG_SATURATION, EXIFTIFFTagSet.TAG_SATURATION, 3), new ExifTag(ExifInterface.TAG_SHARPNESS, EXIFTIFFTagSet.TAG_SHARPNESS, 3)};
        ...
        EXIF_POINTER_TAGS = new ExifTag[]{new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_EXIF_IFD_POINTER, EXIFParentTIFFTagSet.TAG_EXIF_IFD_POINTER, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_INTEROPERABILITY_IFD_POINTER, EXIFTIFFTagSet.TAG_INTEROPERABILITY_IFD_POINTER, 4)};
    ...
    public static final class Builder {
        ...
        public ExifData build() {
            ...
            if (!list.get(2).isEmpty()) {
                ...
                setAttributeIfMissing(ExifInterface.TAG_GPS_TRACK_REF, "T", list);
                setAttributeIfMissing(ExifInterface.TAG_GPS_IMG_DIRECTION_REF, "T", list);
                setAttributeIfMissing(ExifInterface.TAG_GPS_DEST_BEARING_REF, "T", list);

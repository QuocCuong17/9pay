...
public class FocusMeteringControl {
    ...
    public ListenableFuture<FocusMeteringResult> startFocusAndMetering(final FocusMeteringAction focusMeteringAction) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda3
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return FocusMeteringControl.this.m56xb5d4fd7e(focusMeteringAction, completer);
            }
        });
    }
    ...
    public /* synthetic */ Object m56xb5d4fd7e(final FocusMeteringAction focusMeteringAction, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda7
            ...
            public final void run() {
                FocusMeteringControl.this.m55x8c80a83d(completer, focusMeteringAction);
            }
        });
    ...
    public void m55x8c80a83d(CallbackToFutureAdapter.Completer<FocusMeteringResult> completer, FocusMeteringAction focusMeteringAction) {
        if (!this.mIsActive) {
    ...
    private void executeMeteringAction(MeteringRectangle[] meteringRectangleArr, MeteringRectangle[] meteringRectangleArr2, MeteringRectangle[] meteringRectangleArr3, FocusMeteringAction focusMeteringAction) {
        ...
        Camera2CameraControlImpl.CaptureResultListener captureResultListener = new Camera2CameraControlImpl.CaptureResultListener() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda1
            ...
            public final boolean onCaptureResult(TotalCaptureResult totalCaptureResult) {
                return FocusMeteringControl.this.m52xfc1c23a9(isAfModeSupported, updateSessionConfigSynchronous, totalCaptureResult);
            }
        };
        ...
        if (focusMeteringAction.isAutoCancelEnabled()) {
            ...
            this.mAutoCancelHandle = this.mScheduler.schedule(new Runnable() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    FocusMeteringControl.this.m54x4ec4ce2b(j);
                }
    ...
    public /* synthetic */ boolean m52xfc1c23a9(boolean z, long j, TotalCaptureResult totalCaptureResult) {
    ...
    public /* synthetic */ void m54x4ec4ce2b(final long j) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                FocusMeteringControl.this.m53x257078ea(j);
            }
        });
    }
    ...
    public /* synthetic */ void m53x257078ea(long j) {
    ...
    public ListenableFuture<Void> cancelFocusAndMetering() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda2
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return FocusMeteringControl.this.m50xb24c9a75(completer);
            }
        });
    }

    /* renamed from: lambda$cancelFocusAndMetering$6$androidx-camera-camera2-internal-FocusMeteringControl, reason: not valid java name */
    public /* synthetic */ Object m50xb24c9a75(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                FocusMeteringControl.this.m49x88f84534(completer);
            }
        });
    ...
    public void m49x88f84534(CallbackToFutureAdapter.Completer<Void> completer) {
        ...
        if (this.mRunningCancelCompleter != null) {
            ...
            Camera2CameraControlImpl.CaptureResultListener captureResultListener = new Camera2CameraControlImpl.CaptureResultListener() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda0
                @Override // androidx.camera.camera2.internal.Camera2CameraControlImpl.CaptureResultListener
                public final boolean onCaptureResult(TotalCaptureResult totalCaptureResult) {
                    return FocusMeteringControl.this.m51x2811a093(supportedAfMode, updateSessionConfigSynchronous, totalCaptureResult);
                }
            };
    ...
    /* renamed from: lambda$cancelFocusAndMeteringInternal$7$androidx-camera-camera2-internal-FocusMeteringControl, reason: not valid java name */
    public /* synthetic */ boolean m51x2811a093(int i, long j, TotalCaptureResult totalCaptureResult) {

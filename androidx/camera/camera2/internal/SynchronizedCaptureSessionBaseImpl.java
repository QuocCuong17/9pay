...
public class SynchronizedCaptureSessionBaseImpl extends SynchronizedCaptureSession.StateCallback implements SynchronizedCaptureSession, SynchronizedCaptureSessionOpener.OpenerImpl {
        ...
        synchronized (this.mLock) {
            ...
            ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda1
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return SynchronizedCaptureSessionBaseImpl.this.m67x73bfea20(list, cameraDeviceCompat, sessionConfigurationCompat, completer);
                }
            });
    ...
    public /* synthetic */ Object m67x73bfea20(List list, CameraDeviceCompat cameraDeviceCompat, SessionConfigurationCompat sessionConfigurationCompat, CallbackToFutureAdapter.Completer completer) throws Exception {
        String str;
        synchronized (this.mLock) {
    ...
    public ListenableFuture<List<Surface>> startWithDeferrableSurface(final List<DeferrableSurface> list, long j) {
        synchronized (this.mLock) {
            ...
            FutureChain transformAsync = FutureChain.from(DeferrableSurfaces.surfaceListWithTimeout(list, false, j, getExecutor(), this.mScheduledExecutorService)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda0
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return SynchronizedCaptureSessionBaseImpl.this.m68x2071bdd2(list, (List) obj);
                }
            }, getExecutor());
    ...
    public /* synthetic */ ListenableFuture m68x2071bdd2(List list, List list2) throws Exception {
    ...
    public void close() {
        ...
        getExecutor().execute(new Runnable() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda2
            ...
            public final void run() {
                SynchronizedCaptureSessionBaseImpl.this.m64x23111ba6();
            }
        });
    }
    ...
    public /* synthetic */ void m64x23111ba6() {
    ...
    public void onClosed(final SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        if (listenableFuture != null) {
            listenableFuture.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    SynchronizedCaptureSessionBaseImpl.this.m65x46877ef4(synchronizedCaptureSession);
                }
            }, CameraXExecutors.directExecutor());
        }
    }
    ...
    public /* synthetic */ void m65x46877ef4(SynchronizedCaptureSession synchronizedCaptureSession) {
    ...
    public void onSessionFinished(final SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        if (listenableFuture != null) {
            listenableFuture.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    SynchronizedCaptureSessionBaseImpl.this.m66x5333f8b9(synchronizedCaptureSession);
                }
            }, CameraXExecutors.directExecutor());
        }
    }
    ...
    public /* synthetic */ void m66x5333f8b9(SynchronizedCaptureSession synchronizedCaptureSession) {

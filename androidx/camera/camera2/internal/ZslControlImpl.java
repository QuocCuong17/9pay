...
public final class ZslControlImpl implements ZslControl {
        ...
        if (this.mIsYuvReprocessingSupported || this.mIsPrivateReprocessingSupported) {
            ...
            safeCloseImageReaderProxy.setOnImageAvailableListener(new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.camera2.internal.ZslControlImpl$$ExternalSyntheticLambda0
                ...
                public final void onImageAvailable(ImageReaderProxy imageReaderProxy) {
                    ZslControlImpl.this.m80xd50834cf(imageReaderProxy);
                }
            ...
            terminationFuture.addListener(new ZslControlImpl$$ExternalSyntheticLambda1(safeCloseImageReaderProxy2), CameraXExecutors.mainThreadExecutor());
    ...
    public /* synthetic */ void m80xd50834cf(ImageReaderProxy imageReaderProxy) {

...
public class SynchronizedCaptureSessionImpl extends SynchronizedCaptureSessionBaseImpl {
        ...
        synchronized (this.mObjectLock) {
            ListenableFuture<Void> openCaptureSession = this.mWaitForOtherSessionCompleteQuirk.openCaptureSession(cameraDevice, sessionConfigurationCompat, list, this.mCaptureSessionRepository.getClosingCaptureSession(), new WaitForRepeatingRequestStart.OpenCaptureSession() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionImpl$$ExternalSyntheticLambda1
                ...
                public final ListenableFuture run(CameraDevice cameraDevice2, SessionConfigurationCompat sessionConfigurationCompat2, List list2) {
                    return SynchronizedCaptureSessionImpl.this.m71xe055f2f(cameraDevice2, sessionConfigurationCompat2, list2);
                }
            });
    ...
    public /* synthetic */ ListenableFuture m71xe055f2f(CameraDevice cameraDevice, SessionConfigurationCompat sessionConfigurationCompat, List list) {
    ...
    public int setSingleRepeatingRequest(CaptureRequest captureRequest, CameraCaptureSession.CaptureCallback captureCallback) throws CameraAccessException {
        return this.mWaitForOtherSessionCompleteQuirk.setSingleRepeatingRequest(captureRequest, captureCallback, new WaitForRepeatingRequestStart.SingleRepeatingRequest() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionImpl$$ExternalSyntheticLambda2
            ...
            public final int run(CaptureRequest captureRequest2, CameraCaptureSession.CaptureCallback captureCallback2) {
                return SynchronizedCaptureSessionImpl.this.m72x8c3ed34e(captureRequest2, captureCallback2);
            }
        });
    }
    ...
    public /* synthetic */ int m72x8c3ed34e(CaptureRequest captureRequest, CameraCaptureSession.CaptureCallback captureCallback) throws CameraAccessException {
    ...
    public void onConfigured(SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        this.mForceCloseSessionQuirk.onSessionConfigured(synchronizedCaptureSession, this.mCaptureSessionRepository.getCreatingCaptureSessions(), this.mCaptureSessionRepository.getCaptureSessions(), new ForceCloseCaptureSession.OnConfigured() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionImpl$$ExternalSyntheticLambda0
            ...
            public final void run(SynchronizedCaptureSession synchronizedCaptureSession2) {
                SynchronizedCaptureSessionImpl.this.m70xf1a34454(synchronizedCaptureSession2);
            }
        });
    }
    ...
    public /* synthetic */ void m70xf1a34454(SynchronizedCaptureSession synchronizedCaptureSession) {
    ...
    public void close() {
        ...
        this.mWaitForOtherSessionCompleteQuirk.getStartStreamFuture().addListener(new Runnable() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionImpl$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                SynchronizedCaptureSessionImpl.this.m69x47c7bbb6();
            }
        }, getExecutor());
    }

    /* renamed from: lambda$close$3$androidx-camera-camera2-internal-SynchronizedCaptureSessionImpl, reason: not valid java name */
    public /* synthetic */ void m69x47c7bbb6() {

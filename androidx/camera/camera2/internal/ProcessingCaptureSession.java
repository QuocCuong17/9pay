...
public final class ProcessingCaptureSession implements CaptureSessionInterface {
    ...
    public ListenableFuture<Void> open(final SessionConfig sessionConfig, final CameraDevice cameraDevice, final SynchronizedCaptureSessionOpener synchronizedCaptureSessionOpener) {
        ...
        return FutureChain.from(DeferrableSurfaces.surfaceListWithTimeout(surfaces, false, 5000L, this.mExecutor, this.mScheduledExecutorService)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.ProcessingCaptureSession$$ExternalSyntheticLambda1
            ...
            public final ListenableFuture apply(Object obj) {
                return ProcessingCaptureSession.this.m58x6ab9d420(sessionConfig, cameraDevice, synchronizedCaptureSessionOpener, (List) obj);
            }
            ...
            public final Object apply(Object obj) {
                return ProcessingCaptureSession.this.m59x7b6fa0e1((Void) obj);
            }
        }, this.mExecutor);
    }

    /* renamed from: lambda$open$2$androidx-camera-camera2-internal-ProcessingCaptureSession, reason: not valid java name */
    public /* synthetic */ ListenableFuture m58x6ab9d420(SessionConfig sessionConfig, CameraDevice cameraDevice, SynchronizedCaptureSessionOpener synchronizedCaptureSessionOpener, List list) throws Exception {
        ...
        try {
            ...
            initSession.getSurfaces().get(0).getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.camera2.internal.ProcessingCaptureSession$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    ProcessingCaptureSession.this.m57x494e3a9e();
                }
    ...
    public /* synthetic */ void m57x494e3a9e() {
    ...
    public /* synthetic */ Void m59x7b6fa0e1(Void r1) {
    ...
    public class AnonymousClass2 implements SessionProcessor.CaptureCallback {
        ...
        public void onCaptureFailed(int i) {
            ...
            executor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.ProcessingCaptureSession$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ProcessingCaptureSession.AnonymousClass2.this.m60x132e4b4c(captureConfig);
                }
            });
        }
        ...
        public /* synthetic */ void m60x132e4b4c(CaptureConfig captureConfig) {
        ...
        public void onCaptureSequenceCompleted(int i) {
            ...
            executor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.ProcessingCaptureSession$2$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ProcessingCaptureSession.AnonymousClass2.this.m61xee984246(captureConfig);
                }
            });
        }
        ...
        public /* synthetic */ void m61xee984246(CaptureConfig captureConfig) {
            Iterator<CameraCaptureCallback> it = captureConfig.getCameraCaptureCallbacks().iterator();
            while (it.hasNext()) {
    ...
    public static class SessionProcessorCaptureCallback implements SessionProcessor.CaptureCallback {
        ...
        public void onCaptureFailed(int i) {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.ProcessingCaptureSession$SessionProcessorCaptureCallback$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ProcessingCaptureSession.SessionProcessorCaptureCallback.this.m62xc0f238e9();
                }
            });
        }
        ...
        public /* synthetic */ void m62xc0f238e9() {
        ...
        public void onCaptureSequenceCompleted(int i) {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.ProcessingCaptureSession$SessionProcessorCaptureCallback$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ProcessingCaptureSession.SessionProcessorCaptureCallback.this.m63x9a5d3e63();
                }
            });
        }
        ...
        public /* synthetic */ void m63x9a5d3e63() {
            Iterator<CameraCaptureCallback> it = this.mCameraCaptureCallbacks.iterator();
            while (it.hasNext()) {

...
public final class SurfaceViewImplementation extends PreviewViewImplementation {
    ...
    public void onSurfaceRequested(final SurfaceRequest surfaceRequest, PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
        ...
        this.mSurfaceView.post(new Runnable() { // from class: androidx.camera.view.SurfaceViewImplementation$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceViewImplementation.this.m179x6305943b(surfaceRequest);
            }
        });
    }

    /* renamed from: lambda$onSurfaceRequested$0$androidx-camera-view-SurfaceViewImplementation, reason: not valid java name */
    public /* synthetic */ void m179x6305943b(SurfaceRequest surfaceRequest) {
    ...
    Bitmap getPreviewBitmap() {
        ...
        Api24Impl.pixelCopyRequest(this.mSurfaceView, createBitmap, new PixelCopy.OnPixelCopyFinishedListener() { // from class: androidx.camera.view.SurfaceViewImplementation$$ExternalSyntheticLambda0
    ...
    public class SurfaceRequestCallback implements SurfaceHolder.Callback {
        ...
        private boolean tryToComplete() {
            ...
            this.mSurfaceRequest.provideSurface(surface, ContextCompat.getMainExecutor(SurfaceViewImplementation.this.mSurfaceView.getContext()), new Consumer() { // from class: androidx.camera.view.SurfaceViewImplementation$SurfaceRequestCallback$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    SurfaceViewImplementation.SurfaceRequestCallback.this.m180x982c86c5((SurfaceRequest.Result) obj);
                }
            });
        ...
        public /* synthetic */ void m180x982c86c5(SurfaceRequest.Result result) {

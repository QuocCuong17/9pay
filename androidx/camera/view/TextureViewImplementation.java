...
public final class TextureViewImplementation extends PreviewViewImplementation {
    ...
    public void onSurfaceRequested(final SurfaceRequest surfaceRequest, PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
        ...
        surfaceRequest.addRequestCancellationListener(ContextCompat.getMainExecutor(this.mTextureView.getContext()), new Runnable() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda4
            ...
            public final void run() {
                TextureViewImplementation.this.m181xce057d29(surfaceRequest);
            }
        });
    ...
    public /* synthetic */ void m181xce057d29(SurfaceRequest surfaceRequest) {
        SurfaceRequest surfaceRequest2 = this.mSurfaceRequest;
    ...
    public void initializePreview() {
        ...
        this.mTextureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() { // from class: androidx.camera.view.TextureViewImplementation.1
            ...
            public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
                Logger.d(TextureViewImplementation.TAG, "SurfaceTexture available. Size: " + i + ViewHierarchyNode.JsonKeys.X + i2);
            ...
            public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
                Logger.d(TextureViewImplementation.TAG, "SurfaceTexture size changed: " + i + ViewHierarchyNode.JsonKeys.X + i2);
            }
    ...
    void tryToProvidePreviewSurface() {
        ...
        final ListenableFuture<SurfaceRequest.Result> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda1
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return TextureViewImplementation.this.m182xdd0bd278(surface, completer);
            }
        });
        ...
        future.addListener(new Runnable() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                TextureViewImplementation.this.m183x16d67457(surface, future, surfaceRequest);
            }
    ...
    public /* synthetic */ Object m182xdd0bd278(Surface surface, final CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m183x16d67457(Surface surface, ListenableFuture listenableFuture, SurfaceRequest surfaceRequest) {
    ...
    public ListenableFuture<Void> waitForNextFrame() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return TextureViewImplementation.this.m184x86b0fc00(completer);
            }
        });
    }

    /* renamed from: lambda$waitForNextFrame$3$androidx-camera-view-TextureViewImplementation, reason: not valid java name */
    public /* synthetic */ Object m184x86b0fc00(CallbackToFutureAdapter.Completer completer) throws Exception {

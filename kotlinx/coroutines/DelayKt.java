...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2762scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m2692delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2693toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2693toDelayMillisLRDsOJo(long j) {
        if (Duration.m2527compareToLRDsOJo(j, Duration.INSTANCE.m2631getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2546getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}

    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            b = r2;
            bArr = bArr2;
            indexedValue = (IndexedValue) ChannelResult.m2721getOrNullimpl(obj2);
            ...
            do {
                ...
                bArr[index] = b;
                indexedValue = (IndexedValue) ChannelResult.m2721getOrNullimpl(channel2.mo2711tryReceivePtdJZtk());
            ...
            if (i != 0) {
                ...
                if (objArr4 == null) {
                    ...
                    combineKt$combineInternal$22.L$0 = objArr5;
                    combineKt$combineInternal$22.L$1 = channel2;
                    combineKt$combineInternal$22.L$2 = bArr;
                    combineKt$combineInternal$22.I$0 = i;
                    combineKt$combineInternal$22.I$1 = b;
        ...
        obj2 = channel.mo2710receiveCatchingJP2dKIU(combineKt$combineInternal$2);
        ...
        combineKt$combineInternal$2.L$2 = bArr;
        combineKt$combineInternal$2.I$0 = length;
        combineKt$combineInternal$2.I$1 = b32;
        combineKt$combineInternal$2.label = 1;
        obj2 = channel.mo2710receiveCatchingJP2dKIU(combineKt$combineInternal$2);
        if (obj2 != coroutine_suspended) {
        }
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (i == 0) {
                    ...
                    int i2 = this.$i;
                    this.label = 1;
                    if (flowArr[i2].collect(new C00621(this.$resultChannel, i2), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
        ...
        public static final class C00621<T> implements FlowCollector {
            ...
            C00621(Channel<IndexedValue<Object>> channel, int i) {
                this.$resultChannel = channel;
                this.$i = i;
            }

...
public final class StartedWhileSubscribed implements SharingStarted {
    ...
    public int hashCode() {
        return (TransactionState$ModuleData$$ExternalSyntheticBackport0.m(this.stopTimeout) * 31) + TransactionState$ModuleData$$ExternalSyntheticBackport0.m(this.replayExpiration);
    }
}

...
public final class SelectUnbiasedKt {
    ...
    private static final <R> Object selectUnbiased$$forInline(Function1<? super SelectBuilder<? super R>, Unit> function1, Continuation<? super R> continuation) {
        ...
        UnbiasedSelectImplementation unbiasedSelectImplementation = new UnbiasedSelectImplementation(continuation2.getContext());
        function1.invoke(unbiasedSelectImplementation);
        InlineMarker.mark(3);
        InlineMarker.mark(0);
        Object doSelect = unbiasedSelectImplementation.doSelect(null);
        InlineMarker.mark(1);
        return doSelect;
    }
}

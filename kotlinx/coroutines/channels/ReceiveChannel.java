...
public interface ReceiveChannel<E> {
    ...
    Object mo2710receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo2711tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo2711tryReceivePtdJZtk = receiveChannel.mo2711tryReceivePtdJZtk();
            if (ChannelResult.m2726isSuccessimpl(mo2711tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2722getOrThrowimpl(mo2711tryReceivePtdJZtk);
            }
            Throwable m2720exceptionOrNullimpl = ChannelResult.m2720exceptionOrNullimpl(mo2711tryReceivePtdJZtk);
            if (m2720exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m2720exceptionOrNullimpl);
        }
            ...
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo2710receiveCatchingJP2dKIU = receiveChannel.mo2710receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                    ...
                    return ChannelResult.m2721getOrNullimpl(mo2710receiveCatchingJP2dKIU);
                }
            }

...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        try {
            ...
            if (this.lastConflatedElement != BroadcastChannelKt.access$getNO_ELEMENT$p()) {
                subscriberConflated.mo2706trySendJP2dKIU(getValue());
            }
    ...
    */
    ...
    public Object mo2706trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo2706trySendJP2dKIU(element);
            }
            List<? extends BufferedChannel<E>> list = this.subscribers;
            boolean z = false;
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo2706trySendJP2dKIU(element);
            }

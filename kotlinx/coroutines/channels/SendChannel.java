...
public interface SendChannel<E> {
    ...
    Object mo2706trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo2706trySendJP2dKIU = sendChannel.mo2706trySendJP2dKIU(e);
            if (ChannelResult.m2726isSuccessimpl(mo2706trySendJP2dKIU)) {
                return true;
            }
            Throwable m2720exceptionOrNullimpl = ChannelResult.m2720exceptionOrNullimpl(mo2706trySendJP2dKIU);

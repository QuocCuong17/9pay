...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m2734trySendImplMj0NB7M = conflatedBufferedChannel.m2734trySendImplMj0NB7M(e, true);
        if (m2734trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2720exceptionOrNullimpl(m2734trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m2734trySendImplMj0NB7M = conflatedBufferedChannel.m2734trySendImplMj0NB7M(e, true);
        if (!(m2734trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2706trySendJP2dKIU(E element) {
        return m2734trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2734trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2732trySendDropLatestMj0NB7M(element, isSendOp) : m2733trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2732trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo2706trySendJP2dKIU = super.mo2706trySendJP2dKIU(element);
        if (ChannelResult.m2726isSuccessimpl(mo2706trySendJP2dKIU) || ChannelResult.m2724isClosedimpl(mo2706trySendJP2dKIU)) {
            return mo2706trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m2731successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m2733trySendDropOldestJP2dKIU(E element) {
    ...
    public void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo2706trySendJP2dKIU = mo2706trySendJP2dKIU(element);
        if (!(mo2706trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo2706trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2720exceptionOrNullimpl(mo2706trySendJP2dKIU);

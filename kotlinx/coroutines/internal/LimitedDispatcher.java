...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo2762scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo2762scheduleResumeAfterDelay(timeMillis, continuation);
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (i >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo2761dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
    ...
    public void mo2761dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo2761dispatch(this, new Worker(obtainTaskOrDeallocateWorker));
    }

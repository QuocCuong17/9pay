...
public class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(Waiter waiter) {
        ...
        SemaphoreSegment semaphoreSegment2 = (SemaphoreSegment) SegmentOrClosed.m2767getSegmentimpl(findSegmentInternal);
        i2 = SemaphoreKt.SEGMENT_SIZE;
        int i3 = (int) (andIncrement % i2);
        if (!semaphoreSegment2.getAcquirers().compareAndSet(i3, null, waiter)) {
            symbol = SemaphoreKt.PERMIT;
            symbol2 = SemaphoreKt.TAKEN;
            if (semaphoreSegment2.getAcquirers().compareAndSet(i3, symbol, symbol2)) {
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        if (andSet == null) {
            ...
            return !semaphoreSegment2.getAcquirers().compareAndSet(i4, symbol3, symbol4);
        }

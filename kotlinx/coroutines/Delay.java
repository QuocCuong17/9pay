...
public interface Delay {
    ...
    void mo2762scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation);
    ...
    public static final class DefaultImpls {
        ...
        public static Object delay(Delay delay, long j, Continuation<? super Unit> continuation) {
            ...
            delay.mo2762scheduleResumeAfterDelay(j, cancellableContinuationImpl);

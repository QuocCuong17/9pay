...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final void readJournal() throws IOException {
        ...
        try {
            ...
            if (Intrinsics.areEqual(MAGIC, readUtf8LineStrict) && Intrinsics.areEqual(VERSION_1, readUtf8LineStrict2) && Intrinsics.areEqual(String.valueOf(this.appVersion), readUtf8LineStrict3) && Intrinsics.areEqual(String.valueOf(getValueCount()), readUtf8LineStrict4)) {
                int i = 0;
    ...
    public final synchronized void rebuildJournal$okhttp() throws IOException {
        ...
        try {
            ...
            bufferedSink2.writeDecimalLong(getValueCount()).writeByte(10);
    ...
    public final synchronized void completeEdit$okhttp(Editor editor, boolean success) throws IOException {
        ...
        while (i < i5) {
            int i6 = i + 1;
            File file = entry.getDirtyFiles$okhttp().get(i);
            if (success && !entry.getZombie()) {
                if (this.fileSystem.exists(file)) {
                    File file2 = entry.getCleanFiles$okhttp().get(i);
    ...
    public final synchronized void initialize() throws IOException {
        ...
        if (this.fileSystem.exists(this.journalFile)) {
            try {
                ...
                Platform.INSTANCE.get().log("DiskLruCache " + this.directory + " is corrupt: " + ((Object) e.getMessage()) + ", removing", 5, e);
                try {
                    delete();
                    this.closed = false;
                } catch (Throwable th) {

...
public final /* data */ class WebSocketExtensions {
    ...
    public static final class Companion {
        ...
        public final WebSocketExtensions parse(Headers responseHeaders) throws IOException {
                        ...
                        if (StringsKt.equals(trimSubstring, "permessage-deflate", true)) {
                            ...
                            while (i3 < delimiterOffset$default) {
                                ...
                                if (delimiterOffset3 < delimiterOffset2) {
                                    str = StringsKt.removeSurrounding(Util.trimSubstring(value, delimiterOffset3 + 1, delimiterOffset2), (CharSequence) "\"");
                                    num = null;
                                } else {
                                    num = null;
                                    str = null;
                                ...
                                if (StringsKt.equals(trimSubstring2, "client_max_window_bits", true)) {
                                    ...
                                    num2 = str == null ? num : StringsKt.toIntOrNull(str);
                                    if (num2 == null) {
                                        z4 = true;
                                    }
                                    ...
                                    num3 = str == null ? num : StringsKt.toIntOrNull(str);
                                    if (num3 == null) {
                                        z4 = true;
                                    }
            ...
            return new WebSocketExtensions(z, num2, z2, num3, z3, z4);
        }
    }
}

...
public final class HttpHeaders {
    ...
    */
            ...
            while (true) {
                ...
                if (skipCommasAndWhitespace || (!skipCommasAndWhitespace2 && !buffer.exhausted())) {
                    ...
                    while (true) {
                        ...
                        String readQuotedString = startsWith(buffer, ISO7816.INS_MSE) ? readQuotedString(buffer) : readToken(buffer);
    ...
    public static final boolean promisesBody(Response response) {
        ...
        return (((code >= 100 && code < 200) || code == 204 || code == 304) && Util.headersContentLength(response) == -1 && !StringsKt.equals("chunked", Response.header$default(response, com.google.common.net.HttpHeaders.TRANSFER_ENCODING, null, 2, null), true)) ? false : true;
    }

...
public final class Response implements Closeable {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = URLProtectionSpaceContract.FeedEntry.COLUMN_NAME_PROTOCOL, imports = {}))
    ...
    public final CacheControl m2893deprecated_cacheControl() {
        return cacheControl();
    }

    ...
    public static final class Pin {
        ...
        public final boolean matchesHostname(String hostname) {
            ...
            if (StringsKt.startsWith$default(this.pattern, "**.", false, 2, (Object) null)) {
                ...
                if (!StringsKt.regionMatches$default(hostname, hostname.length() - length3, this.pattern, 1, length3, false, 16, (Object) null) || StringsKt.lastIndexOf$default((CharSequence) hostname, FilenameUtils.EXTENSION_SEPARATOR, length4 - 1, false, 4, (Object) null) != -1) {
                    return false;
                }
            } else {

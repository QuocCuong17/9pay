...
public class GLTextureView extends TextureView implements TextureView.SurfaceTextureListener, View.OnLayoutChangeListener {
    ...
    public void setPreserveEGLContextOnDestroy(boolean z) {
        this.preserveEGLContextOnDestroy = z;
    }
    ...
    private static class DefaultWindowSurfaceFactory implements EGLWindowSurfaceFactory {
        ...
        public EGLSurface createWindowSurface(EGL10 egl10, EGLDisplay eGLDisplay, EGLConfig eGLConfig, Object obj) {
            try {
                ...
                HVLog.e(GLTextureView.TAG, "eglCreateWindowSurface", e);
                return null;
            }
        }
    ...
    public static class EglHelper {
        ...
        public static void logEglErrorAsWarning(String str, String str2, int i) {
            HVLog.w(str, formatEglError(str2, i));
        }
                ...
                while (true) {
                    try {
                        synchronized (GLTextureView.glThreadManager) {
                            while (!this.shouldExit) {
                                if (!this.eventQueue.isEmpty()) {
                                    ...
                                    if (z12 && this.haveEglContext) {
                                        GLTextureView gLTextureView = this.glTextureViewWeakRef.get();
                                        if (!(gLTextureView != null && gLTextureView.preserveEGLContextOnDestroy) || GLTextureView.glThreadManager.shouldReleaseEGLContextWhenPausing()) {
                                            stopEglContextLocked();
                                        }
                                    }
                                    if (z12 && GLTextureView.glThreadManager.shouldTerminateEGLWhenPausing()) {
                                        this.eglHelper.finish();
                                    }
                        ...
                        if (z8) {
                            ...
                            GLTextureView.glThreadManager.checkGLDriver(gl10);
                            z8 = z;
                        }
                        if (z6) {

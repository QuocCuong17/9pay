...
@DebugMetadata(c = "co.hyperverge.hyperkyc.data.network.NetworkRepo$prefetchCountries$2", f = "NetworkRepo.kt", i = {0}, l = {199}, m = "invokeSuspend", n = {"$this$onIO"}, s = {"L$0"})
/* loaded from: classes2.dex */
public final class NetworkRepo$prefetchCountries$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends KycCountry>>, Object> {
    ...
    public NetworkRepo$prefetchCountries$2(File file, Continuation<? super NetworkRepo$prefetchCountries$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        NetworkRepo$prefetchCountries$2 networkRepo$prefetchCountries$2 = new NetworkRepo$prefetchCountries$2(this.$cacheDir, continuation);
        networkRepo$prefetchCountries$2.L$0 = obj;
        return networkRepo$prefetchCountries$2;
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super List<KycCountry>> continuation) {
        return ((NetworkRepo$prefetchCountries$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        String str5;
        NetworkRepo$prefetchCountries$2 networkRepo$prefetchCountries$2;
        Object obj2;
        ?? r2;
        String str6;
        Class<?> cls;
        ...
        if (i3 == 0) {
            ...
            sb.append(str4);
            sb.append(" - ");
            String str15 = "prefetchCountries() called with: cacheDir = " + file;
            if (str15 == null) {
                str15 = "null ";
            }
            sb.append(str15);
            ...
            if (CoreExtsKt.isRelease()) {
                networkRepo$prefetchCountries$2 = this;
                str5 = str2;
            } else {
                try {
                ...
                if (CoreExtsKt.isDebug()) {
                    ...
                    if (StringsKt.contains$default((CharSequence) str16, charSequence, false, 2, (Object) null)) {
                        ...
                        if (((String) objectRef2.element).length() > 23 && Build.VERSION.SDK_INT < 26) {
                            ...
                            String str18 = "prefetchCountries() called with: cacheDir = " + file;
                        ...
                        String str182 = "prefetchCountries() called with: cacheDir = " + file;
            ...
            File file2 = networkRepo$prefetchCountries$2.$cacheDir;
            try {
                Result.Companion companion4 = Result.INSTANCE;
                NetworkRepo networkRepo = NetworkRepo.INSTANCE;
                Integer boxInt = Boxing.boxInt(3600);
                networkRepo$prefetchCountries$2.L$0 = coroutineScope;
                networkRepo$prefetchCountries$2.label = 1;
                str7 = "replaceAll(\"\")";
                str8 = "";
                str9 = "this as java.lang.String…ing(startIndex, endIndex)";
                str10 = str;
                try {
                    callCountriesFetchAPI$default = NetworkRepo.callCountriesFetchAPI$default(networkRepo, file2, boxInt, null, this, 4, null);
                    if (callCountriesFetchAPI$default == coroutine_suspended) {
        ...
        try {
            m1202constructorimpl2 = Result.m1202constructorimpl((List) callCountriesFetchAPI$default);
        } catch (Throwable th5) {
            th = th5;
        ...
        if (Result.m1205exceptionOrNullimpl(obj3) == null) {
            ...
            if (((String) objectRef3.element).length() > 23) {
                ...
                if (Build.VERSION.SDK_INT >= 26) {
                    ...
                    sb3.append(str13);
                    sb3.append(" - ");
                    sb3.append("prefetchCountries() failed");
                    sb3.append(' ');
                    sb3.append(str8);
                            ...
                            if (StringsKt.contains$default(str19, charSequence, (boolean) i2, 2, (Object) null)) {
                                ...
                                if (stackTraceElement4 == null || (className3 = stackTraceElement4.getClassName()) == null) {
                                    ...
                                    if (substringAfterLast$default3 != null) {
                                        ...
                                        Log.println(3, str14, "prefetchCountries() failed " + str8);

...
@DebugMetadata(c = "co.hyperverge.hyperkyc.data.network.NetworkRepo$fetchWorkflowConfig$2", f = "NetworkRepo.kt", i = {0, 1}, l = {375, 375}, m = "invokeSuspend", n = {"$this$onIO", "$this$onIO"}, s = {"L$0", "L$0"})
/* loaded from: classes2.dex */
public final class NetworkRepo$fetchWorkflowConfig$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super WorkflowConfig>, Object> {
    final /* synthetic */ String $appId;
    final /* synthetic */ File $cacheDir;
    final /* synthetic */ String $workflowConfigJson;
    ...
    public NetworkRepo$fetchWorkflowConfig$2(String str, String str2, File file, String str3, Continuation<? super NetworkRepo$fetchWorkflowConfig$2> continuation) {
        super(2, continuation);
        this.$appId = str;
        this.$workflowId = str2;
        this.$cacheDir = file;
        this.$workflowConfigJson = str3;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        NetworkRepo$fetchWorkflowConfig$2 networkRepo$fetchWorkflowConfig$2 = new NetworkRepo$fetchWorkflowConfig$2(this.$appId, this.$workflowId, this.$cacheDir, this.$workflowConfigJson, continuation);
        networkRepo$fetchWorkflowConfig$2.L$0 = obj;
        return networkRepo$fetchWorkflowConfig$2;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super WorkflowConfig> continuation) {
        return ((NetworkRepo$fetchWorkflowConfig$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        Class<?> cls;
        Deferred deferred;
        NetworkRepo$fetchWorkflowConfig$2 networkRepo$fetchWorkflowConfig$2;
        Object obj2;
        Object await;
        Class<?> cls2;
        String canonicalName;
        Object obj3;
        Object callWorkflowConfigFetchAPI;
        ...
        if (i == 0) {
            ...
            String str28 = this.$workflowConfigJson;
            try {
            ...
            if (coroutineScope != null) {
                ...
                if (cls2 != null) {
                    ...
                    if (((String) objectRef.element).length() > 23 && Build.VERSION.SDK_INT < 26) {
                        ...
                        sb3.append("fetchWorkflowConfig() called with: appId = ");
                        sb3.append(str);
                        sb3.append(", workflowId = ");
                        sb3.append(str2);
                        sb3.append(", cacheDir = ");
                        sb3.append(file);
                        sb3.append(", workflowConfigJson = ");
                        str15 = str12;
                        sb3.append(str15);
                        sb2 = sb3.toString();
                        if (sb2 == null) {
                            ...
                            if (CoreExtsKt.isDebug()) {
                                ...
                                try {
                                    ...
                                    try {
                                        if (StringsKt.contains$default((CharSequence) packageName2, charSequence, false, 2, (Object) null)) {
                                            ...
                                            try {
                                                ...
                                                if (((String) objectRef2.element).length() > 23 && Build.VERSION.SDK_INT < 26) {
                                                    ...
                                                    str18 = "fetchWorkflowConfig() called with: appId = " + str + ", workflowId = " + str2 + ", cacheDir = " + file + ", workflowConfigJson = " + str15;
                                                    if (str18 == null) {
                                                        str18 = "null ";
                                                    }
                                                    sb4.append(str18);
                                        ...
                                        deferred = NetworkRepo.prefetchWorkflowConfigDeferred;
                                ...
                                if (deferred == null) {
                                    networkRepo$fetchWorkflowConfig$2 = this;
                                    ...
                                    networkRepo$fetchWorkflowConfig$2.L$0 = coroutineScope4;
                                    networkRepo$fetchWorkflowConfig$2.L$1 = null;
                                    networkRepo$fetchWorkflowConfig$2.L$2 = null;
                                    networkRepo$fetchWorkflowConfig$2.L$3 = null;
                                    networkRepo$fetchWorkflowConfig$2.L$4 = null;
                                    networkRepo$fetchWorkflowConfig$2.label = 2;
                                    obj3 = obj2;
                                    str3 = str11;
                                    str10 = null;
                                    str4 = "replaceAll(\"\")";
                                    ...
                                    str6 = "this as java.lang.String…ing(startIndex, endIndex)";
                                    str7 = str16;
                                    callWorkflowConfigFetchAPI = networkRepo.callWorkflowConfigFetchAPI(str31, str30, file2, (r16 & 8) != 0 ? null : null, (r16 & 16) != 0 ? null : str32, this);
                                    if (callWorkflowConfigFetchAPI != obj3) {
                                        return obj3;
                                    }
                                    coroutineScope2 = coroutineScope4;
                                    workflowConfig = (WorkflowConfig) callWorkflowConfigFetchAPI;
                                    m1202constructorimpl2 = Result.m1202constructorimpl(workflowConfig);
                                ...
                                networkRepo$fetchWorkflowConfig$2 = this;
                                networkRepo$fetchWorkflowConfig$2.L$0 = coroutineScope;
                                networkRepo$fetchWorkflowConfig$2.L$1 = str;
                                networkRepo$fetchWorkflowConfig$2.L$2 = str2;
                                networkRepo$fetchWorkflowConfig$2.L$3 = file;
                                networkRepo$fetchWorkflowConfig$2.L$4 = str15;
                                networkRepo$fetchWorkflowConfig$2.label = 1;
                                await = deferred.await(networkRepo$fetchWorkflowConfig$2);
                                obj2 = coroutine_suspended;
                                if (await == obj2) {
                                    return obj2;
                                }
                    ...
                    sb32.append("fetchWorkflowConfig() called with: appId = ");
                    sb32.append(str);
                    sb32.append(", workflowId = ");
                    sb32.append(str2);
                    sb32.append(", cacheDir = ");
                    sb32.append(file);
                    sb32.append(", workflowConfigJson = ");
                    str15 = str12;
                    sb32.append(str15);
                    sb2 = sb32.toString();
                    if (sb2 == null) {
            ...
            if (((String) objectRef.element).length() > 23) {
                ...
                sb322.append("fetchWorkflowConfig() called with: appId = ");
                sb322.append(str);
                sb322.append(", workflowId = ");
                sb322.append(str2);
                sb322.append(", cacheDir = ");
                sb322.append(file);
                sb322.append(", workflowConfigJson = ");
                str15 = str12;
                sb322.append(str15);
                sb2 = sb322.toString();
                if (sb2 == null) {
            ...
            sb3222.append("fetchWorkflowConfig() called with: appId = ");
            sb3222.append(str);
            sb3222.append(", workflowId = ");
            sb3222.append(str2);
            sb3222.append(", cacheDir = ");
            sb3222.append(file);
            sb3222.append(", workflowConfigJson = ");
            str15 = str12;
            sb3222.append(str15);
            sb2 = sb3222.toString();
            if (sb2 == null) {
            ...
            if (i != 1) {
                ...
                try {
                    ResultKt.throwOnFailure(obj);
                    callWorkflowConfigFetchAPI = obj;
                    str3 = "Throwable().stackTrace";
                    str4 = "replaceAll(\"\")";
                    str5 = "";
                    str6 = "this as java.lang.String…ing(startIndex, endIndex)";
                ...
                if (m1205exceptionOrNullimpl != null) {
                    FormWebViewDriver.INSTANCE.getJsonConfigStore$hyperkyc_release().setWorkflowConfig$hyperkyc_release(str10);
                    ...
                    sb5.append(str22);
                    sb5.append(str7);
                    sb5.append("fetchWorkflowConfig() failed");
                    sb5.append(' ');
                        ...
                        if (StringsKt.contains$default((CharSequence) str33, charSequence, false, 2, (Object) null)) {
                            ...
                            if (stackTraceElement4 == null || (className = stackTraceElement4.getClassName()) == null) {
                                ...
                                if (substringAfterLast$default2 != null) {
                                    ...
                                    sb6.append("fetchWorkflowConfig() failed");
                                    sb6.append(' ');
                            ...
                            sb62.append("fetchWorkflowConfig() failed");
                            sb62.append(' ');
                            if (m1205exceptionOrNullimpl == null) {
                            }
                            if (localizedMessage == null) {
        ...
        workflowConfig = (WorkflowConfig) await;
        ...
        networkRepo$fetchWorkflowConfig$2.L$0 = coroutineScope42;
        networkRepo$fetchWorkflowConfig$2.L$1 = null;
        networkRepo$fetchWorkflowConfig$2.L$2 = null;
        networkRepo$fetchWorkflowConfig$2.L$3 = null;
        networkRepo$fetchWorkflowConfig$2.L$4 = null;
        ...
        str6 = "this as java.lang.String…ing(startIndex, endIndex)";
        str7 = str16;
        callWorkflowConfigFetchAPI = networkRepo2.callWorkflowConfigFetchAPI(str312, str302, file22, (r16 & 8) != 0 ? null : null, (r16 & 16) != 0 ? null : str322, this);
        if (callWorkflowConfigFetchAPI != obj3) {
        }
    }
}

...
@DebugMetadata(c = "co.hyperverge.hyperkyc.data.network.NetworkRepo$fetchCountries$2", f = "NetworkRepo.kt", i = {0, 1}, l = {CipherSuite.TLS_RSA_PSK_WITH_NULL_SHA256, CipherSuite.TLS_RSA_PSK_WITH_NULL_SHA256}, m = "invokeSuspend", n = {"$this$onIO", "$this$onIO"}, s = {"L$0", "L$0"})
/* loaded from: classes2.dex */
public final class NetworkRepo$fetchCountries$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends KycCountry>>, Object> {
    final /* synthetic */ File $cacheDir;
    final /* synthetic */ String $countriesJson;
    ...
    public NetworkRepo$fetchCountries$2(File file, String str, Continuation<? super NetworkRepo$fetchCountries$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        NetworkRepo$fetchCountries$2 networkRepo$fetchCountries$2 = new NetworkRepo$fetchCountries$2(this.$cacheDir, this.$countriesJson, continuation);
        networkRepo$fetchCountries$2.L$0 = obj;
        return networkRepo$fetchCountries$2;
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super List<KycCountry>> continuation) {
        return ((NetworkRepo$fetchCountries$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        String str17;
        Deferred deferred;
        NetworkRepo$fetchCountries$2 networkRepo$fetchCountries$2;
        Object obj2;
        Object await;
        Class<?> cls2;
        Object obj3;
        Object callCountriesFetchAPI$default;
        List list;
        ...
        if (i == 0) {
                ...
                if (className != null) {
                    ...
                    if (substringAfterLast$default != null) {
                        ...
                        if (((String) objectRef.element).length() > 23 && Build.VERSION.SDK_INT < 26) {
                            ...
                            sb.append(str13);
                            sb.append(" - ");
                            str14 = "fetchCountries() called with cacheDir = " + file + ", countriesJson = " + str;
                            if (str14 == null) {
                                str14 = "null ";
                            }
                            sb.append(str14);
                                            ...
                                            if (className4 != null) {
                                                ...
                                                if (substringAfterLast$default2 != null) {
                                                    ...
                                                    if (((String) objectRef2.element).length() <= 23 && Build.VERSION.SDK_INT < 26) {
                                                        ...
                                                        str17 = "fetchCountries() called with cacheDir = " + file + ", countriesJson = " + str;
                                                        if (str17 == null) {
                                                            str17 = "null ";
                                                        }
                                                        sb2.append(str17);
                                                        ...
                                                        deferred = NetworkRepo.prefetchCountriesDeferred;
                                                        if (deferred == null) {
                                                            networkRepo$fetchCountries$2 = this;
                                                            obj2 = coroutine_suspended;
                                                            String str28 = str;
                                                            CoroutineScope coroutineScope4 = coroutineScope;
                                                            File file2 = file;
                                                            NetworkRepo networkRepo = NetworkRepo.INSTANCE;
                                                            networkRepo$fetchCountries$2.L$0 = coroutineScope4;
                                                            networkRepo$fetchCountries$2.L$1 = null;
                                                            networkRepo$fetchCountries$2.L$2 = null;
                                                            networkRepo$fetchCountries$2.label = 2;
                                                            obj3 = obj2;
                                                            str8 = "";
                                                            str9 = "replaceAll(\"\")";
                                                            str2 = str10;
                                                            ...
                                                            str3 = "this as java.lang.String…ing(startIndex, endIndex)";
                                                            callCountriesFetchAPI$default = NetworkRepo.callCountriesFetchAPI$default(networkRepo, file2, null, str28, this, 2, null);
                                                            if (callCountriesFetchAPI$default != obj3) {
                                                                return obj3;
                                                            }
                                                            coroutineScope2 = coroutineScope5;
                                                            list = (List) callCountriesFetchAPI$default;
                                                            m1202constructorimpl2 = Result.m1202constructorimpl(list);
                                                        ...
                                                        networkRepo$fetchCountries$2 = this;
                                                        networkRepo$fetchCountries$2.L$0 = coroutineScope;
                                                        networkRepo$fetchCountries$2.L$1 = file;
                                                        networkRepo$fetchCountries$2.L$2 = str;
                                                        networkRepo$fetchCountries$2.label = 1;
                                                        await = deferred.await(networkRepo$fetchCountries$2);
                                                        obj2 = coroutine_suspended;
                                                        if (await == obj2) {
                                                            return obj2;
                                                        }
            ...
            if (i != 1) {
                ...
                try {
                    ResultKt.throwOnFailure(obj);
                    callCountriesFetchAPI$default = obj;
                    str2 = "Throwable().stackTrace";
                    str3 = "this as java.lang.String…ing(startIndex, endIndex)";
                    str4 = "null cannot be cast to non-null type android.app.Application";
                    charSequence = "co.hyperverge";
                ...
                if (m1205exceptionOrNullimpl != null) {
                    ...
                    if (((String) objectRef3.element).length() > 23 && Build.VERSION.SDK_INT < 26) {
                        ...
                        sb3.append(str21);
                        sb3.append(" - ");
                        sb3.append("fetchCountries() failed");
                        sb3.append(' ');
        ...
        networkRepo$fetchCountries$2.L$0 = coroutineScope42;
        networkRepo$fetchCountries$2.L$1 = null;
        networkRepo$fetchCountries$2.L$2 = null;
        networkRepo$fetchCountries$2.label = 2;
        obj3 = obj2;
        ...
        str3 = "this as java.lang.String…ing(startIndex, endIndex)";
        callCountriesFetchAPI$default = NetworkRepo.callCountriesFetchAPI$default(networkRepo2, file22, null, str282, this, 2, null);
        if (callCountriesFetchAPI$default != obj3) {
        }
    }
}

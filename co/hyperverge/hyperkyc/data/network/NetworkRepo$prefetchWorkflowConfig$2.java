...
@DebugMetadata(c = "co.hyperverge.hyperkyc.data.network.NetworkRepo$prefetchWorkflowConfig$2", f = "NetworkRepo.kt", i = {0}, l = {395}, m = "invokeSuspend", n = {"$this$onIO"}, s = {"L$0"})
/* loaded from: classes2.dex */
public final class NetworkRepo$prefetchWorkflowConfig$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super WorkflowConfig>, Object> {
    ...
    public NetworkRepo$prefetchWorkflowConfig$2(String str, String str2, File file, Continuation<? super NetworkRepo$prefetchWorkflowConfig$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        NetworkRepo$prefetchWorkflowConfig$2 networkRepo$prefetchWorkflowConfig$2 = new NetworkRepo$prefetchWorkflowConfig$2(this.$appId, this.$workflowId, this.$cacheDir, continuation);
        networkRepo$prefetchWorkflowConfig$2.L$0 = obj;
        return networkRepo$prefetchWorkflowConfig$2;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super WorkflowConfig> continuation) {
        return ((NetworkRepo$prefetchWorkflowConfig$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        NetworkRepo$prefetchWorkflowConfig$2 networkRepo$prefetchWorkflowConfig$2;
        ?? r4;
        String str7;
        String str8;
        Class<?> cls;
        ...
        if (i2 == 0) {
            ...
            sb.append(str5);
            sb.append(" - ");
            String str21 = "prefetchWorkflowConfig() called with: appId = " + str19 + ", workflowId = " + str20 + ", cacheDir = " + file2;
            if (str21 == null) {
                str21 = "null ";
            }
            sb.append(str21);
            ...
            if (CoreExtsKt.isRelease()) {
                networkRepo$prefetchWorkflowConfig$2 = this;
            } else {
                try {
                    ...
                    try {
                        ...
                        networkRepo$prefetchWorkflowConfig$2 = this;
                        str9 = networkRepo$prefetchWorkflowConfig$2.$appId;
                        str10 = networkRepo$prefetchWorkflowConfig$2.$workflowId;
                        file = networkRepo$prefetchWorkflowConfig$2.$cacheDir;
                        Result.Companion companion4 = Result.INSTANCE;
                        NetworkRepo networkRepo = NetworkRepo.INSTANCE;
                        Integer boxInt = Boxing.boxInt(3600);
                        networkRepo$prefetchWorkflowConfig$2.L$0 = coroutineScope;
                        networkRepo$prefetchWorkflowConfig$2.label = 1;
                        str14 = str;
                        ...
                        str13 = "";
                        try {
                            callWorkflowConfigFetchAPI = networkRepo.callWorkflowConfigFetchAPI(str9, str10, file, (r16 & 8) != 0 ? null : boxInt, (r16 & 16) != 0 ? null : null, this);
                            if (callWorkflowConfigFetchAPI != coroutine_suspended) {
                            }
                        } catch (Throwable th2) {
                            th = th2;
                            coroutineScope = coroutineScope;
                ...
                if (CoreExtsKt.isDebug()) {
                    ...
                    if (StringsKt.contains$default((CharSequence) packageName2, (CharSequence) "co.hyperverge", false, 2, (Object) null)) {
                        ...
                        if (((String) objectRef2.element).length() > 23 && Build.VERSION.SDK_INT < 26) {
                            ...
                            str8 = "prefetchWorkflowConfig() called with: appId = " + str19 + ", workflowId = " + str20 + ", cacheDir = " + file2;
                            if (str8 == null) {
                                str8 = "null ";
                            }
                            sb2.append(str8);
            ...
            try {
                ...
                str12 = "this as java.lang.String…ing(startIndex, endIndex)";
                str13 = "";
                callWorkflowConfigFetchAPI = networkRepo2.callWorkflowConfigFetchAPI(str9, str10, file, (r16 & 8) != 0 ? null : boxInt2, (r16 & 16) != 0 ? null : null, this);
                if (callWorkflowConfigFetchAPI != coroutine_suspended) {
        ...
        try {
            m1202constructorimpl2 = Result.m1202constructorimpl((WorkflowConfig) callWorkflowConfigFetchAPI);
        } catch (Throwable th6) {
            th = th6;
        ...
        if (Result.m1205exceptionOrNullimpl(obj2) != null) {
            ...
            if (((String) objectRef3.element).length() > 23) {
                ...
                if (Build.VERSION.SDK_INT >= 26) {
                    ...
                    sb3.append(str17);
                    sb3.append(" - ");
                    sb3.append("prefetchWorkflowConfig() failed");
                    sb3.append(' ');
                    sb3.append(str13);
                            ...
                            if (StringsKt.contains$default((CharSequence) packageName3, (CharSequence) "co.hyperverge", false, 2, (Object) null)) {
                                ...
                                if (stackTraceElement4 == null || (className3 = stackTraceElement4.getClassName()) == null) {
                                    ...
                                    if (substringAfterLast$default2 != null) {
                                        ...
                                        Log.println(3, str18, "prefetchWorkflowConfig() failed " + str13);

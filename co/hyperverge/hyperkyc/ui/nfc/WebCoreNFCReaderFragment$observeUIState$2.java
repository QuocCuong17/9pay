...
@DebugMetadata(c = "co.hyperverge.hyperkyc.ui.nfc.WebCoreNFCReaderFragment$observeUIState$2", f = "WebCoreNFCReaderFragment.kt", i = {}, l = {649}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
public final class WebCoreNFCReaderFragment$observeUIState$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ WebCoreNFCReaderFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WebCoreNFCReaderFragment$observeUIState$2(WebCoreNFCReaderFragment webCoreNFCReaderFragment, Continuation<? super WebCoreNFCReaderFragment$observeUIState$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WebCoreNFCReaderFragment$observeUIState$2(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((WebCoreNFCReaderFragment$observeUIState$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    /* compiled from: WebCoreNFCReaderFragment.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "co.hyperverge.hyperkyc.ui.nfc.WebCoreNFCReaderFragment$observeUIState$2$1", f = "WebCoreNFCReaderFragment.kt", i = {}, l = {651}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: co.hyperverge.hyperkyc.ui.nfc.WebCoreNFCReaderFragment$observeUIState$2$1, reason: invalid class name */
    /* loaded from: classes2.dex */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(WebCoreNFCReaderFragment webCoreNFCReaderFragment, Continuation<? super AnonymousClass1> continuation) {
            super(2, continuation);
            this.this$0 = webCoreNFCReaderFragment;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                final WebCoreNFCReaderFragment webCoreNFCReaderFragment = this.this$0;
                this.label = 1;
                if (filterNotNull.collect(new FlowCollector() { // from class: co.hyperverge.hyperkyc.ui.nfc.WebCoreNFCReaderFragment.observeUIState.2.1.1
                    ...
                    */
                    public final Object emit(NFCUIFlowModel nFCUIFlowModel, Continuation<? super Unit> continuation) {
                        ...
                        str = null;
                        list = webCoreNFCReaderFragment.uiStatesView;
                        for (NFCUIStateView nFCUIStateView : list) {
                            ...
                            if (Intrinsics.areEqual(tag, uiState != null ? uiState.getNfcStepId() : str)) {
                                ...
                                if (Intrinsics.areEqual(uiState2, NFCUIFlowModel.NFCUIState.TurnOnNFC.INSTANCE)) {
                                    nfcManager = webCoreNFCReaderFragment.nfcMgr;
                                    ...
                                    if (nfcManager2.getDefaultAdapter() != null) {
                                        hVNFCAdapter = webCoreNFCReaderFragment.nfcAdapter;
                                        ...
                                        if (hVNFCAdapter2.isEnabled()) {
                                            ...
                                            nFCReaderVM4 = webCoreNFCReaderFragment.nfcVM;
                                            ...
                                            timer = webCoreNFCReaderFragment.timer;
                                            if (timer == null) {
                                                webCoreNFCReaderFragment.startSkipButtonTimer();
                                            }
                                        } else {
                                            nFCUIStateView.setUIModel(nFCUIFlowModel);
                                        }
                                        ...
                                        nFCUIStateView.setUIModel(nFCUIFlowModel);
                                        webCoreNFCReaderFragment.errorCode = 120;
                                        WebCoreNFCReaderFragment webCoreNFCReaderFragment2 = webCoreNFCReaderFragment;
                                        webCoreNFCReaderFragment2.errorMessage = webCoreNFCReaderFragment2.getString(R.string.hk_error_unavailable);
                                        webCoreNFCReaderFragment.processErrorState();
                                    }
                                    ...
                                    if (nFCUIFlowModel.getStatus() == NFCUIFlowModel.NFCUIStatus.Success) {
                                        nFCReaderVM2 = webCoreNFCReaderFragment.nfcVM;

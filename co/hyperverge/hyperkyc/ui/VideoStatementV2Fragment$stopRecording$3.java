...
@DebugMetadata(c = "co.hyperverge.hyperkyc.ui.VideoStatementV2Fragment$stopRecording$3", f = "VideoStatementV2Fragment.kt", i = {0}, l = {667}, m = "invokeSuspend", n = {"$this$launch"}, s = {"L$0"})
/* loaded from: classes2.dex */
public final class VideoStatementV2Fragment$stopRecording$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public VideoStatementV2Fragment$stopRecording$3(VideoStatementV2Fragment videoStatementV2Fragment, Continuation<? super VideoStatementV2Fragment$stopRecording$3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        VideoStatementV2Fragment$stopRecording$3 videoStatementV2Fragment$stopRecording$3 = new VideoStatementV2Fragment$stopRecording$3(this.this$0, continuation);
        videoStatementV2Fragment$stopRecording$3.L$0 = obj;
        return videoStatementV2Fragment$stopRecording$3;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((VideoStatementV2Fragment$stopRecording$3) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (m1205exceptionOrNullimpl != null) {
            ...
            sb.append(str);
            sb.append(" - ");
            String str4 = "stopRecording(): " + m1205exceptionOrNullimpl.getLocalizedMessage();
            if (str4 == null) {
                str4 = "null ";
            }
            sb.append(str4);
                    ...
                    if (StringsKt.contains$default((CharSequence) packageName, (CharSequence) "co.hyperverge", false, 2, (Object) null)) {
                        ...
                        if (stackTraceElement2 == null || (className = stackTraceElement2.getClassName()) == null) {
                            ...
                            if (substringAfterLast$default != null) {
                                ...
                                String str5 = "stopRecording(): " + m1205exceptionOrNullimpl.getLocalizedMessage();
                        ...
                        String str52 = "stopRecording(): " + m1205exceptionOrNullimpl.getLocalizedMessage();

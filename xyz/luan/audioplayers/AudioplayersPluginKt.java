...
@Metadata(d1 = {"\u00002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\u001a\f\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u0002\u001a.\u0010\u0003\u001a\u0004\u0018\u0001H\u0004\"\u0010\b\u0000\u0010\u0004\u0018\u0001*\b\u0012\u0004\u0012\u0002H\u00040\u0005*\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0007H\u0082\b¢\u0006\u0002\u0010\b\u001a\n\u0010\t\u001a\u00020\u0007*\u00020\u0007*j\u0010\n\"2\u0012\u0013\u0012\u00110\u0002¢\u0006\f\b\f\u0012\b\b\u0006\u0012\u0004\b\b(\r\u0012\u0013\u0012\u00110\u000e¢\u0006\f\b\f\u0012\b\b\u0006\u0012\u0004\b\b(\u000f\u0012\u0004\u0012\u00020\u00100\u000b22\u0012\u0013\u0012\u00110\u0002¢\u0006\f\b\f\u0012\b\b\u0006\u0012\u0004\b\b(\r\u0012\u0013\u0012\u00110\u000e¢\u0006\f\b\f\u0012\b\b\u0006\u0012\u0004\b\b(\u000f\u0012\u0004\u0012\u00020\u00100\u000b¨\u0006\u0011"}, d2 = {"audioContext", "Lxyz/luan/audioplayers/AudioContextAndroid;", "Lio/flutter/plugin/common/MethodCall;", "enumArgument", "T", "", "name", "", "(Lio/flutter/plugin/common/MethodCall;Ljava/lang/String;)Ljava/lang/Enum;", "toConstantCase", "FlutterHandler", "Lkotlin/Function2;", "Lkotlin/ParameterName;", NotificationCompat.CATEGORY_CALL, "Lio/flutter/plugin/common/MethodChannel$Result;", "response", "", "audioplayers_android_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class AudioplayersPluginKt {
    private static final /* synthetic */ <T extends Enum<T>> T enumArgument(MethodCall methodCall, String str) {
        ...
        String constantCase = toConstantCase((String) CollectionsKt.last(StringsKt.split$default((CharSequence) str2, new char[]{FilenameUtils.EXTENSION_SEPARATOR}, false, 0, 6, (Object) null)));
        Intrinsics.reifiedOperationMarker(5, "T");
        return (T) Enum.valueOf(null, constantCase);
    }

    public static final String toConstantCase(String str) {
    ...
    public static final AudioContextAndroid audioContext(MethodCall methodCall) {
        ...
        if (num4 != null) {
            return new AudioContextAndroid(booleanValue, booleanValue2, intValue, intValue2, intValue3, num4.intValue());
        }

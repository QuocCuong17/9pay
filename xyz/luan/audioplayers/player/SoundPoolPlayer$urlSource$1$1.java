...
public final class SoundPoolPlayer$urlSource$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public SoundPoolPlayer$urlSource$1$1(UrlSource urlSource, SoundPoolPlayer soundPoolPlayer, SoundPoolPlayer soundPoolPlayer2, long j, Continuation<? super SoundPoolPlayer$urlSource$1$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        BuildersKt__Builders_commonKt.launch$default(coroutineScope, Dispatchers.getMain(), null, new AnonymousClass1(this.this$0, audioPathForSoundPool, this.$soundPoolPlayer, this.$value, this.$start, null), 2, null);
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(SoundPoolPlayer soundPoolPlayer, String str, SoundPoolPlayer soundPoolPlayer2, UrlSource urlSource, long j, Continuation<? super AnonymousClass1> continuation) {
            super(2, continuation);
            this.this$0 = soundPoolPlayer;
            this.$actualUrl = str;
            this.$soundPoolPlayer = soundPoolPlayer2;
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            Integer boxInt = Boxing.boxInt(load);
            soundPoolWrapper = this.this$0.soundPoolWrapper;
            soundPoolWrapper.getSoundIdToPlayer().put(boxInt, this.$soundPoolPlayer);
            this.this$0.setSoundId(Boxing.boxInt(load));

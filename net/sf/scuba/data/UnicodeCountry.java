...
public class UnicodeCountry extends Country implements Serializable {
    ...
    static {
        ...
        BH = unicodeCountry24;
        UnicodeCountry unicodeCountry25 = new UnicodeCountry(BaselineTIFFTagSet.TAG_CELL_WIDTH, "BI", "BDI", "Burundi", "Burundian");
        BI = unicodeCountry25;
        ...
        BM = unicodeCountry28;
        UnicodeCountry unicodeCountry29 = new UnicodeCountry(CipherSuite.TLS_RSA_WITH_SEED_CBC_SHA, "BN", "BRN", "Brunei", "Bruneian");
        BN = unicodeCountry29;
        ...
        BW = unicodeCountry35;
        UnicodeCountry unicodeCountry36 = new UnicodeCountry(BaselineTIFFTagSet.TAG_ORIENTATION, "BY", "BLR", "Belarus", "Belarusian");
        BY = unicodeCountry36;
        UnicodeCountry unicodeCountry37 = new UnicodeCountry(CipherSuite.TLS_RSA_WITH_CAMELLIA_256_CBC_SHA, "BZ", "BLZ", "Belize", "Belizean");
        BZ = unicodeCountry37;
        UnicodeCountry unicodeCountry38 = new UnicodeCountry(BaselineTIFFTagSet.TAG_T4_OPTIONS, "CA", "CAN", "Canada", "Canadian");
        CA = unicodeCountry38;
        UnicodeCountry unicodeCountry39 = new UnicodeCountry(358, AFMParser.CC, "CCK", "Cocos [Keeling] Islands", "");
        CC = unicodeCountry39;
        UnicodeCountry unicodeCountry40 = new UnicodeCountry(RendererCapabilities.DECODER_SUPPORT_MASK, "CD", "COD", "Congo - Kinshasa", "Congolese");
        CD = unicodeCountry40;
        UnicodeCountry unicodeCountry41 = new UnicodeCountry(BaselineTIFFTagSet.TAG_COLOR_MAP, "CF", "CAF", "Central African Republic", "Central African");
        CF = unicodeCountry41;
        UnicodeCountry unicodeCountry42 = new UnicodeCountry(376, "CG", "COG", "Congo - Brazzaville", "Congolese");
        CG = unicodeCountry42;
        UnicodeCountry unicodeCountry43 = new UnicodeCountry(1878, AFMParser.CHARMETRICS_CH, "CHE", "Switzerland", "Swiss");
        CH = unicodeCountry43;
        ...
        CK = unicodeCountry45;
        UnicodeCountry unicodeCountry46 = new UnicodeCountry(BaselineTIFFTagSet.TAG_EXTRA_SAMPLES, "CL", "CHL", "Chile", "Chilean");
        CL = unicodeCountry46;
        UnicodeCountry unicodeCountry47 = new UnicodeCountry(BaselineTIFFTagSet.TAG_FREE_OFFSETS, "CM", "CMR", "Cameroon", "Cameroonian");
        CM = unicodeCountry47;
        UnicodeCountry unicodeCountry48 = new UnicodeCountry(BaselineTIFFTagSet.TAG_TRANSFER_RANGE, "CN", "CHN", "China", "Chinese");
        CN = unicodeCountry48;
        ...
        CR = unicodeCountry50;
        UnicodeCountry unicodeCountry51 = new UnicodeCountry(TypedValues.CycleType.TYPE_VISIBILITY, "CU", "CUB", "Cuba", "Cuban");
        CU = unicodeCountry51;
        ...
        CY = unicodeCountry54;
        UnicodeCountry unicodeCountry55 = new UnicodeCountry(BaselineTIFFTagSet.TAG_JPEG_RESTART_INTERVAL, "CZ", "CZE", "Czech Republic", "Czech");
        CZ = unicodeCountry55;
        UnicodeCountry unicodeCountry56 = new UnicodeCountry(630, "DE", "DEU", "Germany", "German");
        DE = unicodeCountry56;
        UnicodeCountry unicodeCountry57 = new UnicodeCountry(TypedValues.MotionType.TYPE_QUANTIZE_MOTIONSTEPS, "DJ", "DJI", "Djibouti", "Djiboutian");
        DJ = unicodeCountry57;
        UnicodeCountry unicodeCountry58 = new UnicodeCountry(BaselineTIFFTagSet.TAG_JPEG_DC_TABLES, "DK", "DNK", "Denmark", "Danish");
        DK = unicodeCountry58;
        UnicodeCountry unicodeCountry59 = new UnicodeCountry(BaselineTIFFTagSet.TAG_Y_CB_CR_SUBSAMPLING, "DM", "DMA", "Dominica", "Dominican");
        DM = unicodeCountry59;
        UnicodeCountry unicodeCountry60 = new UnicodeCountry(BaselineTIFFTagSet.TAG_REFERENCE_BLACK_WHITE, "DO", "DOM", "Dominican Republic", "Dominican");
        DO = unicodeCountry60;
        ...
        GQ = unicodeCountry87;
        UnicodeCountry unicodeCountry88 = new UnicodeCountry(ValidationPath.MAX_PATH_LENGTH_BYTES, "GR", "GRC", "Greece", "Greek, Hellenic");
        GR = unicodeCountry88;
        ...
        HN = unicodeCountry96;
        UnicodeCountry unicodeCountry97 = new UnicodeCountry(TypedValues.CycleType.TYPE_CURVE_FIT, "HR", "HRV", "Croatia", "Croatian");
        HR = unicodeCountry97;
        ...
        UnicodeCountry unicodeCountry111 = new UnicodeCountry(TypedValues.Custom.TYPE_BOOLEAN, "JM", "JAM", "Jamaica", "Jamaican");
        ...
        UnicodeCountry unicodeCountry114 = new UnicodeCountry(AnalyticsListener.EVENT_PLAYER_RELEASED, "KE", "KEN", "Kenya", "Kenyan");
        ...
        UnicodeCountry unicodeCountry116 = new UnicodeCountry(BaselineTIFFTagSet.TAG_ROWS_PER_STRIP, "KH", "KHM", "Cambodia", "Cambodian");
        ...
        UnicodeCountry unicodeCountry120 = new UnicodeCountry(AnalyticsListener.EVENT_AUDIO_TRACK_RELEASED, AFMParser.KERN_PAIR_KP, "PRK", "North Korea", "North Korean");
        ...
        UnicodeCountry unicodeCountry128 = new UnicodeCountry(1080, StandardStructureTypes.LI, "LIE", "Liechtenstein", "");
        LI = unicodeCountry128;
        UnicodeCountry unicodeCountry129 = new UnicodeCountry(BaselineTIFFTagSet.TAG_TILE_OFFSETS, "LK", "LKA", "Sri Lanka", "Sri Lankan");
        ...
        UnicodeCountry unicodeCountry151 = new UnicodeCountry(PlatformPlugin.DEFAULT_SYSTEM_UI, "MS", "MSR", "Montserrat", "Montserratian");
        ...
        UnicodeCountry unicodeCountry160 = new UnicodeCountry(Polynomial.PRIVATE_KEY_I, "NC", "NCL", "New Caledonia", "New Caledonian");
        ...
        UnicodeCountry unicodeCountry212 = new UnicodeCountry(FaxTIFFTagSet.TAG_CONSECUTIVE_BAD_LINES, StandardStructureTypes.TD, "TCD", "Chad", "Chadian");
        TD = unicodeCountry212;
        UnicodeCountry unicodeCountry213 = new UnicodeCountry(TypedValues.MotionType.TYPE_DRAW_PATH, "TF", "ATF", "French Southern Territories", "");
        TF = unicodeCountry213;
        UnicodeCountry unicodeCountry214 = new UnicodeCountry(1896, "TG", "TGO", "Togo", "Togolese");
        TG = unicodeCountry214;
        UnicodeCountry unicodeCountry215 = new UnicodeCountry(1892, StandardStructureTypes.TH, "THA", "Thailand", "Thai");
        ...
        UnicodeCountry unicodeCountry222 = new UnicodeCountry(1938, StandardStructureTypes.TR, "TUR", "Turkey", "Turkish");
        ...
        UnicodeCountry unicodeCountry230 = new UnicodeCountry(Polynomial.PRIVATE_KEY_III_SIZE, "US", "USA", "United States", "American");

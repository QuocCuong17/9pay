...
public final class CoroutineDebuggingKt {
    ...
    public static final StackTraceElement artificialFrame(Throwable th, String str) {
        ...
        return new StackTraceElement(ARTIFICIAL_FRAME_PACKAGE_NAME + FilenameUtils.EXTENSION_SEPARATOR + str, "_", stackTraceElement.getFileName(), stackTraceElement.getLineNumber());
    }
}

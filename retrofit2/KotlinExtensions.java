        ...
        if (continuation instanceof KotlinExtensions$suspendAndThrow$1) {
            ...
            if ((kotlinExtensions$suspendAndThrow$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    Dispatchers.getDefault().mo2761dispatch(kotlinExtensions$suspendAndThrow$12.get$context(), new Runnable() { // from class: retrofit2.KotlinExtensions$suspendAndThrow$$inlined$suspendCoroutineUninterceptedOrReturn$lambda$1
                        @Override // java.lang.Runnable
                        public final void run() {
                            Continuation intercepted = IntrinsicsKt.intercepted(Continuation.this);
                            Exception exc2 = exc;
                            Result.Companion companion = Result.INSTANCE;
                            intercepted.resumeWith(Result.m1202constructorimpl(ResultKt.createFailure(exc2)));
                        }
                    });
    ...
    public static final <T> Object await(final Call<T> call, Continuation<? super T> continuation) {
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$2$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (body == null) {
                        ...
                        Result.Companion companion = Result.INSTANCE;
                        cancellableContinuation.resumeWith(Result.m1202constructorimpl(ResultKt.createFailure(kotlinNullPointerException)));
                        return;
                    }
                    CancellableContinuation cancellableContinuation2 = CancellableContinuation.this;
                    Result.Companion companion2 = Result.INSTANCE;
                    cancellableContinuation2.resumeWith(Result.m1202constructorimpl(body));
                    return;
                }
                CancellableContinuation cancellableContinuation3 = CancellableContinuation.this;
                HttpException httpException = new HttpException(response);
                Result.Companion companion3 = Result.INSTANCE;
                cancellableContinuation3.resumeWith(Result.m1202constructorimpl(ResultKt.createFailure(httpException)));
            }
            ...
            public void onFailure(Call<T> call2, Throwable t) {
                ...
                CancellableContinuation cancellableContinuation = CancellableContinuation.this;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m1202constructorimpl(ResultKt.createFailure(t)));
            }
        });
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$4$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    T body = response.body();
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuation.resumeWith(Result.m1202constructorimpl(body));
                    return;
                }
                CancellableContinuation cancellableContinuation2 = CancellableContinuation.this;
                HttpException httpException = new HttpException(response);
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m1202constructorimpl(ResultKt.createFailure(httpException)));
            }
    ...
    public static final <T> Object awaitResponse(final Call<T> call, Continuation<? super Response<T>> continuation) {
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$awaitResponse$2$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                CancellableContinuation cancellableContinuation = CancellableContinuation.this;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m1202constructorimpl(response));
            }

...
public final class Utf8 {
    ...
    public static final boolean isUtf8Continuation(byte b) {
        return (b & ISO7816.INS_GET_RESPONSE) == 128;
    }
            ...
            if (Intrinsics.compare((int) charAt, 128) < 0) {
                ...
                if (Intrinsics.compare((int) charAt, 2048) < 0) {
                    ...
                    if (!(55296 <= charAt && charAt <= 57343)) {
                        ...
                        if (Intrinsics.compare((int) charAt, GeneratorBase.SURR1_LAST) <= 0 && i2 > (i3 = i + 1)) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x011c, code lost:
        ...
        if (((r16[r4] & net.sf.scuba.smartcards.ISO7816.INS_GET_RESPONSE) == 128) == false) goto L27;
     */
    /* JADX WARN: Code restructure failed: missing block: B:75:0x0097, code lost:
    
        if (((r16[r4] & net.sf.scuba.smartcards.ISO7816.INS_GET_RESPONSE) == 128) == false) goto L16;
     */
    /*
            ...
            if (b >= 0) {
                ...
                if ((b >> 5) == -2) {
                    ...
                    if (i2 <= i10) {
                        ...
                        int i11 = i4 + 1;
                        if (i2 > i11) {
                            if ((bArr[i11] & ISO7816.INS_GET_RESPONSE) == 128) {
                                int i12 = i4 + 2;
                                if (i2 > i12) {
                                }
                                i3 = 2;
                        ...
                        if ((b8 & ISO7816.INS_GET_RESPONSE) == 128) {
                            byte b9 = bArr[i4 + 2];
                            if ((b9 & ISO7816.INS_GET_RESPONSE) == 128) {
                                byte b10 = bArr[i10];
                                if ((b10 & ISO7816.INS_GET_RESPONSE) == 128) {
                                    int i13 = (((b10 ^ 3678080) ^ (b9 << 6)) ^ (b8 << 12)) ^ (b7 << Ascii.DC2);
                                    if (i13 <= 1114111) {
    ...
    */
                                ...
                                if ((b10 & ISO7816.INS_GET_RESPONSE) == 128) {
                                    ...
                                    if (i13 <= 1114111) {
                                        ...
                                        if (!r9 && i13 >= 65536 && i13 != 65533) {
                                            ...
                                            yield.invoke(Character.valueOf((char) ((i13 & AnalyticsListener.EVENT_DRM_KEYS_LOADED) + 56320)));
                                            Unit unit8 = Unit.INSTANCE;
                                            i3 = 4;
                                        }
                                    }
    ...
    public static final int process3Utf8Bytes(byte[] bArr, int i, int i2, Function1<? super Integer, Unit> yield) {
        ...
        if (i2 <= i3) {
            ...
            int i4 = i + 1;
            if (i2 > i4) {
                if ((bArr[i4] & ISO7816.INS_GET_RESPONSE) == 128) {
                    return 2;
                }
            }
            return 1;
        ...
        if (i2 <= i3) {
            ...
            if (i2 > i4) {
                if ((bArr[i4] & ISO7816.INS_GET_RESPONSE) == 128) {
                    int i5 = i + 2;
                    if (i2 > i5) {
                        if ((bArr[i5] & ISO7816.INS_GET_RESPONSE) == 128) {
                            return 3;
                        }
                    }
                    return 2;

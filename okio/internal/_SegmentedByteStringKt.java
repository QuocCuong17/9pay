...
public final class _SegmentedByteStringKt {
    ...
    public static final ByteString commonSubstring(SegmentedByteString segmentedByteString, int i, int i2) {
        ...
        int i8 = segment != 0 ? segmentedByteString.getDirectory()[segment - 1] : 0;
    ...
    public static final boolean commonRangeEquals(SegmentedByteString segmentedByteString, int i, ByteString other, int i2, int i3) {
        ...
        while (i < i4) {
            ...
            if (!other.rangeEquals(i2, segmentedByteString.getSegments()[segment], i7 + (i - i5), min)) {
                return false;
            }
            i2 += min;
            i += min;
    ...
    public static final boolean commonRangeEquals(SegmentedByteString segmentedByteString, int i, byte[] other, int i2, int i3) {
        ...
        while (i < i4) {
            ...
            int i7 = segmentedByteString.getDirectory()[segmentedByteString.getSegments().length + segment];
            int min = Math.min(i4, i6 + i5) - i;
            if (!_UtilKt.arrayRangeEquals(segmentedByteString.getSegments()[segment], i7 + (i - i5), other, i2, min)) {
                return false;
            }
            i2 += min;
            i += min;
    ...
    public static final void commonCopyInto(SegmentedByteString segmentedByteString, int i, byte[] target, int i2, int i3) {
        ...
        while (i < i4) {
            ...
            int min = Math.min(i4, i6 + i5) - i;
            int i8 = i7 + (i - i5);
            ArraysKt.copyInto(segmentedByteString.getSegments()[segment], target, i2, i8, i8 + min);
            i2 += min;
            i += min;
            segment++;
        }

...
@Metadata(d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0012\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\u001a\n\u0010\u0000\u001a\u00020\u0001*\u00020\u0002\u001a\u001e\u0010\u0003\u001a\u00020\u0002*\u00020\u00012\b\b\u0002\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u0005¨\u0006\u0007"}, d2 = {"commonAsUtf8ToByteArray", "", "", "commonToUtf8String", "beginIndex", "", SpellCheckPlugin.END_INDEX_KEY, "okio"}, k = 2, mv = {1, 5, 1}, xi = 48)
...
public final class _Utf8Kt {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:35:0x0123, code lost:
        ...
        if (((r16[r5] & net.sf.scuba.smartcards.ISO7816.INS_GET_RESPONSE) == 128) == false) goto L97;
     */
    /* JADX WARN: Code restructure failed: missing block: B:90:0x009d, code lost:
    
        if (((r16[r5] & net.sf.scuba.smartcards.ISO7816.INS_GET_RESPONSE) == 128) == false) goto L23;
     */
    /*
                ...
                if ((b >> 5) == -2) {
                    ...
                    if ((b >> 4) == -2) {
                        ...
                        if (i2 <= i16) {
                            ...
                            int i17 = i8 + 1;
                            if (i2 > i17) {
                                if ((bArr[i17] & ISO7816.INS_GET_RESPONSE) == 128) {
                                    int i18 = i8 + 2;
                                    if (i2 > i18) {
                                    }
                                    i9 = i7;
                            ...
                            if ((b8 & ISO7816.INS_GET_RESPONSE) == 128) {
                                ...
                                if ((b9 & ISO7816.INS_GET_RESPONSE) == 128) {
                                    ...
                                    if ((b10 & ISO7816.INS_GET_RESPONSE) == 128) {
                                        int i19 = (((b10 ^ 3678080) ^ (b9 << 6)) ^ (b8 << 12)) ^ (b7 << Ascii.DC2);
                                        if (i19 > 1114111) {
                                            i6 = i9 + 1;
                                            cArr[i9] = Utf8.REPLACEMENT_CHARACTER;
                                        } else {
                                            if (55296 <= i19 && i19 <= 57343) {
                                                ...
                                                char c = (char) ((i19 & AnalyticsListener.EVENT_DRM_KEYS_LOADED) + 56320);
                                                i6 = i20 + 1;
                                                cArr[i20] = c;
                                            } else {
                                                i6 = i9 + 1;
                        ...
                        if (Intrinsics.compare((int) charAt2, 128) < 0) {
                            ...
                            if (Intrinsics.compare((int) charAt2, 2048) < 0) {
                                ...
                                if (55296 <= charAt2 && charAt2 <= 57343) {
                                    if (Intrinsics.compare((int) charAt2, GeneratorBase.SURR1_LAST) <= 0 && length2 > (i2 = i3 + 1)) {

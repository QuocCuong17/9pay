...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) throws CryptoException {
        ...
        System.out.println("");
        System.out.println("(Secret passwords used by Alice and Bob: \"" + URLCredentialContract.FeedEntry.COLUMN_NAME_PASSWORD + "\" and \"" + URLCredentialContract.FeedEntry.COLUMN_NAME_PASSWORD + "\")\n");
        SHA256Digest sHA256Digest = new SHA256Digest();
        SecureRandom secureRandom = new SecureRandom();
        JPAKEParticipant jPAKEParticipant = new JPAKEParticipant("alice", URLCredentialContract.FeedEntry.COLUMN_NAME_PASSWORD.toCharArray(), jPAKEPrimeOrderGroup, sHA256Digest, secureRandom);
        JPAKEParticipant jPAKEParticipant2 = new JPAKEParticipant("bob", URLCredentialContract.FeedEntry.COLUMN_NAME_PASSWORD.toCharArray(), jPAKEPrimeOrderGroup, sHA256Digest, secureRandom);

...
public class NoekeonEngine implements BlockCipher {
    ...
    private static final int[] roundConstants = {128, 27, 54, 108, 216, CipherSuite.TLS_DHE_PSK_WITH_AES_256_GCM_SHA384, 77, CipherSuite.TLS_DHE_RSA_WITH_SEED_CBC_SHA, 47, 94, 188, 99, 198, 151, 53, 106, 212};
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (true) {
            ...
            if (i3 <= 0) {
                ...
                iArr4[0] = roundConstants[i3] ^ iArr4[0];
                intToBytesBig(iArr4[0], bArr2, i2);
            ...
            iArr5[0] = iArr5[0] ^ roundConstants[i3];
            pi1(iArr5);
            gamma(this.state);
            pi2(this.state);
            i3--;

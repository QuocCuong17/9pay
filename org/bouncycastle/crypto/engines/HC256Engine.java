...
public class HC256Engine implements StreamCipher {
    ...
    private int step() {
        ...
        if (i3 < 1024) {
            ...
            i = iArr2[i8 & 255] + iArr2[((i8 >> 8) & 255) + 256] + iArr2[((i8 >> 16) & 255) + 512] + iArr2[((i8 >> 24) & 255) + ValidationPath.MAX_PATH_LENGTH_BYTES];
            i2 = iArr3[i4];
        } else {
            int[] iArr4 = this.q;
            ...
            i = iArr5[i12 & 255] + iArr5[((i12 >> 8) & 255) + 256] + iArr5[((i12 >> 16) & 255) + 512] + iArr5[((i12 >> 24) & 255) + ValidationPath.MAX_PATH_LENGTH_BYTES];
            i2 = iArr6[i4];
        }
        int i13 = i2 ^ i;

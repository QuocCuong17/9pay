...
public class Poly1305 implements Mac {
    ...
    public int doFinal(byte[] bArr, int i) throws DataLengthException, IllegalStateException {
        ...
        int i21 = ((i19 >>> 26) + i13) - AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL;
        int i22 = (i21 >>> 31) - 1;
        int i23 = ~i22;
        ...
        long j = ((r1 | (r0 << 26)) & 4294967295L) + (this.k0 & 4294967295L);
        long j2 = (((r3 >>> 12) | (r2 << 14)) & 4294967295L) + (this.k2 & 4294967295L);
        Pack.intToLittleEndian((int) j, bArr, i);
        long j3 = (((r0 >>> 6) | (r3 << 20)) & 4294967295L) + (this.k1 & 4294967295L) + (j >>> 32);
        Pack.intToLittleEndian((int) j3, bArr, i + 4);
        long j4 = j2 + (j3 >>> 32);
        Pack.intToLittleEndian((int) j4, bArr, i + 8);
        Pack.intToLittleEndian((int) ((((r2 >>> 18) | (r4 << 8)) & 4294967295L) + (4294967295L & this.k3) + (j4 >>> 32)), bArr, i + 12);
        reset();
        return 16;
    }

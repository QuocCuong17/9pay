...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    protected void processBlock() {
        ...
        int RL32 = RL(RL27, 10);
        int RL33 = RL(i + f5(i2, i3, i4) + this.X[5] + 1352829926, 8) + i5;
        int RL34 = RL(i3, 10);
        int RL35 = RL(i5 + f5(RL33, i2, RL34) + this.X[14] + 1352829926, 9) + i4;
        int RL36 = RL(i2, 10);
        int RL37 = RL(i4 + f5(RL35, RL33, RL36) + this.X[7] + 1352829926, 9) + RL34;
        int RL38 = RL(RL33, 10);
        ...
        int RL64 = RL(RL59, 10);
        int RL65 = RL(RL28 + f2(RL31, RL29, RL32) + this.X[7] + 1518500249, 7) + RL30;
        int RL66 = RL(RL29, 10);
        int RL67 = RL(RL30 + f2(RL65, RL31, RL66) + this.X[4] + 1518500249, 6) + RL32;
        int RL68 = RL(RL31, 10);
        ...
        int RL96 = RL(RL91, 10);
        int RL97 = RL(RL60 + f4(RL63, RL61, RL64) + this.X[6] + 1548603684, 9) + RL62;
        int RL98 = RL(RL61, 10);
        int RL99 = RL(RL62 + f4(RL97, RL63, RL98) + this.X[11] + 1548603684, 13) + RL64;
        int RL100 = RL(RL63, 10);
        ...
        int RL129 = RL(RL92 + f3(RL95, RL93, RL96) + this.X[3] + 1859775393, 11) + RL94;
        int RL130 = RL(RL93, 10);
        int RL131 = RL(RL94 + f3(RL129, RL95, RL130) + this.X[10] + 1859775393, 13) + RL96;
        int RL132 = RL(RL95, 10);
        int RL133 = RL(RL96 + f3(RL131, RL129, RL132) + this.X[14] + 1859775393, 6) + RL130;
        ...
        int RL161 = RL(RL124 + f3(RL127, RL125, RL128) + this.X[15] + 1836072691, 9) + RL126;
        int RL162 = RL(RL125, 10);
        int RL163 = RL(RL126 + f3(RL161, RL127, RL162) + this.X[5] + 1836072691, 7) + RL128;
        int RL164 = RL(RL127, 10);
        int RL165 = RL(RL128 + f3(RL163, RL161, RL164) + this.X[1] + 1836072691, 15) + RL162;
        ...
        int RL193 = RL(((RL156 + f4(RL159, RL157, RL160)) + this.X[1]) - 1894007588, 11) + RL158;
        ...
        int RL225 = RL(RL188 + f2(RL191, RL189, RL192) + this.X[8] + 2053994217, 15) + RL190;
        ...
        int RL257 = RL(((RL220 + f5(RL223, RL221, RL224)) + this.X[4]) - 1454113458, 9) + RL222;
        int RL258 = RL(RL221, 10);
        ...
        int RL289 = RL(RL252 + f1(RL255, RL253, RL256) + this.X[12], 8) + RL254;
        int RL290 = RL(RL253, 10);
        ...
        int RL320 = RL(RL315, 10) + RL285 + this.H1;
        this.H1 = this.H2 + RL288 + RL318;
        this.H2 = this.H3 + RL286 + RL316;
        this.H3 = this.H4 + RL284 + RL319;
        this.H4 = this.H0 + RL287 + RL317;
        this.H0 = RL320;
        this.xOff = 0;
        int i6 = 0;
        while (true) {

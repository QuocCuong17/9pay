...
public class RIPEMD128Digest extends GeneralDigest {
    ...
    protected void processBlock() {
        ...
        int F2 = F2(F113, F116, F115, F114, this.X[7], 7);
        ...
        int F3 = F3(F213, F216, F215, F214, this.X[3], 11);
        int F32 = F3(F214, F3, F216, F215, this.X[10], 13);
        int F33 = F3(F215, F32, F3, F216, this.X[14], 6);
        int F34 = F3(F216, F33, F32, F3, this.X[4], 7);
        ...
        int F4 = F4(F313, F316, F315, F314, this.X[1], 11);
        int F42 = F4(F314, F4, F316, F315, this.X[9], 12);
        int F43 = F4(F315, F42, F4, F316, this.X[11], 14);
        ...
        int FF4 = FF4(i, i2, i3, i4, this.X[5], 8);
        int FF42 = FF4(i4, FF4, i2, i3, this.X[14], 9);
        int FF43 = FF4(i3, FF42, FF4, i2, this.X[7], 9);
        int FF44 = FF4(i2, FF43, FF42, FF4, this.X[0], 11);
        ...
        int FF3 = FF3(FF413, FF416, FF415, FF414, this.X[6], 9);
        ...
        int FF2 = FF2(FF313, FF316, FF315, FF314, this.X[15], 9);
        int FF22 = FF2(FF314, FF2, FF316, FF315, this.X[5], 7);
        int FF23 = FF2(FF315, FF22, FF2, FF316, this.X[1], 15);
        int FF24 = FF2(FF316, FF23, FF22, FF2, this.X[3], 11);
        ...
        int FF1 = FF1(FF213, FF216, FF215, FF214, this.X[8], 15);
        int FF12 = FF1(FF214, FF1, FF216, FF215, this.X[6], 5);
        int FF13 = FF1(FF215, FF12, FF1, FF216, this.X[4], 8);

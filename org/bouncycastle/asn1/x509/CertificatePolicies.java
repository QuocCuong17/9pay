...
public class CertificatePolicies extends ASN1Object {
    ...
    public CertificatePolicies(PolicyInformation[] policyInformationArr) {
        this.policyInformation = copyPolicyInfo(policyInformationArr);
    }

    private PolicyInformation[] copyPolicyInfo(PolicyInformation[] policyInformationArr) {
    ...
    public PolicyInformation[] getPolicyInformation() {
        return copyPolicyInfo(this.policyInformation);
    }

...
public class LDAPStoreHelper {
    ...
    /* JADX WARN: Removed duplicated region for block: B:26:0x009c A[LOOP:0: B:26:0x009c->B:28:0x009f, LOOP_START, PHI: r4
      0x009c: PHI (r4v5 int) = (r4v1 int), (r4v6 int) binds: [B:25:0x009a, B:28:0x009f] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:37:0x00d9 A[LOOP:1: B:35:0x00d3->B:37:0x00d9, LOOP_END] */
    /*
    ...
    */
    private List search(String[] strArr, String str, String[] strArr2) throws StoreException {
        ...
        try {
            ...
            NamingEnumeration search = dirContext.search(this.params.getBaseDN(), str7, searchControls);

...
public class XMSSReducedSignature implements XMSSStoreableObjectInterface {
    ...
    public XMSSReducedSignature(Builder builder) {
        ...
        if (bArr == null) {
            ...
            this.wotsPlusSignature = wOTSPlusSignature == null ? new WOTSPlusSignature(xMSSParameters.getWOTSPlus().getParams(), (byte[][]) Array.newInstance((Class<?>) byte.class, len, treeDigestSize)) : wOTSPlusSignature;

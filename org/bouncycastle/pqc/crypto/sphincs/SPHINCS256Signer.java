...
public class SPHINCS256Signer implements MessageSigner {
    ...
    byte[] crypto_sign(HashFunctions hashFunctions, byte[] bArr, byte[] bArr2) {
        ...
        for (int i7 = 12; i6 < i7; i7 = 12) {
            ...
            int i9 = i5;
            byte[] bArr14 = bArr11;
            wots.wots_sign(hashFunctions, bArr3, i8, bArr6, bArr7, bArr14);
            int i10 = i9 + 2144;
            compute_authpath_wots(hashFunctions, bArr6, bArr3, i10, leafaddrVar2, bArr13, bArr14, 5);
            i5 = i10 + 160;
    ...
    boolean verify(HashFunctions hashFunctions, byte[] bArr, byte[] bArr2, byte[] bArr3) {
        ...
        while (i4 < 12) {
            ...
            byte[] bArr12 = bArr7;
            validate_authpath(hashFunctions, bArr6, bArr5, (int) (31 & j), bArr12, i6, bArr11, 5);
            j >>= 5;
            i5 = i6 + 160;
            i4++;
            bArr7 = bArr12;

...
public class GMSSRootCalc {
    ...
    public GMSSRootCalc(int i, int i2, GMSSDigestProvider gMSSDigestProvider) {
        ...
        this.AuthPath = (byte[][]) Array.newInstance((Class<?>) byte.class, iArr);
    ...
    public byte[][] getStatByte() {
        ...
        byte[][] bArr = (byte[][]) Array.newInstance((Class<?>) byte.class, this.heightOfTree + 1 + size, 64);
        bArr[0] = this.root;
        int i = 0;
    ...
    public void initialize(Vector vector) {
        ...
        this.index = new int[i];
        this.AuthPath = (byte[][]) Array.newInstance((Class<?>) byte.class, i, this.mdLength);
        this.root = new byte[this.mdLength];

        ...
        for (int i = 0; i < 10; i += 2) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                while (i5 < 1023) {
                    ...
                    short s = sArr2[i4];
                    sArr[i5] = (short) (i6 + i8);
                    sArr[i7] = Reduce.montgomery(s * ((i6 + EXIFTIFFTagSet.TAG_DATE_TIME_ORIGINAL) - i8));
                    i5 += i2 * 2;
                    i4 = i9;
                }
            }
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                ...
                while (i13 < 1023) {
                    ...
                    int i17 = i12 + 1;
                    short s2 = sArr2[i12];
                    sArr[i13] = Reduce.barrett((short) (i14 + i16));
                    sArr[i15] = Reduce.montgomery(s2 * ((i14 + EXIFTIFFTagSet.TAG_DATE_TIME_ORIGINAL) - i16));
                    i13 += i10 * 2;
                    i12 = i17;
                }
            }

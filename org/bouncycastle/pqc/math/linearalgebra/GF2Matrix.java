...
public class GF2Matrix extends Matrix {
    ...
    public GF2Matrix(byte[] bArr) {
        ...
        if (this.numRows > 0) {
            ...
            if (i == bArr.length - 8) {
                ...
                this.matrix = (int[][]) Array.newInstance((Class<?>) int.class, this.numRows, this.length);
    ...
    public Matrix computeInverse() {
        ...
        int[][] iArr = (int[][]) Array.newInstance((Class<?>) int.class, this.numRows, this.length);
        for (int i = this.numRows - 1; i >= 0; i--) {
            iArr[i] = IntUtils.clone(this.matrix[i]);
        }
        int[][] iArr2 = (int[][]) Array.newInstance((Class<?>) int.class, this.numRows, this.length);
    ...
    public Matrix computeTranspose() {
        int[][] iArr = (int[][]) Array.newInstance((Class<?>) int.class, this.numColumns, (this.numRows + 31) >>> 5);
    ...
    public GF2Matrix getLeftSubMatrix() {
        ...
        int[][] iArr = (int[][]) Array.newInstance((Class<?>) int.class, this.numRows, i);

...
public class GF2mMatrix extends Matrix {
    ...
    public GF2mMatrix(GF2mField gF2mField, byte[] bArr) {
        ...
        if (this.numRows > 0) {
            ...
            if ((bArr.length - 4) % i3 == 0) {
                ...
                this.matrix = (int[][]) Array.newInstance((Class<?>) int.class, this.numRows, this.numColumns);
    ...
    public Matrix computeInverse() {
        ...
        int[][] iArr = (int[][]) Array.newInstance((Class<?>) int.class, this.numRows, this.numRows);
        for (int i2 = this.numRows - 1; i2 >= 0; i2--) {
            iArr[i2] = IntUtils.clone(this.matrix[i2]);
        }
        int[][] iArr2 = (int[][]) Array.newInstance((Class<?>) int.class, this.numRows, this.numRows);

...
public abstract class Nat {
    ...
    public static int add33At(int i, int i2, int[] iArr, int i3) {
        long j = (iArr[r0] & 4294967295L) + (i2 & 4294967295L);
        iArr[i3 + 0] = (int) j;
        long j2 = (j >>> 32) + (4294967295L & iArr[r2]) + 1;
        iArr[i3 + 1] = (int) j2;
        if ((j2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = j + (iArr[i2 + i5] & 4294967295L) + (iArr2[i3 + i5] & 4294967295L) + (4294967295L & iArr3[r8]);
            iArr3[i4 + i5] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addDWordAt(int i, long j, int[] iArr, int i2) {
        long j2 = (iArr[r0] & 4294967295L) + (j & 4294967295L);
        iArr[i2 + 0] = (int) j2;
        long j3 = (j2 >>> 32) + (4294967295L & iArr[r5]) + (j >>> 32);
        iArr[i2 + 1] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            long j2 = j + (iArr[i2 + i4] & 4294967295L) + (4294967295L & iArr2[r7]);
            iArr2[i3 + i4] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            long j2 = j + (iArr[i2 + i5] & 4294967295L) + (iArr2[r6] & 4294967295L);
            iArr2[i3 + i5] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addToEachOther(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        long j = 0;
        for (int i4 = 0; i4 < i; i4++) {
            long j2 = j + (iArr[r3] & 4294967295L) + (4294967295L & iArr2[r8]);
            int i5 = (int) j2;
            iArr[i2 + i4] = i5;
            iArr2[i3 + i4] = i5;
            j = j2 >>> 32;
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        long j = 0;
        for (int i5 = 0; i5 < i; i5++) {
            long mulWordAddTo = j + (mulWordAddTo(i, iArr[i2 + i5], iArr2, i3, iArr3, i4) & 4294967295L) + (iArr3[r3] & 4294967295L);
            iArr3[i4 + i] = (int) mulWordAddTo;
            j = mulWordAddTo >>> 32;
            i4++;
        }
        return (int) j;
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long mulWordAddTo = j + (mulWordAddTo(i, iArr[i2], iArr2, 0, iArr3, i2) & 4294967295L) + (iArr3[r2] & 4294967295L);
    ...
    public static int mulWordAddTo(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        int i5 = 0;
        do {
            long j3 = j2 + ((iArr[i3 + i5] & 4294967295L) * j) + (iArr2[r9] & 4294967295L);
            iArr2[i4 + i5] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
        } while (i5 < i);
    ...
    public static int mulWordDwordAddAt(int i, int i2, long j, int[] iArr, int i3) {
        ...
        long j3 = ((j & 4294967295L) * j2) + (iArr[r11] & 4294967295L) + 0;
        iArr[i3 + 0] = (int) j3;
        long j4 = j2 * (j >>> 32);
        long j5 = (j3 >>> 32) + j4 + (iArr[r12] & 4294967295L);
        iArr[i3 + 1] = (int) j5;
    ...
    public static void square(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        int i10 = i3 + 2;
        while (i4 < i) {
            long squareWordAddTo = j3 + (squareWordAddTo(iArr, i2, i4, iArr2, i3) & 4294967295L) + (iArr2[i10] & 4294967295L);
            int i11 = i10 + 1;
            iArr2[i10] = (int) squareWordAddTo;
            long j4 = (squareWordAddTo >>> 32) + (iArr2[i11] & 4294967295L);
            iArr2[i11] = (int) j4;
            j3 = j4 >>> 32;
            i4++;
            i10 = i11 + 1;
    ...
    public static void square(int i, int[] iArr, int[] iArr2) {
        ...
        int i9 = 2;
        while (i2 < i) {
            long squareWordAddTo = j3 + (squareWordAddTo(iArr, i2, iArr2) & 4294967295L) + (iArr2[i9] & 4294967295L);
            int i10 = i9 + 1;
    ...
    public static int squareWordAdd(int[] iArr, int i, int i2, int[] iArr2, int i3) {
        ...
        int i5 = i3;
        do {
            long j3 = j2 + ((iArr[i + i4] & 4294967295L) * j) + (iArr2[r11] & 4294967295L);
            iArr2[i2 + i5] = (int) j3;
            j2 = j3 >>> 32;
            i5++;
            i4++;
    ...
    public static int squareWordAdd(int[] iArr, int i, int[] iArr2) {
        ...
        int i2 = 0;
        do {
            long j3 = j2 + ((iArr[i2] & 4294967295L) * j) + (iArr2[r9] & 4294967295L);
            iArr2[i + i2] = (int) j3;
            j2 = j3 >>> 32;
            i2++;
        } while (i2 < i);

...
public class LongArray implements Cloneable {
    ...
    private static long interleave3_13to65(int i) {
        return (INTERLEAVE5_TABLE[i & 127] & 4294967295L) | ((r0[i >>> 7] & 4294967295L) << 35);
    }

    private static long interleave3_21to63(int i) {
        return (INTERLEAVE3_TABLE[i & 127] & 4294967295L) | ((r0[i >>> 14] & 4294967295L) << 42) | ((r0[(i >>> 7) & 127] & 4294967295L) << 21);
    }

    private static long interleave4_16to64(int i) {
        return (INTERLEAVE4_TABLE[i & 255] & 4294967295L) | ((r0[i >>> 8] & 4294967295L) << 32);
    }
    ...
    */
    ...
    public LongArray modMultiply(LongArray longArray, int i, int[] iArr) {
        ...
        if (i6 == 1) {
            ...
            return reduceResult(jArr2, 0, i8, i, iArr);
        }
        int i9 = ((i3 + 7) + 63) >>> 6;
        ...
        while (i16 < i6) {
            ...
            while (true) {
                ...
                long j3 = j2 >>> 4;
                i4 = i16;
                addBoth(jArr7, i17, jArr4, iArr2[i18], jArr5, iArr2[((int) j3) & 15], i9);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            i15 -= i8;
            if (i15 == 0) {
                return reduceResult(jArr7, 0, i8, i, iArr);
            }
            addShiftedUp(jArr7, i15 - i8, jArr7, i15, i8, 8);
        }
    }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        if (i7 == 1) {
            ...
            multiplyWord(j, longArray3.m_ints, i8, jArr, 0);
            return reduceResult(jArr, 0, i9, i, iArr);
        }
        int i10 = 15;
        int i11 = ((i3 + 15) + 63) >>> 6;
        int i12 = i11 * 8;
        ...
        int i15 = i12;
        interleave(longArray2.m_ints, 0, jArr2, 0, i7, 4);
        System.arraycopy(longArray3.m_ints, 0, jArr2, i7, i8);
        int i16 = i7;
        int i17 = 1;
        while (i17 < 8) {
            int i18 = i16 + i11;
        ...
        while (true) {
            ...
            do {
                ...
                while (true) {
                    int i23 = ((int) j2) & i10;
                    if (i23 != 0) {
                        add(jArr2, iArr2[i23] + i20, jArr2, i21, i11);
                    }
                    i4 = 1;
                    i22++;
                    if (i22 == 8) {
        ...
        while (true) {
            int i25 = i24 - 1;
            if (i25 <= i4) {
                return reduceResult(jArr2, iArr2[i4], i9, i, iArr);
            }
            if ((i25 & 1) == 0) {
                i6 = i4;
                addShiftedUp(jArr2, iArr2[i25 >>> 1], jArr2, iArr2[i25], i9, 16);
            } else {
                i6 = i4;
                distribute(jArr2, iArr2[i25], iArr2[i25 - 1], iArr2[i6], i9);
            }
            i24 = i25;
            i4 = i6;
        }
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        while (true) {
            ...
            int i15 = 1;
            while (i15 < i5) {
                int i16 = (int) (jArr6[i15] >>> i13);
                addBoth(jArr7, i15 - 1, jArr4, iArr2[i16 & 15], jArr5, iArr2[(i16 >>> 4) & 15], i8);
                i15 += 2;
                i14 = i14;
            }
            shiftUp(jArr7, 0, i7, i14);
            i13 -= 8;
        }
        for (int i17 = 56; i17 >= 0; i17 -= 8) {
            for (int i18 = 0; i18 < i5; i18 += 2) {
                int i19 = (int) (jArr6[i18] >>> i17);
                addBoth(jArr7, i18, jArr4, iArr2[i19 & 15], jArr5, iArr2[(i19 >>> 4) & 15], i8);
            }
            if (i17 > 0) {

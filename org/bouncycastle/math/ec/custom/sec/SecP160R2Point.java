...
public class SecP160R2Point extends ECPoint.AbstractFp {
    ...
    public ECPoint twice() {
        ...
        int[] create2 = Nat160.create();
        int[] create3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.x, create3);
        int[] create4 = Nat160.create();
        SecP160R2Field.square(create3, create4);
        boolean isOne = secP160R2FieldElement3.isOne();
        int[] iArr = secP160R2FieldElement3.x;
        if (!isOne) {
            SecP160R2Field.square(secP160R2FieldElement3.x, create2);
            iArr = create2;
        }
        SecP160R2Field.subtract(secP160R2FieldElement2.x, iArr, create);
        SecP160R2Field.add(secP160R2FieldElement2.x, iArr, create2);
        ...
        SecP160R2Field.square(create2, secP160R2FieldElement4.x);
        SecP160R2Field.subtract(secP160R2FieldElement4.x, create3, secP160R2FieldElement4.x);
        SecP160R2Field.subtract(secP160R2FieldElement4.x, create3, secP160R2FieldElement4.x);
        SecP160R2FieldElement secP160R2FieldElement5 = new SecP160R2FieldElement(create3);
        SecP160R2Field.subtract(create3, secP160R2FieldElement4.x, secP160R2FieldElement5.x);
        SecP160R2Field.multiply(secP160R2FieldElement5.x, create2, secP160R2FieldElement5.x);
        SecP160R2Field.subtract(secP160R2FieldElement5.x, create, secP160R2FieldElement5.x);

...
public abstract class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public static class EC extends KeyPairGeneratorSpi {
        ...
        static {
            ...
            ecParameters.put(Integers.valueOf(RendererCapabilities.DECODER_SUPPORT_MASK), new ECGenParameterSpec("P-384"));
            ecParameters.put(Integers.valueOf(BaselineTIFFTagSet.TAG_JPEG_AC_TABLES), new ECGenParameterSpec("P-521"));
        }

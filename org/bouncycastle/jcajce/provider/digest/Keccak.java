...
public class Keccak {
    ...
    public static class Digest288 extends DigestKeccak {
        public Digest288() {
            super(BaselineTIFFTagSet.TAG_FREE_OFFSETS);
        }
    }
    ...
    public static class HashMac288 extends BaseMac {
        public HashMac288() {
            super(new HMac(new KeccakDigest(BaselineTIFFTagSet.TAG_FREE_OFFSETS)));
        }
    }
    ...
    public static class HashMac384 extends BaseMac {
        public HashMac384() {
            super(new HMac(new KeccakDigest(RendererCapabilities.DECODER_SUPPORT_MASK)));
        }
    }
    ...
    public static class KeyGenerator288 extends BaseKeyGenerator {
        public KeyGenerator288() {
            super("HMACKECCAK288", BaselineTIFFTagSet.TAG_FREE_OFFSETS, new CipherKeyGenerator());
        }
    }
    ...
    public static class KeyGenerator384 extends BaseKeyGenerator {
        public KeyGenerator384() {
            super("HMACKECCAK384", RendererCapabilities.DECODER_SUPPORT_MASK, new CipherKeyGenerator());
        }
    }

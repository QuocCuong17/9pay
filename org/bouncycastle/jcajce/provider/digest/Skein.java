...
public class Skein {
    ...
    public static class HMacKeyGenerator_1024_384 extends BaseKeyGenerator {
        public HMacKeyGenerator_1024_384() {
            super("HMACSkein-1024-384", RendererCapabilities.DECODER_SUPPORT_MASK, new CipherKeyGenerator());
        }
    }
    ...
    public static class HMacKeyGenerator_512_384 extends BaseKeyGenerator {
        public HMacKeyGenerator_512_384() {
            super("HMACSkein-512-384", RendererCapabilities.DECODER_SUPPORT_MASK, new CipherKeyGenerator());
        }
    }
    ...
    public static class HashMac_1024_384 extends BaseMac {
        public HashMac_1024_384() {
            super(new HMac(new SkeinDigest(1024, RendererCapabilities.DECODER_SUPPORT_MASK)));
        }
    }
    ...
    public static class HashMac_512_384 extends BaseMac {
        public HashMac_512_384() {
            super(new HMac(new SkeinDigest(512, RendererCapabilities.DECODER_SUPPORT_MASK)));
        }
    }
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        private void addSkeinMacAlgorithm(ConfigurableProvider configurableProvider, int i, int i2) {
            String str = "Skein-MAC-" + i + Parameters.DEFAULT_OPTION_PREFIXES + i2;
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            addSkeinMacAlgorithm(configurableProvider, 512, RendererCapabilities.DECODER_SUPPORT_MASK);
            addSkeinMacAlgorithm(configurableProvider, 512, 512);
            addSkeinMacAlgorithm(configurableProvider, 1024, RendererCapabilities.DECODER_SUPPORT_MASK);
    ...
    public static class SkeinMacKeyGenerator_1024_384 extends BaseKeyGenerator {
        public SkeinMacKeyGenerator_1024_384() {
            super("Skein-MAC-1024-384", RendererCapabilities.DECODER_SUPPORT_MASK, new CipherKeyGenerator());
        }
    }
    ...
    public static class SkeinMacKeyGenerator_512_384 extends BaseKeyGenerator {
        public SkeinMacKeyGenerator_512_384() {
            super("Skein-MAC-512-384", RendererCapabilities.DECODER_SUPPORT_MASK, new CipherKeyGenerator());
        }
    }
    ...
    public static class SkeinMac_1024_384 extends BaseMac {
        public SkeinMac_1024_384() {
            super(new SkeinMac(1024, RendererCapabilities.DECODER_SUPPORT_MASK));
        }
    }
    ...
    public static class SkeinMac_512_384 extends BaseMac {
        public SkeinMac_512_384() {
            super(new SkeinMac(512, RendererCapabilities.DECODER_SUPPORT_MASK));
        }
    }

...
public class Operators {
    ...
    public Operators() {
        ...
        this.operators.put(TtmlNode.TAG_DIV, DIV);
        this.operators.put(AuthenticationTokenClaims.JSON_KEY_EXP, EXP);
        ...
        this.operators.put(AuthenticationTokenClaims.JSON_KEY_SUB, SUB);

...
public final class COSName extends COSBase implements Comparable<COSName> {
    ...
    public static final COSName BC = new COSName(BouncyCastleProvider.PROVIDER_NAME);
    ...
    public static final COSName DL = new COSName(ASN1Encoding.DL);
    public static final COSName DM = new COSName("Dm");
    public static final COSName DOC = new COSName(HVRetakeActivity.DOC_CALLING_ACTIVITY_VALUE);
    ...
    public static final COSName F = new COSName(PDNumberFormatDictionary.FRACTIONAL_DISPLAY_FRACTION);
    ...
    public static final COSName H = new COSName(StandardStructureTypes.H);
    ...
    public static final COSName O = new COSName(PDAnnotationLink.HIGHLIGHT_MODE_OUTLINE);
    ...
    public static final COSName TR = new COSName(StandardStructureTypes.TR);
    ...
    public static final COSName U = new COSName(PDBorderStyleDictionary.STYLE_UNDERLINE);
